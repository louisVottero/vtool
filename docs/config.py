# -*- coding: utf-8 -*-
#
# Vetala documentation build configuration file, created by
# sphinx-quickstart on Tue Oct 27 15:41:53 2015.
#
...
#sys.path.insert(0, 'D:/louis/development/git/vtool/python/')
...
html_theme_options = {
    ...
    # such as "amelia" or "cosmo" or "united", "sandstone", "bootswatch_theme"
...
latex_documents = [
  (master_doc, 'Vetala.tex', u'Vetala Documentation',
   u'Louis Vottero', 'manual'),
]
...
man_pages = [
    (master_doc, 'vetala', u'Vetala Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Vetala', u'Vetala Documentation',
   author, 'Vetala', 'One line description of project.',
   'Miscellaneous'),
]
