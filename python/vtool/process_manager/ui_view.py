...
class ViewProcessWidget(qt_ui.EditFileTreeWidget):
    ...
    def _copy_match(self, process_name=None, directory=None, show_others=True):
        ...
        if not process_name:
            ...
            self.tree_widget.scrollToItem(items[0], qt.QAbstractItemView.PositionAtCenter)
...
class ProcessTreeWidget(qt_ui.FileTreeWidget):
    ...
    def _create_context_menu(self):
        ...
        self.edit_mode_message = self.context_menu.addAction('Turn on Edit mode (at the bottom of the view)'
    ...
    def _duplicate_process(self):
        ...
        new_process = process.copy_process(source_process, target_directory)
        ...
        self.scrollToItem(new_item, qt.QAbstractItemView.PositionAtCenter)
    ...
    def paste_process(self, source_process=None):
        ...
        new_process = process.copy_process(source_process, target_process.get_path())
