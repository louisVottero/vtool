...
class UnrealUtilRig(UnrealUtil):
    ...
    def _build_return(self):
        ...
        graph.add_link(self.switch_mode, 'Result', vetala_lib_output_rig_controls, 'mode', controller)
...
class UnrealSplineIkRig(UnrealUtilRig):
    ...
    def _build_function_construct_graph(self):
        ...
        set_local_controls = controller.add_variable_node_from_object_path('local_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', False, '()', unreal.Vector2D(6648.0, -1512.0), 'Set local_controls')
        spline_from_items = controller.add_external_function_reference_node('/ControlRigSpline/SplineFunctionLibrary/SplineFunctionLibrary.SplineFunctionLibrary_C', 'SplineFromItems', unreal.Vector2D(1560.0, -3068.0), 'SplineFromItems')
        get_joints = controller.add_variable_node_from_object_path('joints', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(1060.0, -1328.0), 'Get joints')
        get_spline_controls = controller.add_variable_node_from_object_path('spline_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(1260.0, -2248.0), 'Get spline_controls')
        get_control_count = controller.add_variable_node('control_count', 'int32', None, True, '', unreal.Vector2D(1060.0, -2368.0), 'Get control_count')
        get_hierarchy = controller.add_variable_node('hierarchy', 'bool', None, True, '', unreal.Vector2D(1060.0, -2228.0), 'Get hierarchy')
        get_parent = controller.add_variable_node_from_object_path('parent', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(1060.0, -1928.0), 'Get parent')
        get_last_control = controller.add_variable_node_from_object_path('last_control', 'FRigElementKey', '/Script/ControlRig.RigElementKey', True, '', unreal.Vector2D(1060.0, -2068.0), 'Get last_control')
        reset = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayReset(io Array)', unreal.Vector2D(1960.0, -2668.0), 'Reset')
        for_loop = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ForLoopCount', 'Execute', unreal.Vector2D(2260.0, -2568.0), 'For Loop')
        greater = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntGreater', 'Execute', unreal.Vector2D(1544.0, -2472.0), 'Greater')
        if1 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(1896.0, -2440.0), 'If')
        num = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetNum(in Array,out Num)', unreal.Vector2D(1760.0, -2068.0), 'Num')
        greater1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntGreater', 'Execute', unreal.Vector2D(1960.0, -2068.0), 'Greater')
        if2 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(2184.0, -1960.0), 'If')
        equals = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(2460.0, -2368.0), 'Equals')
        if3 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(2660.0, -2218.0), 'If')
        if4 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(2860.0, -2068.0), 'If')
        position_from_spline = controller.add_unit_node_from_struct_path('/Script/ControlRigSpline.RigUnit_PositionFromControlRigSpline', 'Execute', unreal.Vector2D(2760.0, -2668.0), 'Position From Spline')
        make_transform = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathTransformMake', 'Execute', unreal.Vector2D(3060.0, -2668.0), 'Make Transform')
        spawn_null = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddNull', 'Execute', unreal.Vector2D(3460.0, -2668.0), 'Spawn Null')
        set_default_parent = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetDefaultParent', 'Execute', unreal.Vector2D(4696.0, -1864.0), 'Set Default Parent')
        get_spline_controls1 = controller.add_variable_node_from_object_path('spline_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(5464.0, -2024.0), 'Get spline_controls')
        at = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(5160.0, -1328.0), 'At')
        add = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayAdd(io Array,in Element,out Index)', unreal.Vector2D(5640.0, -1864.0), 'Add')
        set_item_array_metadata = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in NameSpace,in Value,out Success)', unreal.Vector2D(6260.0, -1668.0), 'Set Item Array Metadata')
        at1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(6536.0, -1784.0), 'At')
        spawn_bool_animation_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelBool', 'Execute', unreal.Vector2D(6860.0, -1668.0), 'Spawn Bool Animation Channel')
        get_spline_controls2 = controller.add_variable_node_from_object_path('spline_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(5912.0, -1400.0), 'Get spline_controls')
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(1752.0, -1928.0), 'vetalaLib_GetItem')
        vetala_lib_control = self._create_control(controller, 4184.0, -2168.0)
        equals1 = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(3176.0, -2232.0), 'Equals')
        branch = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(4088.0, -2440.0), 'Branch')
        set_last_control = controller.add_variable_node_from_object_path('last_control', 'FRigElementKey', '/Script/ControlRig.RigElementKey', False, '', unreal.Vector2D(5976.0, -2600.0), 'Set last_control')
        add1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayAdd(io Array,in Element,out Index)', unreal.Vector2D(5656.0, -2520.0), 'Add')
        greater2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntGreater', 'Execute', unreal.Vector2D(3288.0, -2376.0), 'Greater')
        less = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntLess', 'Execute', unreal.Vector2D(3432.0, -2184.0), 'Less')
        and1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathBoolAnd', 'Execute', unreal.Vector2D(3560.0, -2360.0), 'And')
        subtract = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntSub', 'Execute', unreal.Vector2D(3272.0, -1912.0), 'Subtract')
        set_default_parent1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetDefaultParent', 'Execute', unreal.Vector2D(5208.0, -2824.0), 'Set Default Parent')
        get_spline_controls3 = controller.add_variable_node_from_object_path('spline_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(5416.0, -2440.0), 'Get spline_controls')
        spawn_null1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddNull', 'Execute', unreal.Vector2D(4632.0, -2840.0), 'Spawn Null')
        equals2 = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(6008.0, -2056.0), 'Equals')
        branch1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(6248.0, -2040.0), 'Branch')
        set_first_control = controller.add_variable_node_from_object_path('first_control', 'FRigElementKey', '/Script/ControlRig.RigElementKey', False, '', unreal.Vector2D(6456.0, -2184.0), 'Set first_control')
        branch2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(6408.0, -2600.0), 'Branch')
        get_first_control = controller.add_variable_node_from_object_path('first_control', 'FRigElementKey', '/Script/ControlRig.RigElementKey', True, '', unreal.Vector2D(6600.0, -2472.0), 'Get first_control')
        set_default_parent2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetDefaultParent', 'Execute', unreal.Vector2D(6840.0, -2600.0), 'Set Default Parent')
        if5 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(3864.0, -2008.0), 'If')
        branch3 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(6696.0, -2184.0), 'Branch')
        get_last_control1 = controller.add_variable_node_from_object_path('last_control', 'FRigElementKey', '/Script/ControlRig.RigElementKey', True, '', unreal.Vector2D(6920.0, -2168.0), 'Get last_control')
        set_default_parent3 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetDefaultParent', 'Execute', unreal.Vector2D(7208.0, -2344.0), 'Set Default Parent')
        equals3 = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(3640.0, -2056.0), 'Equals')
        and2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathBoolAnd', 'Execute', unreal.Vector2D(3864.0, -2216.0), 'And')
        set_last_control1 = controller.add_variable_node_from_object_path('last_control', 'FRigElementKey', '/Script/ControlRig.RigElementKey', False, '', unreal.Vector2D(7000.0, -1960.0), 'Set last_control')
        and3 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathBoolAnd', 'Execute', unreal.Vector2D(3736.0, -2344.0), 'And')
        if6 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(3864.0, -1848.0), 'If')
        subtract1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntSub', 'Execute', unreal.Vector2D(3720.0, -1672.0), 'Subtract')
        ...
        controller.resolve_wild_card_pin(f'{if5.get_node_path()}.Result', 'FRigElementKey', '/Script/ControlRig.RigElementKey')
        ...
        graph.add_link(set_local_controls, 'ExecuteContext', spawn_bool_animation_channel, 'ExecutePin', controller)
        ...
        graph.add_link(add, 'ExecuteContext', branch1, 'ExecuteContext', controller)
        graph.add_link(branch, 'False', vetala_lib_control, 'ExecuteContext', controller)
        graph.add_link(add1, 'ExecuteContext', set_last_control, 'ExecuteContext', controller)
        graph.add_link(set_last_control, 'ExecuteContext', branch2, 'ExecuteContext', controller)
        ...
        graph.add_link(branch1, 'Completed', branch3, 'ExecuteContext', controller)
        graph.add_link(branch3, 'Completed', set_last_control1, 'ExecuteContext', controller)
        ...
        graph.add_link(for_loop, 'Index', greater2, 'A', controller)
        graph.add_link(for_loop, 'Index', less, 'A', controller)
        graph.add_link(for_loop, 'Index', equals2, 'A', controller)
        graph.add_link(for_loop, 'Index', equals3, 'A', controller)
        graph.add_link(for_loop, 'Index', if6, 'False', controller)
        ...
        graph.add_link(spawn_null, 'Item', set_last_control, 'Value', controller)
        graph.add_link(spawn_null, 'Item', add1, 'Element', controller)
        ...
        graph.add_link(vetala_lib_control, 'Control', add, 'Element', controller)
        graph.add_link(get_spline_controls2, 'Value', set_item_array_metadata, 'Value', controller)
        graph.add_link(get_spline_controls2, 'Value', at1, 'Array', controller)
        graph.add_link(at1, 'Element', spawn_bool_animation_channel, 'Parent', controller)
        graph.add_link(if6, 'Result', vetala_lib_control, 'increment', controller)
        graph.add_link(if5, 'Result', vetala_lib_control, 'parent', controller)
        ...
        graph.add_link(vetala_lib_control, 'Control', set_default_parent3, 'Parent', controller)
        graph.add_link(vetala_lib_control, 'Control', set_last_control1, 'Value', controller)
        graph.add_link(equals1, 'Result', and2, 'B', controller)
        graph.add_link(equals1, 'Result', and3, 'B', controller)
        graph.add_link(and3, 'Result', branch, 'Condition', controller)
        graph.add_link(branch, 'True', spawn_null1, 'ExecutePin', controller)
        graph.add_link(get_spline_controls3, 'Value', add1, 'Array', controller)
        graph.add_link(greater2, 'Result', and1, 'A', controller)
        graph.add_link(subtract, 'Result', less, 'B', controller)
        graph.add_link(less, 'Result', and1, 'B', controller)
        graph.add_link(and1, 'Result', and3, 'A', controller)
        graph.add_link(subtract, 'Result', equals3, 'B', controller)
        ...
        graph.add_link(and2, 'Result', if5, 'Condition', controller)
        graph.add_link(and2, 'Result', branch3, 'Condition', controller)
        graph.add_link(branch3, 'True', set_default_parent3, 'ExecutePin', controller)
        graph.add_link(get_last_control1, 'Value', set_default_parent3, 'Child', controller)
        graph.add_link(equals3, 'Result', and2, 'A', controller)
        graph.add_link(and2, 'Result', if6, 'Condition', controller)
        graph.add_link(subtract1, 'Result', if6, 'True', controller)
        ...
        graph.set_pin(spawn_null1, 'Name', 'NewNull', controller)
        ...
        graph.set_pin(subtract1, 'B', '2', controller)
...
class UnrealFootRollRig(UnrealUtilRig):
    ...
    def _build_function_construct_graph(self):
        ...
        spawn_transform_control1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddControlTransform', 'Execute', unreal.Vector2D(2992.0, -2640.0), 'Spawn Transform Control')
        ...
        graph.add_link(from_string1, 'Result', spawn_null, 'Name', controller)
        ...
        graph.add_link(from_string4, 'Result', spawn_null2, 'Name', controller)
    ...
    def _build_function_forward_graph(self):
        ...
        get_control_layer = controller.add_variable_node('control_layer', 'FName', None, True, '', unreal.Vector2D(1040.0, 2280.0), 'Get control_layer')
        get_item_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(1808.0, 1648.0), 'Get Item Metadata')
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(2503.0, 1912.0), 'Get Transform')
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(1280.0, 2664.0), 'vetalaLib_GetItem')
        get_item_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(1680.0, 2360.0), 'Get Item Metadata')
        vetala_lib_get_item1 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(1136.0, 1968.0), 'vetalaLib_GetItem')
        basic_fabrik = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_FABRIKItemArray', 'Execute', unreal.Vector2D(3904.0, 1664.0), 'Basic FABRIK')
        make_array = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayMake(in Values,out Array)', unreal.Vector2D(2534.0, 2648.0), 'Make Array')
        basic_fabrik1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_FABRIKItemArray', 'Execute', unreal.Vector2D(3472.0, 2080.0), 'Basic FABRIK')
        make_array1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayMake(in Values,out Array)', unreal.Vector2D(2576.0, 1728.0), 'Make Array')
        get_item_metadata2 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(1680.0, 2120.0), 'Get Item Metadata')
        project_to_new_parent = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ProjectTransformToNewParent', 'Execute', unreal.Vector2D(2502.0, 2168.0), 'Project to new Parent')
        vetala_lib_get_item2 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(976.0, 1792.0), 'vetalaLib_GetItem')
        make_array2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayMake(in Values,out Array)', unreal.Vector2D(3952.0, 1940.0), 'Make Array')
        at = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(4496.0, 1977.0), 'At')
        get_name_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(4736.0, 1977.0), 'Get Name Metadata')
        get_control_float = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetControlFloat', 'Execute', unreal.Vector2D(5072.0, 1977.0), 'Get Control Float')
        make_array3 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayMake(in Values,out Array)', unreal.Vector2D(4160.0, 1108.0), 'Make Array')
        get_item_metadata3 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(5120.0, 500.0), 'Get Item Metadata')
        get_joints = controller.add_variable_node_from_object_path('joints', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(3136.0, 1392.0), 'Get joints')
        vetala_lib_get_item3 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(3344.0, 1360.0), 'vetalaLib_GetItem')
        at1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(4496.0, 500.0), 'At')
        from_string = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(4695.0, 500.0), 'From String')
        get_vector_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(5920.0, 1604.0), 'Get Vector Metadata')
        cross = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorCross', 'Execute', unreal.Vector2D(6288.0, 1732.0), 'Cross')
        get_vector_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(5920.0, 1764.0), 'Get Vector Metadata')
        from_axis_and_angle = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionFromAxisAndAngle', 'Execute', unreal.Vector2D(6768.0, 1780.0), 'From Axis And Angle')
        multiply = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleMul', 'Execute', unreal.Vector2D(5808.0, 2132.0), 'Multiply')
        set_rotation = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetRotation', 'Execute', unreal.Vector2D(8400.0, 500.0), 'Set Rotation')
        get_item_metadata4 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(5120.0, 724.0), 'Get Item Metadata')
        at2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(4505.0, 724.0), 'At')
        from_string1 = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(4704.0, 724.0), 'From String')
        get_item_metadata5 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(5120.0, 948.0), 'Get Item Metadata')
        at3 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(4505.0, 948.0), 'At')
        from_string2 = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(4704.0, 948.0), 'From String')
        get_item_metadata6 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(5120.0, 1172.0), 'Get Item Metadata')
        at4 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(4505.0, 1172.0), 'At')
        from_string3 = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(4704.0, 1172.0), 'From String')
        evaluate_curve = controller.add_unit_node_with_defaults(unreal.load_object(None, '/Script/RigVM.RigVMFunction_AnimEvalRichCurve'), '(Curve=(EditorCurveData=(Keys=((),(Time=0.500000,Value=1.000000),(Time=1.000000)))),SourceMinimum=0.000000,SourceMaximum=1.000000,TargetMinimum=0.000000,TargetMaximum=1.000000)', 'Execute', unreal.Vector2D(6240.0, 2164.0), 'Evaluate Curve')
        from_axis_and_angle1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionFromAxisAndAngle', 'Execute', unreal.Vector2D(7088.0, 2004.0), 'From Axis And Angle')
        get_parent = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyGetParent', 'Execute', unreal.Vector2D(5952.0, 532.0), 'Get Parent')
        negate = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorNegate', 'Execute', unreal.Vector2D(6544.0, 1716.0), 'Negate')
        from_axis_and_angle2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionFromAxisAndAngle', 'Execute', unreal.Vector2D(6768.0, 1604.0), 'From Axis And Angle')
        get_parent1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyGetParent', 'Execute', unreal.Vector2D(5952.0, 1296.0), 'Get Parent')
        set_rotation1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetRotation', 'Execute', unreal.Vector2D(8400.0, 1124.0), 'Set Rotation')
        radians = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleRad', 'Execute', unreal.Vector2D(6880.0, 2180.0), 'Radians')
        multiply1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleMul', 'Execute', unreal.Vector2D(6720.0, 2356.0), 'Multiply')
        get_control_float1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetControlFloat', 'Execute', unreal.Vector2D(5072.0, 2532.0), 'Get Control Float')
        get_name_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(4736.0, 2521.0), 'Get Name Metadata')
        evaluate_curve1 = controller.add_unit_node_with_defaults(unreal.load_object(None, '/Script/RigVM.RigVMFunction_AnimEvalRichCurve'), '(Curve=(EditorCurveData=(Keys=((),(Time=0.250000),(InterpMode=RCIM_Constant,Time=1.000000,Value=1.000000)))),SourceMinimum=0.000000,SourceMaximum=2.000000,TargetMinimum=0.000000,TargetMaximum=90.000000)', 'Execute', unreal.Vector2D(6240.0, 2612.0), 'Evaluate Curve')
        radians1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleRad', 'Execute', unreal.Vector2D(6827.0, 3003.0), 'Radians')
        from_axis_and_angle3 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionFromAxisAndAngle', 'Execute', unreal.Vector2D(7088.0, 2756.0), 'From Axis And Angle')
        evaluate_curve2 = controller.add_unit_node_with_defaults(unreal.load_object(None, '/Script/RigVM.RigVMFunction_AnimEvalRichCurve'), '(Curve=(EditorCurveData=(Keys=((),(InterpMode=RCIM_Constant,Time=1.000000,Value=1.000000)))),SourceMinimum=0.000000,SourceMaximum=2.000000,TargetMinimum=0.000000,TargetMaximum=-90.000000)', 'Execute', unreal.Vector2D(6240.0, 3076.0), 'Evaluate Curve')
        multiply2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleMul', 'Execute', unreal.Vector2D(5808.0, 2692.0), 'Multiply')
        set_rotation2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetRotation', 'Execute', unreal.Vector2D(8400.0, 788.0), 'Set Rotation')
        get_parent2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyGetParent', 'Execute', unreal.Vector2D(5952.0, 772.0), 'Get Parent')
        from_axis_and_angle4 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionFromAxisAndAngle', 'Execute', unreal.Vector2D(7088.0, 3428.0), 'From Axis And Angle')
        radians2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleRad', 'Execute', unreal.Vector2D(6848.0, 3460.0), 'Radians')
        multiply3 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleMul', 'Execute', unreal.Vector2D(5808.0, 2404.0), 'Multiply')
        at5 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(4512.0, 2858.0), 'At')
        get_name_metadata2 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(4752.0, 2837.0), 'Get Name Metadata')
        get_control_float2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetControlFloat', 'Execute', unreal.Vector2D(5088.0, 2848.0), 'Get Control Float')
        from_axis_and_angle5 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionFromAxisAndAngle', 'Execute', unreal.Vector2D(7088.0, 3860.0), 'From Axis And Angle')
        multiply4 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionMul', 'Execute', unreal.Vector2D(7584.0, 3652.0), 'Multiply')
        at6 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(4464.0, 3151.0), 'At')
        get_name_metadata3 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(4768.0, 3130.0), 'Get Name Metadata')
        get_control_float3 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetControlFloat', 'Execute', unreal.Vector2D(5104.0, 3141.0), 'Get Control Float')
        from_axis_and_angle6 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionFromAxisAndAngle', 'Execute', unreal.Vector2D(7104.0, 4084.0), 'From Axis And Angle')
        multiply5 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionMul', 'Execute', unreal.Vector2D(7952.0, 4068.0), 'Multiply')
        rig_element_key = controller.add_free_reroute_node('FRigElementKey', unreal.load_object(None, '/Script/ControlRig.RigElementKey').get_name(), is_constant=False, custom_widget_name='', default_value='', position=[3843.0, 2476.0], node_name='', setup_undo_redo=True)
        at7 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(4496.0, 2420.0), 'At')
        at8 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(4464.0, 3482.0), 'At')
        get_name_metadata4 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(4768.0, 3461.0), 'Get Name Metadata')
        get_control_float4 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetControlFloat', 'Execute', unreal.Vector2D(5104.0, 3472.0), 'Get Control Float')
        from_axis_and_angle7 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionFromAxisAndAngle', 'Execute', unreal.Vector2D(7104.0, 4292.0), 'From Axis And Angle')
        multiply6 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionMul', 'Execute', unreal.Vector2D(7613.0, 4308.0), 'Multiply')
        at9 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(4464.0, 3786.0), 'At')
        get_name_metadata5 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(4768.0, 3765.0), 'Get Name Metadata')
        get_control_float5 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetControlFloat', 'Execute', unreal.Vector2D(5104.0, 3776.0), 'Get Control Float')
        get_parent3 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyGetParent', 'Execute', unreal.Vector2D(5952.0, 1460.0), 'Get Parent')
        set_rotation3 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetRotation', 'Execute', unreal.Vector2D(8384.0, 1412.0), 'Set Rotation')
        from_axis_and_angle8 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionFromAxisAndAngle', 'Execute', unreal.Vector2D(7088.0, 4516.0), 'From Axis And Angle')
        from_axis_and_angle9 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionFromAxisAndAngle', 'Execute', unreal.Vector2D(6528.0, 3892.0), 'From Axis And Angle')
        multiply7 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionMul', 'Execute', unreal.Vector2D(8176.0, 3988.0), 'Multiply')
        at10 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(4464.0, 4058.0), 'At')
        get_name_metadata6 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(4768.0, 4037.0), 'Get Name Metadata')
        get_control_float6 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetControlFloat', 'Execute', unreal.Vector2D(5104.0, 4048.0), 'Get Control Float')
        greater = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleGreater', 'Execute', unreal.Vector2D(6944.0, 4916.0), 'Greater')
        if1 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(7200.0, 4932.0), 'If')
        from_axis_and_angle10 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionFromAxisAndAngle', 'Execute', unreal.Vector2D(7056.0, 5108.0), 'From Axis And Angle')
        negate1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorNegate', 'Execute', unreal.Vector2D(6304.0, 4244.0), 'Negate')
        from_axis_and_angle11 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionFromAxisAndAngle', 'Execute', unreal.Vector2D(7056.0, 5252.0), 'From Axis And Angle')
        if2 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(7104.0, 5460.0), 'If')
        less = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleLess', 'Execute', unreal.Vector2D(6896.0, 5460.0), 'Less')
        get_parent4 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyGetParent', 'Execute', unreal.Vector2D(5968.0, 948.0), 'Get Parent')
        get_parent5 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyGetParent', 'Execute', unreal.Vector2D(5968.0, 1076.0), 'Get Parent')
        set_rotation4 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetRotation', 'Execute', unreal.Vector2D(8384.0, 1748.0), 'Set Rotation')
        set_rotation5 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetRotation', 'Execute', unreal.Vector2D(8368.0, 2036.0), 'Set Rotation')
        multiply8 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleMul', 'Execute', unreal.Vector2D(6448.0, 5268.0), 'Multiply')
        at11 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(4464.0, 4346.0), 'At')
        get_name_metadata7 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(4768.0, 4325.0), 'Get Name Metadata')
        get_control_float7 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetControlFloat', 'Execute', unreal.Vector2D(5104.0, 4336.0), 'Get Control Float')
        at12 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(4464.0, 4570.0), 'At')
        get_name_metadata8 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(4768.0, 4549.0), 'Get Name Metadata')
        get_control_float8 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetControlFloat', 'Execute', unreal.Vector2D(5104.0, 4560.0), 'Get Control Float')
        at13 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(4464.0, 4778.0), 'At')
        get_name_metadata9 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(4768.0, 4757.0), 'Get Name Metadata')
        get_control_float9 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetControlFloat', 'Execute', unreal.Vector2D(5104.0, 4768.0), 'Get Control Float')
        from_axis_and_angle12 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionFromAxisAndAngle', 'Execute', unreal.Vector2D(7088.0, 5716.0), 'From Axis And Angle')
        multiply9 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionMul', 'Execute', unreal.Vector2D(8256.0, 4676.0), 'Multiply')
        from_axis_and_angle13 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionFromAxisAndAngle', 'Execute', unreal.Vector2D(7104.0, 5924.0), 'From Axis And Angle')
        vector = controller.add_free_reroute_node('FVector', unreal.load_object(None, '/Script/CoreUObject.Vector').get_name(), is_constant=False, custom_widget_name='', default_value='', position=[6256.0, 5860.0], node_name='', setup_undo_redo=True)
        vector1 = controller.add_free_reroute_node('FVector', unreal.load_object(None, '/Script/CoreUObject.Vector').get_name(), is_constant=False, custom_widget_name='', default_value='', position=[5936.0, 4244.0], node_name='', setup_undo_redo=True)
        set_rotation6 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetRotation', 'Execute', unreal.Vector2D(8880.0, 916.0), 'Set Rotation')
        from_axis_and_angle14 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionFromAxisAndAngle', 'Execute', unreal.Vector2D(7088.0, 6116.0), 'From Axis And Angle')
        multiply10 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionMul', 'Execute', unreal.Vector2D(8144.0, 3700.0), 'Multiply')
        radians3 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleRad', 'Execute', unreal.Vector2D(5541.0, 3007.0), 'Radians')
        radians4 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleRad', 'Execute', unreal.Vector2D(5553.0, 3322.0), 'Radians')
        radians5 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleRad', 'Execute', unreal.Vector2D(5584.0, 3557.0), 'Radians')
        radians6 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleRad', 'Execute', unreal.Vector2D(5568.0, 3845.0), 'Radians')
        radians7 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleRad', 'Execute', unreal.Vector2D(5584.0, 4197.0), 'Radians')
        radians8 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleRad', 'Execute', unreal.Vector2D(5602.0, 4511.0), 'Radians')
        radians9 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleRad', 'Execute', unreal.Vector2D(5709.0, 4809.0), 'Radians')
        radians10 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleRad', 'Execute', unreal.Vector2D(5742.0, 4997.0), 'Radians')
        to_integer = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathBoolToInteger', 'Execute', unreal.Vector2D(1424.0, 1024.0), 'To Integer')
        get_parent6 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyGetParent', 'Execute', unreal.Vector2D(6304.0, 1216.0), 'Get Parent')
        branch = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(1520.0, 544.0), 'Branch')
        set_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(2512.0, 560.0), 'Set Transform')
        project_to_new_parent1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ProjectTransformToNewParent', 'Execute', unreal.Vector2D(2064.0, 512.0), 'Project to new Parent')
        item_exists = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ItemExists', 'Execute', unreal.Vector2D(1088.0, 880.0), 'Item Exists')
        vetala_lib_get_item4 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(816.0, 800.0), 'vetalaLib_GetItem')
        vetala_lib_get_item5 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(1008.0, 1168.0), 'vetalaLib_GetItem')
        item_exists1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ItemExists', 'Execute', unreal.Vector2D(1264.0, 1136.0), 'Item Exists')
        get_item_metadata7 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(1536.0, 1280.0), 'Get Item Metadata')
        get_float_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannelFromItem', 'Execute', unreal.Vector2D(1904.0, 1376.0), 'Get Float Channel')
        equals = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(2128.0, 1232.0), 'Equals')
        select = controller.add_template_node('DISPATCH_RigVMDispatch_SelectInt32(in Index,in Values,out Result)', unreal.Vector2D(1760.0, 976.0), 'Select')
        if3 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(2208.0, 1008.0), 'If')
        ...
        graph.add_link(get_item_metadata1, 'Value', project_to_new_parent, 'Child', controller)
        ...
        graph.add_link(get_item_metadata2, 'Value', project_to_new_parent, 'NewParent', controller)
        graph.add_link(get_item_metadata2, 'Value', project_to_new_parent, 'OldParent', controller)
        ...
        graph.add_link(vetala_lib_get_item3, 'Element', get_item_metadata3, 'Item', controller)
        ...
        graph.add_link(get_joints, 'Value', vetala_lib_get_item3, 'Array', controller)
        graph.add_link(vetala_lib_get_item3, 'Element', get_item_metadata4, 'Item', controller)
        graph.add_link(vetala_lib_get_item3, 'Element', get_item_metadata5, 'Item', controller)
        graph.add_link(vetala_lib_get_item3, 'Element', get_item_metadata6, 'Item', controller)
        graph.add_link(vetala_lib_get_item3, 'Element', get_vector_metadata, 'Item', controller)
        graph.add_link(vetala_lib_get_item3, 'Element', get_vector_metadata1, 'Item', controller)
        ...
        graph.add_link(branch, 'True', set_transform, 'ExecutePin', controller)
        graph.add_link(vetala_lib_get_item4, 'Element', set_transform, 'Item', controller)
        graph.add_link(project_to_new_parent1, 'Transform', set_transform, 'Value', controller)
        graph.add_link(vetala_lib_get_item4, 'Element', project_to_new_parent1, 'Child', controller)
        graph.add_link(vetala_lib_get_item4, 'Element', item_exists, 'Item', controller)
        graph.add_link('Entry', 'ik', vetala_lib_get_item4, 'Array', controller)
        ...
        graph.set_pin(basic_fabrik1, 'bSetEffectorTransform', 'true', controller)
        ...
        graph.set_pin(if3, 'False', 'False', controller)
...
class UnrealIkQuadrupedRig(UnrealUtilRig):
    ...
    def _build_controls(self, controller, library):
        ...
        get_local_controls = controller.add_variable_node_from_object_path('local_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(3024.0, -1680.0), 'Get local_controls')

        vetala_lib_find_pole_vector = controller.add_function_reference_node(library.find_function('vetalaLib_findPoleVector'), unreal.Vector2D(4744.0, -1580.0), 'vetalaLib_findPoleVector')
        for_each = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayIterator(in Array,out Element,out Index,out Count,out Ratio)', unreal.Vector2D(1452.0, -1676.0), 'For Each')
        vetala_lib_control = self._create_control(controller, 2452.0, -1726.0)
        vetala_lib_get_parent = controller.add_function_reference_node(library.find_function('vetalaLib_GetParent'), unreal.Vector2D(1864.0, -1884.0), 'vetalaLib_GetParent')
        vetala_lib_get_joint_description = controller.add_function_reference_node(library.find_function('vetalaLib_GetJointDescription'), unreal.Vector2D(1952.0, -1560.0), 'vetalaLib_GetJointDescription')
        set_item_metadata = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in NameSpace,in Value,out Success)', unreal.Vector2D(2784.0, -1936.0), 'Set Item Metadata')
        get_control_layer = controller.add_variable_node('control_layer', 'FName', None, True, '', unreal.Vector2D(1280.0, -1816.0), 'Get control_layer')
        equals = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(1632.0, -1880.0), 'Equals')
        get_description = controller.add_variable_node('description', 'FString', None, True, '', unreal.Vector2D(1000.0, -1056.0), 'Get description')
        get_use_joint_name = controller.add_variable_node('use_joint_name', 'bool', None, True, '', unreal.Vector2D(1848.0, -1072.0), 'Get use_joint_name')
        get_joint_token = controller.add_variable_node('joint_token', 'FString', None, True, '', unreal.Vector2D(1452.0, -1426.0), 'Get joint_token')
        if1 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(2202.0, -1126.0), 'If')
        get_world = controller.add_variable_node('world', 'bool', None, True, '', unreal.Vector2D(1200.0, -1272.0), 'Get world')
        get_mirror = controller.add_variable_node('mirror', 'bool', None, True, '', unreal.Vector2D(1200.0, -1172.0), 'Get mirror')
        add = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayAdd(io Array,in Element,out Index)', unreal.Vector2D(3384.0, -1900.0), 'Add')

        get_pole_vector_shape = controller.add_variable_node('pole_vector_shape', 'FString', None, True, '', unreal.Vector2D(3052.0, -1451.0), 'Get pole_vector_shape')
        from_string = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(3252.0, -1426.0), 'From String')
        shape_exists = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ShapeExists', 'Execute', unreal.Vector2D(3452.0, -1426.0), 'Shape Exists')
        if2 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(3376.0, -1624.0), 'If')
        set_shape_settings = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchySetShapeSettings', 'Execute', unreal.Vector2D(3652.0, -1526.0), 'Set Shape Settings')
        vetala_lib_parent = controller.add_function_reference_node(library.find_function('vetalaLib_Parent'), unreal.Vector2D(4052.0, -1426.0), 'vetalaLib_Parent')
        vetala_lib_parent1 = controller.add_function_reference_node(library.find_function('vetalaLib_Parent'), unreal.Vector2D(4352.0, -1226.0), 'vetalaLib_Parent')
        get_color = controller.add_variable_node_from_object_path('color', 'TArray<FLinearColor>', '/Script/CoreUObject.LinearColor', True, '()', unreal.Vector2D(3052.0, -1376.0), 'Get color')
        at = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(3352.0, -1326.0), 'At')
        at1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(3424.0, -1160.0), 'At')
        at2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(3424.0, -1032.0), 'At')
        at3 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(3432.0, -880.0), 'At')
        get_shape_scale = controller.add_variable_node_from_object_path('shape_scale', 'TArray<FVector>', '/Script/CoreUObject.Vector', True, '()', unreal.Vector2D(2652.0, -1526.0), 'Get shape_scale')
        at4 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(2802.0, -1526.0), 'At')
        multiply = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorMul', 'Execute', unreal.Vector2D(2952.0, -1526.0), 'Multiply')
        get_joints = controller.add_variable_node_from_object_path('joints', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(3824.0, -1688.0), 'Get joints')
        at5 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(4096.0, -1792.0), 'At')
        at6 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(4096.0, -1692.0), 'At')
        at7 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(4096.0, -1592.0), 'At')
        get_pole_vector_offset = controller.add_variable_node('pole_vector_offset', 'float', None, True, '', unreal.Vector2D(4352.0, -1676.0), 'Get pole_vector_offset')
        set_translation = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTranslation', 'Execute', unreal.Vector2D(5152.0, -1528.0), 'Set Translation')
        greater = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntGreater', 'Execute', unreal.Vector2D(744.0, -1692.0), 'Greater')
        if3 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(944.0, -1592.0), 'If')
        spawn_null = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddNull', 'Execute', unreal.Vector2D(5808.0, -1984.0), 'Spawn Null')
        if4 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(5496.0, -608.0), 'If')
        get_item_array_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(5032.0, -624.0), 'Get Item Array Metadata')
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(5768.0, -656.0), 'vetalaLib_GetItem')
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(5792.0, -1488.0), 'Get Transform')
        get_local_ik = controller.add_variable_node_from_object_path('local_ik', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(6144.0, -1320.0), 'Get local_ik')
        add1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayAdd(io Array,in Element,out Index)', unreal.Vector2D(6304.0, -1608.0), 'Add')
        num = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetNum(in Array,out Num)', unreal.Vector2D(5192.0, -416.0), 'Num')
        greater1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntGreater', 'Execute', unreal.Vector2D(5352.0, -464.0), 'Greater')
        get_joints1 = controller.add_variable_node_from_object_path('joints', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(5608.0, -1056.0), 'Get joints')
        vetala_lib_get_item1 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(6256.0, -1112.0), 'vetalaLib_GetItem')
        set_item_array_metadata = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in NameSpace,in Value,out Success)', unreal.Vector2D(6576.0, -1632.0), 'Set Item Array Metadata')
        spawn_bool_animation_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelBool', 'Execute', unreal.Vector2D(7072.0, -1592.0), 'Spawn Bool Animation Channel')
        spawn_float_animation_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelFloat', 'Execute', unreal.Vector2D(7088.0, -1032.0), 'Spawn Float Animation Channel')
        rig_element_key = controller.add_free_reroute_node('FRigElementKey', unreal.load_object(None, '/Script/ControlRig.RigElementKey').get_name(), is_constant=False, custom_widget_name='', default_value='', position=[6858.0, -1195.0], node_name='', setup_undo_redo=True)
        spawn_float_animation_channel1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelFloat', 'Execute', unreal.Vector2D(5472.0, -1512.0), 'Spawn Float Animation Channel')
        num1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetNum(in Array,out Num)', unreal.Vector2D(864.0, -760.0), 'Num')
        equals1 = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(1880.0, -320.0), 'Equals')
        branch = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(2912.0, -1176.0), 'Branch')
        get_local_controls2 = controller.add_variable_node_from_object_path('local_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(3072.0, -968.0), 'Get local_controls')
        at8 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(4648.0, -832.0), 'At')
        vetala_lib_parent2 = controller.add_function_reference_node(library.find_function('vetalaLib_Parent'), unreal.Vector2D(3296.0, -616.0), 'vetalaLib_Parent')
        branch1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(6816.0, -824.0), 'Branch')
        make_array = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayMake(in Values,out Array)', unreal.Vector2D(1584.0, -712.0), 'Make Array')
        get_joints2 = controller.add_variable_node_from_object_path('joints', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(600.0, -896.0), 'Get joints')
        at9 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(1256.0, -736.0), 'At')
        at10 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(1256.0, -512.0), 'At')
        or1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathBoolOr', 'Execute', unreal.Vector2D(2600.0, -384.0), 'Or')
        at11 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(1256.0, -624.0), 'At')
        at12 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(1256.0, -384.0), 'At')
        at13 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(3432.0, -752.0), 'At')
        vetala_lib_parent3 = controller.add_function_reference_node(library.find_function('vetalaLib_Parent'), unreal.Vector2D(4584.0, -1136.0), 'vetalaLib_Parent')
        equals2 = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(1816.0, -976.0), 'Equals')
        if5 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(2040.0, -944.0), 'If')
        concat = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_StringConcat', 'Execute', unreal.Vector2D(1864.0, -800.0), 'Concat')
        if6 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(2264.0, -848.0), 'If')
        equals3 = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(2216.0, -992.0), 'Equals')
        if7 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(2506.583251953125, -863.2752685546875), 'If')
        set_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(4968.0, -1088.0), 'Set Transform')
        get_transform1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(3960.0, -784.0), 'Get Transform')
        if8 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(2088.0, -672.0), 'If')
        if9 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(2376.0, -672.0), 'If')
        vetala_lib_get_item2 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(5304.0, -816.0), 'vetalaLib_GetItem')
        equals4 = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(774.762939453125, -1016.4758911132812), 'Equals')
        branch2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(832.0, -1360.0), 'Branch')
        spawn_null1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddNull', 'Execute', unreal.Vector2D(7104.0, -1936.0), 'Spawn Null')
        get_transform2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(5568.0, -896.0), 'Get Transform')
        at14 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(5392.0, -1024.0), 'At')
        vetala_lib_parent4 = controller.add_function_reference_node(library.find_function('vetalaLib_Parent'), unreal.Vector2D(7516.99755859375, -1767.9906005859375), 'vetalaLib_Parent')
        ...
        graph.add_link(spawn_null, 'ExecutePin', add1, 'ExecuteContext', controller)
        graph.add_link(add1, 'ExecuteContext', set_item_array_metadata, 'ExecuteContext', controller)
        graph.add_link(set_item_array_metadata, 'ExecuteContext', spawn_null1, 'ExecutePin', controller)
        ...
        graph.add_link(spawn_null1, 'ExecutePin', vetala_lib_parent4, 'ExecuteContext', controller)
        graph.add_link(at5, 'Element', vetala_lib_find_pole_vector, 'BoneA', controller)
        graph.add_link(at6, 'Element', vetala_lib_find_pole_vector, 'BoneB', controller)
        graph.add_link(at7, 'Element', vetala_lib_find_pole_vector, 'BoneC', controller)
        graph.add_link(get_pole_vector_offset, 'Value', vetala_lib_find_pole_vector, 'output', controller)
        ...
        graph.add_link(equals1, 'Result', or1, 'A', controller)
        graph.add_link(or1, 'Result', branch, 'Condition', controller)
        graph.add_link(get_local_controls2, 'Value', at13, 'Array', controller)
        graph.add_link(or1, 'Result', branch1, 'Condition', controller)
        graph.add_link(get_joints2, 'Value', at9, 'Array', controller)
        graph.add_link(get_joints2, 'Value', at10, 'Array', controller)
        ...
        graph.add_link(at14, 'Element', spawn_null1, 'Parent', controller)
        graph.add_link(spawn_null1, 'Item', vetala_lib_parent4, 'Parent', controller)
        graph.add_link(get_transform2, 'Transform', spawn_null1, 'Transform', controller)
        graph.add_link(if2, 'Result', set_shape_settings, 'Settings.Name', controller)
        graph.add_link(at, 'Element', set_shape_settings, 'Settings.Color', controller)
        graph.add_link(at8, 'Element', if4, 'False.0', controller)
        graph.add_link(at9, 'Element', make_array, 'Values.0', controller)
        ...
        graph.set_pin(spawn_null1, 'Name', 'quad_ik_offset', controller)
        graph.set_pin(spawn_null1, 'Space', 'LocalSpace', controller)
        graph.set_pin(get_transform2, 'Space', 'GlobalSpace', controller)
        graph.set_pin(get_transform2, 'bInitial', 'False', controller)
    ...
    def _build_function_forward_graph(self):
        ...
        at = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(3944.0, 616.0), 'At')
        at1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(912.0, 1184.0), 'At')
        at2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(936.0, 1438.0), 'At')
        at3 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(848.0, 1632.0), 'At')
        get_item_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(1232.0, 1328.0), 'Get Item Metadata')
        get_control_layer = controller.add_variable_node('control_layer', 'FName', None, True, '', unreal.Vector2D(880.0, 1352.0), 'Get control_layer')
        basic_ik = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_TwoBoneIKSimplePerItem', 'Execute', unreal.Vector2D(5336.0, 1720.0), 'Basic IK')
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(2008.0, 1288.0), 'Get Transform')
        vetala_lib_find_bone_aim_axis = controller.add_function_reference_node(library.find_function('vetalaLib_findBoneAimAxis'), unreal.Vector2D(2512.0, 688.0), 'vetalaLib_findBoneAimAxis')
        draw_line = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_DebugLineNoSpace', 'Execute', unreal.Vector2D(5832.0, 1880.0), 'Draw Line')
        get_transform1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(1616.0, 1424.0), 'Get Transform')
        project_to_new_parent = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ProjectTransformToNewParent', 'Execute', unreal.Vector2D(3592.0, 1928.0), 'Project to new Parent')
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(2824.0, 1576.0), 'vetalaLib_GetItem')
        get_item_array_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(1976.0, 1736.0), 'Get Item Array Metadata')
        vetala_lib_ik_nudge_lock = controller.add_function_reference_node(library.find_function('vetalaLib_IK_NudgeLock'), unreal.Vector2D(3240.0, 824.0), 'vetalaLib_IK_NudgeLock')
        get_item_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(936.0, 760.0), 'Get Item Metadata')
        get_bool_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetBoolAnimationChannel', 'Execute', unreal.Vector2D(1816.0, 1944.0), 'Get Bool Channel')
        get_item_metadata2 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(816.0, 1888.0), 'Get Item Metadata')
        item = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_Item', 'Execute', unreal.Vector2D(1444.0, 2032.0), 'Item')
        get_float_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(1816.0, 2104.0), 'Get Float Channel')
        item1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_Item', 'Execute', unreal.Vector2D(1432.0, 2168.0), 'Item')
        item2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_Item', 'Execute', unreal.Vector2D(1960.0, 1112.0), 'Item')
        get_float_channel1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(2376.0, 1128.0), 'Get Float Channel')
        get_item_metadata3 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(808.0, 2104.0), 'Get Item Metadata')
        if1 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(1208.0, 2195.0), 'If')
        vetala_lib_constrain_transform = controller.add_function_reference_node(library.find_function('vetalaLib_ConstrainTransform'), unreal.Vector2D(1504.0, 672.0), 'vetalaLib_ConstrainTransform')
        at4 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(600.0, 1704.0), 'At')
        get_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(1184.0, 1808.0), 'Get Metadata')
        get_joints = controller.add_variable_node_from_object_path('joints', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(3560.0, 728.0), 'Get joints')
        get_transform2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(3656.0, 1256.0), 'Get Transform')
        at5 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(3944.0, 728.0), 'At')
        at6 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(3944.0, 840.0), 'At')
        at7 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(3944.0, 952.0), 'At')
        ccdik = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_CCDIKItemArray', 'Execute', unreal.Vector2D(4472.0, 1320.0), 'CCDIK')
        set_local_ik = controller.add_variable_node_from_object_path('local_ik', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', False, '()', unreal.Vector2D(6280.0, 1816.0), 'Set local_ik')
        set_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(4824.0, 1336.0), 'Set Transform')
        get_item_array_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(5224.0, 648.0), 'Get Item Array Metadata')
        get_layer = controller.add_variable_node('layer', 'int32', None, True, '', unreal.Vector2D(4392.0, 728.0), 'Get layer')
        to_string = controller.add_template_node('DISPATCH_RigDispatch_ToString(in Value,out Result)', unreal.Vector2D(4568.0, 728.0), 'To String')
        vetala_lib_get_item1 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(5608.0, 616.0), 'vetalaLib_GetItem')
        join = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_StringJoin', 'Execute', unreal.Vector2D(4840.0, 600.0), 'Join')
        concat = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_NameConcat', 'Execute', unreal.Vector2D(5016.0, 712.0), 'Concat')
        from_string = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(4744.0, 760.0), 'From String')
        get_parent = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyGetParent', 'Execute', unreal.Vector2D(5832.0, 616.0), 'Get Parent')
        project_to_new_parent1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ProjectTransformToNewParent', 'Execute', unreal.Vector2D(4744.0, 888.0), 'Project to new Parent')
        get_local_ik1 = controller.add_variable_node_from_object_path('local_ik', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(3720.0, -392.0), 'Get local_ik')
        ...
        graph.add_link(at3, 'Element', 'Get Item Metadata_4', 'Item', controller)
        graph.add_link(get_control_layer, 'Value', get_item_metadata, 'Name', controller)
        graph.add_link(get_item_metadata, 'Value', get_transform, 'Item', controller)
        graph.add_link(get_item_metadata, 'Value', 'Item_2', 'Item', controller)
        graph.add_link(get_control_layer, 'Value', get_item_metadata1, 'Name', controller)
        ...
        graph.add_link('At_18', 'Element', get_item_array_metadata, 'Item', controller)
        graph.add_link(get_item_array_metadata, 'Value', set_local_ik, 'Value', controller)
        graph.add_link(get_float_channel, 'Value', vetala_lib_ik_nudge_lock, 'nudge', controller)
        graph.add_link(get_float_channel1, 'Value', vetala_lib_ik_nudge_lock, 'lock', controller)
        graph.add_link(get_item_metadata1, 'Value', vetala_lib_constrain_transform, 'SourceTransform', controller)
        graph.add_link(item, 'Item.Name', get_bool_channel, 'Control', controller)
        graph.add_link('At_18', 'Element', get_item_metadata2, 'Item', controller)
        graph.add_link(get_item_metadata2, 'Value', if1, 'False', controller)
        ...
        graph.add_link(get_item_metadata, 'Value', item2, 'Item', controller)
        graph.add_link(item2, 'Item.Name', get_float_channel1, 'Control', controller)
        graph.add_link('At_18', 'Element', get_item_metadata3, 'Item', controller)
        graph.add_link(get_item_metadata3, 'Value', if1, 'True', controller)
        graph.add_link(get_item_metadata3, 'Found', if1, 'Condition', controller)
        graph.add_link(if1, 'Result', item, 'Item', controller)
        graph.add_link(if1, 'Result', 'Item_1', 'Item', controller)
        ...
        graph.set_pin(basic_ik, 'StretchMaximumRatio', '10.000000', controller)
        graph.set_pin(basic_ik, 'Weight', '1.000000', controller)
        graph.set_pin(basic_ik, 'bPropagateToChildren', 'false', controller)
        graph.set_pin(basic_ik, 'DebugSettings', '(bEnabled=False,Scale=10.000000,WorldOffset=(Rotation=(X=0.000000,Y=0.000000,Z=0.000000,W=1.000000),Translation=(X=0.000000,Y=0.000000,Z=0.000000),Scale3D=(X=1.000000,Y=1.000000,Z=1.000000)))', controller)
        graph.set_pin(get_transform, 'Space', 'GlobalSpace', controller)
        graph.set_pin(get_transform, 'bInitial', 'False', controller)
        graph.set_pin(draw_line, 'DebugDrawSettings', '(DepthPriority=SDPG_Foreground,Lifetime=-1.000000)', controller)
        ...
        graph.set_pin(ccdik, 'Precision', '0.010000', controller)
        graph.set_pin(ccdik, 'Weight', '1.000000', controller)
        graph.set_pin(ccdik, 'MaxIterations', '60', controller)
        graph.set_pin(ccdik, 'bStartFromTail', 'false', controller)
        graph.set_pin(ccdik, 'BaseRotationLimit', '180.000000', controller)
...
class UnrealSwitch(UnrealUtil):
    ...
    def _build_function_graph(self):
        ...
        graph.add_link(switch1, 'Cases.1', vetala_lib_rig_layer_solver, 'ExecuteContext', controller)
        graph.add_link(switch1, 'Completed', 'Return', 'ExecuteContext', controller)
