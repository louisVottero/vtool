...
class UnrealFootRollRig(UnrealUtilRig):
    ...
    def _build_function_forward_graph(self):
        ...
        get_item_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(1680.0, 1764.0), 'Get Item Metadata')
        ...
        basic_fabrik1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_FABRIKItemArray', 'Execute', unreal.Vector2D(3440.0, 1680.0), 'Basic FABRIK')
        make_array1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayMake(in Values,out Array)', unreal.Vector2D(2464.0, 1600.0), 'Make Array')
        ...
        vetala_lib_get_item2 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(800.0, 1584.0), 'vetalaLib_GetItem')
        branch = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(2560.0, 1168.0), 'Branch')
        ...
        get_joints = controller.add_variable_node_from_object_path('joints', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(3440.0, 1280.0), 'Get joints')
        vetala_lib_get_item3 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(800.0, 1584.0), 'vetalaLib_GetItem')
        ...
        get_parent1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyGetParent', 'Execute', unreal.Vector2D(5952.0, 1300.0), 'Get Parent')
        ...
        get_parent6 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyGetParent', 'Execute', unreal.Vector2D(6336.0, 1284.0), 'Get Parent')
        ...
        set_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(2976.0, 1280.0), 'Set Transform')
        vetala_lib_get_item4 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(1008.0, 1168.0), 'vetalaLib_GetItem')
        item_exists = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ItemExists', 'Execute', unreal.Vector2D(1264.0, 1136.0), 'Item Exists')
        ...
        graph.add_link(if3, 'Result', branch, 'Condition', controller)
        graph.add_link(branch, 'True', set_transform, 'ExecutePin', controller)
        ...
        graph.add_link('Entry', 'switch_control', vetala_lib_get_item4, 'Array', controller)
        ...
        graph.add_link(item_exists, 'Exists', if3, 'Condition', controller)
...
class UnrealIkQuadrupedRig(UnrealUtilRig):
    ...
    def _build_controls(self, controller, library):
        ...
        set_item_metadata = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in NameSpace,in Value,out Success)', unreal.Vector2D(2952.0, -1876.0), 'Set Item Metadata')
        ...
        get_local_controls = controller.add_variable_node_from_object_path('local_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(2736.0, -1704.0), 'Get local_controls')
        get_local_controls1 = controller.add_variable_node_from_object_path('local_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(4344.0, -832.0), 'Get local_controls')
        ...
        spawn_null = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddNull', 'Execute', unreal.Vector2D(5944.0, -1900.0), 'Spawn Null')
        ...
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(5744.0, -1288.0), 'Get Transform')
        ...
        set_item_array_metadata = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in NameSpace,in Value,out Success)', unreal.Vector2D(6728.0, -1756.0), 'Set Item Array Metadata')
        get_local_ik1 = controller.add_variable_node_from_object_path('local_ik', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(3760.0, -392.0), 'Get local_ik')
        ...
        vetala_lib_parent4 = controller.add_function_reference_node(library.find_function('vetalaLib_Parent'), unreal.Vector2D(6408.0, -1824.0), 'vetalaLib_Parent')
        ...
        graph.add_link(spawn_null, 'ExecutePin', vetala_lib_parent4, 'ExecuteContext', controller)
        graph.add_link(vetala_lib_parent4, 'ExecuteContext', add1, 'ExecuteContext', controller)
        graph.add_link(add1, 'ExecuteContext', set_item_array_metadata, 'ExecuteContext', controller)
        graph.add_link(set_item_array_metadata, 'ExecuteContext', spawn_bool_animation_channel, 'ExecutePin', controller)
        graph.add_link(spawn_bool_animation_channel, 'ExecutePin', branch1, 'ExecuteContext', controller)
        graph.add_link(branch, 'True', vetala_lib_parent2, 'ExecuteContext', controller)
        ...
        graph.add_link(vetala_lib_get_item, 'Element', spawn_null, 'Parent', controller)
        graph.add_link(spawn_null, 'Item', add1, 'Element', controller)
        graph.add_link(spawn_null, 'Item', vetala_lib_parent4, 'Parent', controller)
        graph.add_link(get_transform, 'Transform', spawn_null, 'Transform', controller)
        graph.add_link(greater1, 'Result', if4, 'Condition', controller)
        graph.add_link(get_item_array_metadata, 'Value', if4, 'True', controller)
        graph.add_link(if4, 'Result', vetala_lib_get_item, 'Array', controller)
        ...
        graph.add_link(at13, 'Element', vetala_lib_parent3, 'Parent', controller)
        ...
        graph.set_pin(at12, 'Index', '-1', controller)
    ...
    def _build_function_forward_graph(self):
        ...
        at = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(816.0, 1072.0), 'At')
        at1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(840.0, 1326.0), 'At')
        at2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(752.0, 1520.0), 'At')
        get_item_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(1136.0, 1216.0), 'Get Item Metadata')
        get_control_layer = controller.add_variable_node('control_layer', 'FName', None, True, '', unreal.Vector2D(784.0, 1240.0), 'Get control_layer')
        basic_ik = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_TwoBoneIKSimplePerItem', 'Execute', unreal.Vector2D(3528.0, 1048.0), 'Basic IK')
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(1840.0, 1168.0), 'Get Transform')
        vetala_lib_find_bone_aim_axis = controller.add_function_reference_node(library.find_function('vetalaLib_findBoneAimAxis'), unreal.Vector2D(2416.0, 576.0), 'vetalaLib_findBoneAimAxis')
        draw_line = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_DebugLineNoSpace', 'Execute', unreal.Vector2D(4208.0, 1200.0), 'Draw Line')
        get_transform1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(1520.0, 1312.0), 'Get Transform')
        project_to_new_parent = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ProjectTransformToNewParent', 'Execute', unreal.Vector2D(2192.0, 1456.0), 'Project to new Parent')
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(1856.0, 1520.0), 'vetalaLib_GetItem')
        get_item_array_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(1072.0, 1488.0), 'Get Item Array Metadata')
        vetala_lib_ik_nudge_lock = controller.add_function_reference_node(library.find_function('vetalaLib_IK_NudgeLock'), unreal.Vector2D(3152.0, 608.0), 'vetalaLib_IK_NudgeLock')
        get_item_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(896.0, 688.0), 'Get Item Metadata')
        get_bool_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetBoolAnimationChannel', 'Execute', unreal.Vector2D(1720.0, 1832.0), 'Get Bool Channel')
        get_item_metadata2 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(720.0, 1776.0), 'Get Item Metadata')
        item = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_Item', 'Execute', unreal.Vector2D(1348.0, 1920.0), 'Item')
        get_float_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(1720.0, 1992.0), 'Get Float Channel')
        item1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_Item', 'Execute', unreal.Vector2D(1336.0, 2056.0), 'Item')
        item2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_Item', 'Execute', unreal.Vector2D(1864.0, 1000.0), 'Item')
        get_float_channel1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(2280.0, 1016.0), 'Get Float Channel')
        get_item_metadata3 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(712.0, 1992.0), 'Get Item Metadata')
        if1 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(1112.0, 2083.0), 'If')
        vetala_lib_constrain_transform = controller.add_function_reference_node(library.find_function('vetalaLib_ConstrainTransform'), unreal.Vector2D(1408.0, 560.0), 'vetalaLib_ConstrainTransform')
        at3 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(576.0, 1536.0), 'At')
        get_item_metadata4 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(1088.0, 1696.0), 'Get Item Metadata')
        ...
        graph.add_link(at2, 'Element', get_item_array_metadata, 'Item', controller)
        graph.add_link(at2, 'Element', project_to_new_parent, 'Child', controller)
        graph.add_link(at2, 'Element', 'Get_Metadata', 'Item', controller)

        graph.add_link(at3, 'Element', get_item_metadata2, 'Item', controller)
        graph.add_link(at3, 'Element', 'Get Item Metadata_3', 'Item', controller)
        graph.add_link(at2, 'Element', get_item_metadata4, 'Item', controller)
        graph.add_link(at, 'Element', vetala_lib_ik_nudge_lock, 'joints.0', controller)
        graph.add_link(at1, 'Element', vetala_lib_ik_nudge_lock, 'joints.1', controller)
        graph.add_link(at2, 'Element', vetala_lib_ik_nudge_lock, 'joints.2', controller)
        ...
        graph.add_link(get_control_layer, 'Value', get_item_metadata1, 'Name', controller)
        graph.add_link(get_control_layer, 'Value', get_item_metadata2, 'Name', controller)
        graph.add_link(get_control_layer, 'Value', get_item_metadata4, 'Name', controller)
        graph.add_link(basic_ik, 'ExecutePin', draw_line, 'ExecutePin', controller)
        graph.add_link(project_to_new_parent, 'Transform', basic_ik, 'Effector', controller)
        graph.add_link(vetala_lib_find_bone_aim_axis, 'Result', basic_ik, 'PrimaryAxis', controller)
        graph.add_link(get_transform, 'Transform.Translation', basic_ik, 'PoleVector', controller)
        ...
        graph.add_link(get_transform, 'Transform.Translation', draw_line, 'B', controller)
        graph.add_link(get_transform1, 'Transform.Translation', draw_line, 'A', controller)
        graph.add_link(get_item_metadata4, 'Value', project_to_new_parent, 'OldParent', controller)
        graph.add_link(get_item_metadata4, 'Value', project_to_new_parent, 'NewParent', controller)
        graph.add_link(get_item_array_metadata, 'Value', vetala_lib_get_item, 'Array', controller)
        graph.add_link(get_float_channel, 'Value', vetala_lib_ik_nudge_lock, 'nudge', controller)
        graph.add_link(get_float_channel1, 'Value', vetala_lib_ik_nudge_lock, 'lock', controller)
        graph.add_link(get_item_metadata1, 'Value', vetala_lib_constrain_transform, 'SourceTransform', controller)
        graph.add_link(item, 'Item.Name', get_bool_channel, 'Control', controller)
        graph.add_link('At_17', 'Element', get_item_metadata2, 'Item', controller)
        graph.add_link(get_item_metadata2, 'Value', if1, 'False', controller)
        graph.add_link('If_5', 'Result', item, 'Item', controller)
        graph.add_link(item1, 'Item.Name', get_float_channel, 'Control', controller)
        graph.add_link('If_5', 'Result', item1, 'Item', controller)
        graph.add_link(get_item_metadata, 'Value', item2, 'Item', controller)
        graph.add_link(item2, 'Item.Name', get_float_channel1, 'Control', controller)
        graph.add_link('At_17', 'Element', get_item_metadata3, 'Item', controller)
        graph.add_link(get_item_metadata3, 'Value', if1, 'True', controller)
        graph.add_link(get_item_metadata3, 'Found', if1, 'Condition', controller)
...
class UnrealSwitch(UnrealUtil):
    ...
    def _build_function_graph(self):
        ...
        entry = 'Entry'
        return1 = 'Return'
        controller.add_exposed_pin('controls', unreal.RigVMPinDirection.OUTPUT, 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', '()')
