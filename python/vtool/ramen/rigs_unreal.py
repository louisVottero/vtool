...
class UnrealIkRig(UnrealUtilRig):
    ...
    def _build_function_forward_graph(self):
        ...
        at = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(752.0, 1710.0), 'At')
        at1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(752.0, 1910.0), 'At')
        at2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(784.0, 2160.0), 'At')
        get_item_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in Default,out Value,out Found)', unreal.Vector2D(1024.0, 1808.0), 'Get Item Metadata')
        get_control_layer = controller.add_variable_node('control_layer', 'FName', None, True, '', unreal.Vector2D(696.0, 1824.0), 'Get control_layer')
        basic_ik = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_TwoBoneIKSimplePerItem', 'Execute', unreal.Vector2D(3440.0, 1632.0), 'Basic IK')
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(1768.0, 1744.0), 'Get Transform')
        vetala_lib_find_bone_aim_axis = controller.add_function_reference_node(library.find_function('vetalaLib_findBoneAimAxis'), unreal.Vector2D(2640.0, 1472.0), 'vetalaLib_findBoneAimAxis')
        draw_line = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_DebugLineNoSpace', 'Execute', unreal.Vector2D(3840.0, 1792.0), 'Draw Line')
        get_transform1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(1440.0, 1968.0), 'Get Transform')
        project_to_new_parent = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ProjectTransformToNewParent', 'Execute', unreal.Vector2D(2040.0, 2128.0), 'Project to new Parent')
        vetala_lib_rig_layer_solve = controller.add_function_reference_node(library.find_function('vetalaLib_rigLayerSolve'), unreal.Vector2D(4208.0, 1792.0), 'vetalaLib_rigLayerSolve')
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(1672.0, 2272.0), 'vetalaLib_GetItem')
        get_item_array_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in Default,out Value,out Found)', unreal.Vector2D(1288.0, 2256.0), 'Get Item Array Metadata')
        vetala_lib_ik_nudge_lock = controller.add_function_reference_node(library.find_function('vetalaLib_IK_NudgeLock'), unreal.Vector2D(2992.0, 1616.0), 'vetalaLib_IK_NudgeLock')
        get_item_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in Default,out Value,out Found)', unreal.Vector2D(1040.0, 1408.0), 'Get Item Metadata')
        get_bool_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetBoolAnimationChannel', 'Execute', unreal.Vector2D(1632.0, 2416.0), 'Get Bool Channel')
        get_item_metadata2 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in Default,out Value,out Found)', unreal.Vector2D(656.0, 2304.0), 'Get Item Metadata')
        item = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_Item', 'Execute', unreal.Vector2D(1260.0, 2504.0), 'Item')
        get_float_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(1632.0, 2576.0), 'Get Float Channel')
        item1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_Item', 'Execute', unreal.Vector2D(1248.0, 2640.0), 'Item')
        item2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_Item', 'Execute', unreal.Vector2D(1776.0, 1584.0), 'Item')
        get_float_channel1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(2192.0, 1600.0), 'Get Float Channel')
        get_item_metadata3 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in Default,out Value,out Found)', unreal.Vector2D(624.0, 2576.0), 'Get Item Metadata')
        if1 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(1024.0, 2667.0), 'If')
        num = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetNum(in Array,out Num)', unreal.Vector2D(1216.0, 848.0), 'Num')
        branch = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(1808.0, 784.0), 'Branch')
        equals = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(1424.0, 848.0), 'Equals')
        basic_fabrik = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_FABRIKItemArray', 'Execute', unreal.Vector2D(4080.0, 832.0), 'Basic FABRIK')
        get_joints = controller.add_variable_node_from_object_path('joints', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(3235.929045447527, 1269.9867986966779), 'Get joints')
        vetala_lib_get_item1 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(3456.0, 1200.0), 'vetalaLib_GetItem')
        vetala_lib_get_item2 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(3456.0, 1344.0), 'vetalaLib_GetItem')
        set_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(2960.0, 864.0), 'Set Transform')
        get_transform2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(2480.0, 912.0), 'Get Transform')
        rotation_constraint = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_RotationConstraintLocalSpaceOffset', 'Execute', unreal.Vector2D(4032.0, 1296.0), 'Rotation Constraint')
        greater = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntGreater', 'Execute', unreal.Vector2D(1424.0, 960.0), 'Greater')
        or1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathBoolOr', 'Execute', unreal.Vector2D(1664.0, 928.0), 'Or')
        ...
        graph.add_link(set_transform, 'ExecuteContext', basic_fabrik, 'ExecuteContext', controller)
        graph.add_link(basic_fabrik, 'ExecuteContext', rotation_constraint, 'ExecuteContext', controller)
...
class UnrealSplineIkRig(UnrealUtilRig):
    ...
    def _build_function_construct_graph(self):
        ...
        vetala_lib_control_temp = controller.add_function_reference_node(library.find_function('vetalaLib_Control_temp'), unreal.Vector2D(4400.0, -2250.0), 'vetalaLib_Control_temp')
        ...
        graph.add_link(spawn_null, 'ExecuteContext', vetala_lib_control_temp, 'ExecuteContext', controller)
        graph.add_link(vetala_lib_control_temp, 'ExecuteContext', set_default_parent, 'ExecuteContext', controller)
        ...
        graph.add_link(for_loop, 'Index', vetala_lib_control_temp, 'increment', controller)
        ...
        graph.add_link(if4, 'Result', vetala_lib_control_temp, 'parent', controller)
        ...
        graph.add_link(spawn_null, 'Item', vetala_lib_control_temp, 'driven', controller)
        graph.add_link('Entry', 'description', vetala_lib_control_temp, 'description', controller)
        graph.add_link('Entry', 'side', vetala_lib_control_temp, 'side', controller)
        graph.add_link('Entry', 'sub_count', vetala_lib_control_temp, 'sub_count', controller)
        graph.add_link('Entry', 'restrain_numbering', vetala_lib_control_temp, 'restrain_numbering', controller)
        graph.add_link('Entry', 'shape', vetala_lib_control_temp, 'shape', controller)
        graph.add_link('Entry', 'color', vetala_lib_control_temp, 'color', controller)
        graph.add_link('Entry', 'sub_color', vetala_lib_control_temp, 'sub_color', controller)
        graph.add_link(vetala_lib_control_temp, 'Control', set_default_parent, 'Parent', controller)
        graph.add_link(vetala_lib_control_temp, 'Control', set_last_control, 'Value', controller)
        graph.add_link(vetala_lib_control_temp, 'Control', add, 'Element', controller)
        graph.add_link('Entry', 'shape_translate', vetala_lib_control_temp, 'translate', controller)
        graph.add_link('Entry', 'shape_rotate', vetala_lib_control_temp, 'rotate', controller)
        graph.add_link('Entry', 'shape_scale', vetala_lib_control_temp, 'scale', controller)
