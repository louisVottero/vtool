...
class UnrealIkRig(UnrealUtilRig):
    ...
    def _build_controls(self, controller, library):
        ...
        vetala_lib_get_joint_description = controller.add_function_reference_node(library.find_function('vetalaLib_GetJointDescription'), unreal.Vector2D(1900.0, -1450.0), 'vetalaLib_GetJointDescription')
        ...
        get_control_layer = controller.add_variable_node('control_layer', 'FName', None, True, '', unreal.Vector2D(1780.0, -1600.0), 'Get control_layer')
        equals = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(1700.0, -1900.0), 'Equals')
        get_description = controller.add_variable_node('description', 'FString', None, True, '', unreal.Vector2D(1500.0, -1050.0), 'Get description')
        get_use_joint_name = controller.add_variable_node('use_joint_name', 'bool', None, True, '', unreal.Vector2D(1500.0, -950.0), 'Get use_joint_name')
        ...
        get_world = controller.add_variable_node('world', 'bool', None, True, '', unreal.Vector2D(2000.0, -850.0), 'Get world')
        get_mirror = controller.add_variable_node('mirror', 'bool', None, True, '', unreal.Vector2D(2000.0, -750.0), 'Get mirror')
        add = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayAdd(io Array,in Element,out Index)', unreal.Vector2D(2800.0, -1350.0), 'Add')
        get_local_controls = controller.add_variable_node_from_object_path('local_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(2700.0, -1150.0), 'Get local_controls')
        get_local_controls1 = controller.add_variable_node_from_object_path('local_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(3100.0, -900.0), 'Get local_controls')
        ...
        if2 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(3500.0, -1650.0), 'If')
        ...
        at1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(3400.0, -1100.0), 'At')
        at2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(3400.0, -1000.0), 'At')
        at3 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(3400.0, -900.0), 'At')
        ...
        get_joints = controller.add_variable_node_from_object_path('joints', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(3500.0, -1850.0), 'Get joints')
        at5 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(3800.0, -1900.0), 'At')
        at6 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(3800.0, -1800.0), 'At')
        at7 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(3800.0, -1700.0), 'At')
        ...
        # blueprint.get_controller_by_name('vetala_IkRig').add_external_function_reference_node('/ControlRig/StandardFunctionLibrary/StandardFunctionLibrary.StandardFunctionLibrary_C', 'ComputePoleVector', unreal.Vector2D(4838.140620, -1558.877926), 'ComputePoleVector')
        compute_pole_vector = controller.add_external_function_reference_node('/ControlRig/StandardFunctionLibrary/StandardFunctionLibrary.StandardFunctionLibrary_C', 'ComputePoleVector', unreal.Vector2D(5000.0, -1850.0), 'ComputePoleVector')
        set_translation = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTranslation', 'Execute', unreal.Vector2D(5584.0, -1632.0), 'Set Translation')
        greater = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntGreater', 'Execute', unreal.Vector2D(600.0, -1750.0), 'Greater')
        if3 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(800.0, -1650.0), 'If')
        spawn_null = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddNull', 'Execute', unreal.Vector2D(7584.0, -1712.0), 'Spawn Null')
        if4 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(6768.0, -1216.0), 'If')
        get_item_array_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in Default,out Value,out Found)', unreal.Vector2D(6160.0, -1360.0), 'Get Item Array Metadata')
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(7184.0, -1104.0), 'vetalaLib_GetItem')
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(7136.0, -1440.0), 'Get Transform')
        get_local_ik = controller.add_variable_node_from_object_path('local_ik', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(7872.0, -1296.0), 'Get local_ik')
        add1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayAdd(io Array,in Element,out Index)', unreal.Vector2D(8208.0, -1520.0), 'Add')
        num = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetNum(in Array,out Num)', unreal.Vector2D(6416.0, -1360.0), 'Num')
        greater1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntGreater', 'Execute', unreal.Vector2D(6592.0, -1360.0), 'Greater')
        get_joints1 = controller.add_variable_node_from_object_path('joints', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(8256.0, -1152.0), 'Get joints')
        vetala_lib_get_item1 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(8416.0, -1152.0), 'vetalaLib_GetItem')
        set_item_array_metadata = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in Value,out Success)', unreal.Vector2D(8688.0, -1520.0), 'Set Item Array Metadata')
        ...
        get_local_ik2 = controller.add_variable_node_from_object_path('local_ik', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(3696.0, -560.0), 'Get local_ik')
        ...
        graph.add_link(at3, 'Element', get_item_array_metadata, 'Item', controller)
        ...
        graph.add_link(for_each, 'Completed', set_shape_settings, 'ExecuteContext', controller)
        ...
        graph.add_link(set_translation, 'ExecuteContext', spawn_null, 'ExecuteContext', controller)
        ...
        graph.add_link(at3, 'Element', if4, 'False.0', controller)
        ...
        controller.set_pin_default_value(f'{n(equals)}.B', '0', False)
        controller.set_pin_default_value(f'{n(if2)}.False', 'Sphere_Solid', False)
        controller.set_pin_default_value(f'{n(set_shape_settings)}.Settings', '(bVisible=True,Name="Default",Color=(R=1.000000,G=0.000000,B=0.000000,A=1.000000),Transform=(Rotation=(X=0.000000,Y=0.000000,Z=0.000000,W=1.000000),Translation=(X=0.000000,Y=0.000000,Z=0.000000),Scale3D=(X=1.000000,Y=1.000000,Z=1.000000)))', False)
        ...
        controller.set_pin_default_value(f'{n(at4)}.Index', '0', False)
        controller.set_pin_default_value(f'{n(multiply)}.B', '(X=0.333,Y=0.333,Z=0.333)', False)
        controller.set_pin_default_value(f'{n(at5)}.Index', '0', False)
        controller.set_pin_default_value(f'{n(at6)}.Index', '1', False)
        controller.set_pin_default_value(f'{n(at7)}.Index', '2', False)
        controller.set_pin_default_value(f'{n(compute_pole_vector)}.Draw Transform', 'false', False)
        controller.set_pin_default_value(f'{n(compute_pole_vector)}.Initial', 'false', False)
        controller.set_pin_default_value(f'{n(compute_pole_vector)}.Origin Scale', '(X=0.000000,Y=0.000000,Z=0.000000)', False)
        controller.set_pin_default_value(f'{n(set_translation)}.Space', 'GlobalSpace', False)
        controller.set_pin_default_value(f'{n(set_translation)}.bInitial', 'true', False)
        controller.set_pin_default_value(f'{n(set_translation)}.Weight', '1.000000', False)
        controller.set_pin_default_value(f'{n(set_translation)}.bPropagateToChildren', 'True', False)
        controller.set_pin_default_value(f'{n(greater)}.B', '1', False)
        controller.set_pin_default_value(f'{n(if3)}.False', '0', False)
        controller.set_pin_default_value(f'{n(spawn_null)}.Name', 'ik', False)
        controller.set_pin_default_value(f'{n(spawn_null)}.Space', 'GlobalSpace', False)
        controller.set_pin_default_value(f'{n(if4)}.False', '((Type=None,Name="None"))', False)
        controller.set_pin_default_value(f'{n(get_item_array_metadata)}.Name', 'Sub', False)
        ...
        controller.set_pin_default_value(f'{n(greater1)}.B', '0', False)
    ...
    def _build_function_forward_graph(self):
        ...
        at = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(600.0, 350.0), 'At')
        at1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(600.0, 550.0), 'At')
        at2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(600.0, 750.0), 'At')
        get_item_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in Default,out Value,out Found)', unreal.Vector2D(900.0, 400.0), 'Get Item Metadata')
        get_item_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in Default,out Value,out Found)', unreal.Vector2D(900.0, 600.0), 'Get Item Metadata')
        get_control_layer = controller.add_variable_node('control_layer', 'FName', None, True, '', unreal.Vector2D(544.0, 464.0), 'Get control_layer')
        basic_ik = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_TwoBoneIKSimplePerItem', 'Execute', unreal.Vector2D(2400.0, 500.0), 'Basic IK')
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(1616.0, 384.0), 'Get Transform')
        vetala_lib_find_bone_aim_axis = controller.add_function_reference_node(library.find_function('vetalaLib_findBoneAimAxis'), unreal.Vector2D(1700.0, 100.0), 'vetalaLib_findBoneAimAxis')
        draw_line = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_DebugLineNoSpace', 'Execute', unreal.Vector2D(2650.0, 100.0), 'Draw Line')
        get_transform1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(1316.0, 384.0), 'Get Transform')
        project_to_new_parent = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ProjectTransformToNewParent', 'Execute', unreal.Vector2D(1888.0, 768.0), 'Project to new Parent')
        vetala_lib_rig_layer_solve = controller.add_function_reference_node(library.find_function('vetalaLib_rigLayerSolve'), unreal.Vector2D(2912.0, 496.0), 'vetalaLib_rigLayerSolve')
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(1520.0, 912.0), 'vetalaLib_GetItem')
        get_item_array_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in Default,out Value,out Found)', unreal.Vector2D(1136.0, 896.0), 'Get Item Array Metadata')

        graph.add_link('DISPATCH_RigVMDispatch_SwitchInt32', 'Cases.1', vetala_lib_find_bone_aim_axis, 'ExecuteContext', controller)
        ...
        graph.add_link(at2, 'Element', get_item_metadata1, 'Item', controller)
        graph.add_link(at2, 'Element', project_to_new_parent, 'Child', controller)
        graph.add_link(vetala_lib_find_bone_aim_axis, 'ExecuteContext', basic_ik, 'ExecuteContext', controller)
        graph.add_link(basic_ik, 'ExecuteContext', draw_line, 'ExecuteContext', controller)
        graph.add_link(draw_line, 'ExecuteContext', vetala_lib_rig_layer_solve, 'ExecuteContext', controller)
        ...
        controller.set_pin_default_value(f'{n(at)}.Index', '0', False)
        controller.set_pin_default_value(f'{n(at1)}.Index', '1', False)
        ...
        controller.set_pin_default_value(f'{n(basic_ik)}.SecondaryAxis', '(X=0.000000,Y=0.000000,Z=0.000000)', False)
        controller.set_pin_default_value(f'{n(basic_ik)}.SecondaryAxisWeight', '1.000000', False)
        controller.set_pin_default_value(f'{n(basic_ik)}.PoleVectorKind', 'Direction', False)
        controller.set_pin_default_value(f'{n(basic_ik)}.PoleVectorSpace', '(Type=Bone,Name="None")', False)
        controller.set_pin_default_value(f'{n(basic_ik)}.bEnableStretch', 'False', False)
        controller.set_pin_default_value(f'{n(basic_ik)}.StretchStartRatio', '0.750000', False)
        controller.set_pin_default_value(f'{n(basic_ik)}.StretchMaximumRatio', '1.250000', False)
        controller.set_pin_default_value(f'{n(basic_ik)}.Weight', '1.000000', False)
        controller.set_pin_default_value(f'{n(basic_ik)}.ItemALength', '0.000000', False)
        controller.set_pin_default_value(f'{n(basic_ik)}.ItemBLength', '0.000000', False)
        controller.set_pin_default_value(f'{n(basic_ik)}.bPropagateToChildren', 'True', False)
        controller.set_pin_default_value(f'{n(basic_ik)}.DebugSettings', '(bEnabled=False,Scale=10.000000,WorldOffset=(Rotation=(X=0.000000,Y=0.000000,Z=0.000000,W=1.000000),Translation=(X=0.000000,Y=0.000000,Z=0.000000),Scale3D=(X=1.000000,Y=1.000000,Z=1.000000)))', False)
        controller.set_pin_default_value(f'{n(get_transform)}.Space', 'GlobalSpace', False)
        controller.set_pin_default_value(f'{n(get_transform)}.bInitial', 'False', False)
        controller.set_pin_default_value(f'{n(draw_line)}.Color', '(R=0.05,G=0.05,B=0.05,A=1.000000)', False)
        controller.set_pin_default_value(f'{n(draw_line)}.Thickness', '0.000000', False)
        controller.set_pin_default_value(f'{n(draw_line)}.WorldOffset', '(Rotation=(X=0.000000,Y=0.000000,Z=0.000000,W=1.000000),Translation=(X=0.000000,Y=0.000000,Z=0.000000),Scale3D=(X=1.000000,Y=1.000000,Z=1.000000))', False)
        controller.set_pin_default_value(f'{n(draw_line)}.bEnabled', 'True', False)
...
class UnrealSplineIkRig(UnrealUtilRig):
    ...
    def _build_function_forward_graph(self):
        ...
        # at1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(1400.0, 400.0), 'At')
        vetala_lib_get_item1 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(1400.0, 400.0), 'vetalaLib_GetItem')
        ...
        get_aim_axis = controller.add_variable_node_from_object_path('aim_axis', 'TArray<FVector>', '/Script/CoreUObject.Vector', True, '()', unreal.Vector2D(2200.0, 300.0), 'Get aim_axis')
        at2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(2350.0, 300.0), 'At')
        get_up_axis = controller.add_variable_node_from_object_path('up_axis', 'TArray<FVector>', '/Script/CoreUObject.Vector', True, '()', unreal.Vector2D(2200.0, 400.0), 'Get up_axis')
        at3 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(2350.0, 400.0), 'At')
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(1792.0, 672.0), 'vetalaLib_GetItem')
        ...
        graph.add_link(vetala_lib_get_item1, 'Element.Name', get_bool_channel, 'Control', controller)
        graph.add_link(get_item_array_metadata, 'Value', vetala_lib_get_item1, 'Array', controller)

        graph.add_link(at2, 'Element', spline_ik, 'Primary Axis', controller)
        graph.add_link(at3, 'Element', spline_ik, 'Up Axis', controller)
        graph.add_link(get_item_array_metadata1, 'Value', vetala_lib_get_item, 'Array', controller)
        ...
        graph.add_link(get_aim_axis, 'Value', at2, 'Array', controller)
        ...
        graph.add_link(get_up_axis, 'Value', at3, 'Array', controller)
        ...
        controller.set_pin_default_value(f'{n(spline_ik)}.Spline Mode', 'BSpline', False)
        controller.set_pin_default_value(f'{n(spline_ik)}.Samples Per Segment', '16', False)
        controller.set_pin_default_value(f'{n(at)}.Index', '0', False)
        controller.set_pin_default_value(f'{n(vetala_lib_get_item1)}.index', '0', False)
        controller.set_pin_default_value(f'{n(get_item_array_metadata)}.Name', 'controls', False)
        # controller.set_pin_default_value(f'{n(get_item_array_metadata)}.NameSpace', 'Self', False)
        controller.set_pin_default_value(f'{n(get_bool_channel)}.Channel', 'stretch', False)
        controller.set_pin_default_value(f'{n(get_bool_channel)}.bInitial', 'False', False)
        controller.set_pin_default_value(f'{n(get_item_array_metadata1)}.Name', 'Sub', False)
        # controller.set_pin_default_value(f'{n(get_item_array_metadata1)}.NameSpace', 'Self', False)
        controller.set_pin_default_value(f'{n(greater)}.B', '0', False)
        controller.set_pin_default_value(f'{n(at2)}.Index', '0', False)
        controller.set_pin_default_value(f'{n(at3)}.Index', '0', False)
        controller.set_pin_default_value(f'{n(vetala_lib_get_item)}.index', '-1', False)
