...
class UnrealWheelRig(UnrealUtilRig):
    ...
    def _build_function_construct_graph(self, controller):
        ...
        vetala_lib_control = self._create_control(controller, 2782.0, -1892.0)
        vetala_lib_control1 = self._create_control(controller, 3182.0, -1392.0)
        get_joints = controller.add_variable_node_from_object_path('joints','TArray<FRigElementKey>','/Script/ControlRig.RigElementKey',True,'()', unreal.Vector2D(2282.0, -1392.0), 'Get joints')
        num = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetNum(in Array,out Num)', unreal.Vector2D(1982.0, -1892.0), 'Num')
        equals = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(2182.0, -1892.0), 'Equals')
        branch = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(2382.0, -1892.0), 'Branch')
        at = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(1682.0, -842.0), 'At')
        add = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorAdd', 'Execute', unreal.Vector2D(1982.0, -842.0), 'Add')
        make_array = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayMake(in Values,out Array)', unreal.Vector2D(2182.0, -842.0), 'Make Array')
        equals1 = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(732.0, -1142.0), 'Equals')
        if1 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(882.0, -1142.0), 'If')
        equals2 = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(732.0, -1342.0), 'Equals')
        if2 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(882.0, -1342.0), 'If')
        join = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_StringJoin', 'Execute', unreal.Vector2D(732.0, -942.0), 'Join')
        get_parent = controller.add_variable_node_from_object_path('parent','TArray<FRigElementKey>','/Script/ControlRig.RigElementKey',True,'()', unreal.Vector2D(2282.0, -1592.0), 'Get parent')
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(2482.0, -1592.0), 'vetalaLib_GetItem')
        vetala_lib_get_item1 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(2482.0, -1392.0), 'vetalaLib_GetItem')
        set_item_metadata = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in NameSpace,in Value,out Success)', unreal.Vector2D(3482.0, -1392.0), 'Set Item Metadata')
        spawn_float_animation_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelFloat', 'Execute', unreal.Vector2D(4148.0, -2700.0), 'Spawn Float Animation Channel')
        spawn_float_animation_channel1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelFloat', 'Execute', unreal.Vector2D(4148.0, -2444.0), 'Spawn Float Animation Channel')
        spawn_float_animation_channel2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelFloat', 'Execute', unreal.Vector2D(4148.0, -2188.0), 'Spawn Float Animation Channel')
        get_wheel_diameter = controller.add_variable_node('wheel_diameter','float',None,True,'', unreal.Vector2D(3748.0, -2572.0), 'Get wheel_diameter')
        get_steer_control = controller.add_variable_node_from_object_path('steer_control','TArray<FRigElementKey>','/Script/ControlRig.RigElementKey',True,'()', unreal.Vector2D(3572.0, -540.0), 'Get steer_control')
        vetala_lib_get_item2 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(3796.0, -572.0), 'vetalaLib_GetItem')
        set_item_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in NameSpace,in Value,out Success)', unreal.Vector2D(4132.0, -652.0), 'Set Item Metadata')
        multiply = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleMul', 'Execute', unreal.Vector2D(2324.0, -1176.0), 'Multiply')
        multiply1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleMul', 'Execute', unreal.Vector2D(2708.0, -1176.0), 'Multiply')
        spawn_bool_animation_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelBool', 'Execute', unreal.Vector2D(4148.0, -1916.0), 'Spawn Bool Animation Channel')
        spawn_float_animation_channel3 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelFloat', 'Execute', unreal.Vector2D(4132.0, -1664.0), 'Spawn Float Animation Channel')
        spawn_float_animation_channel4 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelFloat', 'Execute', unreal.Vector2D(4132.0, -1404.0), 'Spawn Float Animation Channel')
        get_tire_bulge = controller.add_variable_node_from_object_path('tire_bulge','TArray<FVector>','/Script/CoreUObject.Vector',True,'()', unreal.Vector2D(3540.0, -700.0), 'Get tire_bulge')
        vetala_lib_get_item_vector = controller.add_function_reference_node(library.find_function('vetalaLib_GetItemVector'), unreal.Vector2D(3780.0, -1084.0), 'vetalaLib_GetItemVector')
        get_tire_diameter_offset = controller.add_variable_node('tire_diameter_offset','float',None,True,'', unreal.Vector2D(3700.0, -1612.0), 'Get tire_diameter_offset')
        spawn_float_animation_channel5 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelFloat', 'Execute', unreal.Vector2D(4132.0, -1164.0), 'Spawn Float Animation Channel')
        spawn_float_animation_channel6 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelFloat', 'Execute', unreal.Vector2D(4132.0, -908.0), 'Spawn Float Animation Channel')

        controller.resolve_wild_card_pin(f'{num.get_node_path()}.Array', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey')
        controller.resolve_wild_card_pin(f'{equals.get_node_path()}.A', 'int32', 'None')
        controller.resolve_wild_card_pin(f'{equals.get_node_path()}.B', 'int32', 'None')
        controller.resolve_wild_card_pin(f'{at.get_node_path()}.Array', 'TArray<FVector>', '/Script/CoreUObject.Vector')
        controller.resolve_wild_card_pin(f'{add.get_node_path()}.Result', 'FVector', '/Script/CoreUObject.Vector')
        controller.resolve_wild_card_pin(f'{make_array.get_node_path()}.Array', 'TArray<FVector>', '/Script/CoreUObject.Vector')
        controller.resolve_wild_card_pin(f'{equals1.get_node_path()}.A', 'FString', 'None')
        controller.resolve_wild_card_pin(f'{equals1.get_node_path()}.B', 'FString', 'None')
        controller.resolve_wild_card_pin(f'{if1.get_node_path()}.Result', 'FString', 'None')
        controller.resolve_wild_card_pin(f'{equals2.get_node_path()}.A', 'FString', 'None')
        controller.resolve_wild_card_pin(f'{equals2.get_node_path()}.B', 'FString', 'None')
        controller.resolve_wild_card_pin(f'{if2.get_node_path()}.Result', 'FString', 'None')
        ...
        graph.add_link(branch,'False',vetala_lib_control,'ExecuteContext',controller)
        graph.add_link(vetala_lib_control,'ExecuteContext',vetala_lib_control1,'ExecuteContext',controller)
        graph.add_link(vetala_lib_control1,'ExecuteContext',set_item_metadata,'ExecuteContext',controller)
        graph.add_link('Start Execute Node','True',branch,'ExecuteContext',controller)
        graph.add_link(set_item_metadata,'ExecuteContext',spawn_float_animation_channel,'ExecutePin',controller)
        graph.add_link(spawn_float_animation_channel6,'ExecutePin',set_item_metadata1,'ExecuteContext',controller)
        ...
        graph.add_link('Entry','side',vetala_lib_control,'side',controller)
        graph.add_link('Entry','restrain_numbering',vetala_lib_control,'restrain_numbering',controller)
        graph.add_link(if1,'Result',vetala_lib_control,'shape',controller)
        graph.add_link('Entry','color',vetala_lib_control,'color',controller)
        graph.add_link('Entry','shape_translate',vetala_lib_control,'translate',controller)
        graph.add_link(make_array,'Array',vetala_lib_control,'rotate',controller)
        graph.add_link('Entry','shape_scale',vetala_lib_control,'scale',controller)
        graph.add_link(multiply,'Result',vetala_lib_control,'scale_offset',controller)
        graph.add_link(vetala_lib_control,'Control',vetala_lib_control1,'parent',controller)
        graph.add_link(vetala_lib_control,'Control',spawn_float_animation_channel,'Parent',controller)
        graph.add_link(vetala_lib_control,'Control',spawn_float_animation_channel1,'Parent',controller)
        graph.add_link(vetala_lib_control,'Control',spawn_float_animation_channel2,'Parent',controller)
        graph.add_link(vetala_lib_control,'Control',spawn_bool_animation_channel,'Parent',controller)
        graph.add_link(vetala_lib_control,'Control',spawn_float_animation_channel3,'Parent',controller)
        graph.add_link(vetala_lib_control,'Control',spawn_float_animation_channel4,'Parent',controller)
        graph.add_link(vetala_lib_control,'Control',spawn_float_animation_channel5,'Parent',controller)
        graph.add_link(vetala_lib_control,'Control',spawn_float_animation_channel6,'Parent',controller)
        graph.add_link(vetala_lib_get_item1,'Element',vetala_lib_control1,'driven',controller)
        graph.add_link(join,'Result',vetala_lib_control1,'description',controller)
        graph.add_link('Entry','side',vetala_lib_control1,'side',controller)
        graph.add_link('Entry','restrain_numbering',vetala_lib_control1,'restrain_numbering',controller)
        graph.add_link(if2,'Result',vetala_lib_control1,'shape',controller)
        graph.add_link('Entry','spin_control_color',vetala_lib_control1,'color',controller)
        graph.add_link('Entry','shape_translate',vetala_lib_control1,'translate',controller)
        graph.add_link(make_array,'Array',vetala_lib_control1,'rotate',controller)
        graph.add_link('Entry','shape_scale',vetala_lib_control1,'scale',controller)
        graph.add_link(multiply1,'Result',vetala_lib_control1,'scale_offset',controller)
        graph.add_link(vetala_lib_control1,'Control',set_item_metadata,'Value',controller)
        ...
        graph.add_link(num,'Num',equals,'A',controller)
        graph.add_link(equals,'Result',branch,'Condition',controller)
        graph.add_link('Entry','shape_rotate',at,'Array',controller)
        graph.add_link(at,'Element',add,'B',controller)
        graph.add_link('Entry','shape',equals1,'A',controller)
        graph.add_link(equals1,'Result',if1,'Condition',controller)
        graph.add_link('Entry','shape',if1,'False',controller)
        graph.add_link('Entry','spin_control_shape',equals2,'A',controller)
        graph.add_link(equals2,'Result',if2,'Condition',controller)
        graph.add_link('Entry','spin_control_shape',if2,'False',controller)
        graph.add_link(get_parent,'Value',vetala_lib_get_item,'Array',controller)
        graph.add_link(vetala_lib_get_item1,'Element',set_item_metadata,'Item',controller)
        graph.add_link(spawn_float_animation_channel,'ExecutePin',spawn_float_animation_channel1,'ExecutePin',controller)
        graph.add_link(get_wheel_diameter,'Value',spawn_float_animation_channel,'InitialValue',controller)
        graph.add_link(spawn_float_animation_channel1,'ExecutePin',spawn_float_animation_channel2,'ExecutePin',controller)
        graph.add_link(spawn_float_animation_channel2,'ExecutePin',spawn_bool_animation_channel,'ExecutePin',controller)
        graph.add_link(get_steer_control,'Value',vetala_lib_get_item2,'Array',controller)
        graph.add_link(vetala_lib_get_item2,'Element',set_item_metadata1,'Value',controller)
        graph.add_link('Entry','wheel_diameter',multiply,'A',controller)
        graph.add_link(multiply,'Result',multiply1,'A',controller)
        graph.add_link(spawn_bool_animation_channel,'ExecutePin',spawn_float_animation_channel3,'ExecutePin',controller)
        graph.add_link(spawn_float_animation_channel3,'ExecutePin',spawn_float_animation_channel4,'ExecutePin',controller)
        graph.add_link(get_tire_diameter_offset,'Value',spawn_float_animation_channel3,'InitialValue',controller)
        graph.add_link(spawn_float_animation_channel4,'ExecutePin',spawn_float_animation_channel5,'ExecutePin',controller)
        graph.add_link(vetala_lib_get_item_vector,'Element.X',spawn_float_animation_channel4,'InitialValue',controller)
        graph.add_link(get_tire_bulge,'Value',vetala_lib_get_item_vector,'Vector',controller)
        graph.add_link(vetala_lib_get_item_vector,'Element.Y',spawn_float_animation_channel5,'InitialValue',controller)
        graph.add_link(vetala_lib_get_item_vector,'Element.Z',spawn_float_animation_channel6,'InitialValue',controller)
        graph.add_link(spawn_float_animation_channel5,'ExecutePin',spawn_float_animation_channel6,'ExecutePin',controller)
        graph.add_link(add,'Result',make_array,'Values.0',controller)
        ...
        graph.set_pin(vetala_lib_control1, 'increment', '0', controller)
        graph.set_pin(vetala_lib_control1, 'sub_count', '0', controller)
        graph.set_pin(vetala_lib_control1, 'sub_color', '((R=0,G=0,B=0,A=0.000000))', controller)
        graph.set_pin(equals, 'B', '0', controller)
        graph.set_pin(at, 'Index', '0', controller)
        graph.set_pin(add, 'A', '(X=0.000000,Y=90.000000,Z=0.000000)', controller)
        graph.set_pin(make_array, 'Values', '((X=0.000000,Y=0.000000,Z=0.000000))', controller)
        graph.set_pin(equals1, 'B', 'Default', controller)
        graph.set_pin(if1, 'True', 'Circle_Thin', controller)
        graph.set_pin(equals2, 'B', 'Default', controller)
        graph.set_pin(if2, 'True', 'Arrow4_Solid', controller)
        graph.set_pin(join, 'Values', '("","spin")', controller)
        graph.set_pin(join, 'Separator', '_', controller)
        graph.set_pin(vetala_lib_get_item, 'index', '-1', controller)
        graph.set_pin(vetala_lib_get_item1, 'index', '0', controller)
        graph.set_pin(set_item_metadata, 'Name', 'Control', controller)
        graph.set_pin(set_item_metadata, 'NameSpace', 'Self', controller)
        graph.set_pin(spawn_float_animation_channel, 'Name', 'Diameter', controller)
        graph.set_pin(spawn_float_animation_channel, 'MinimumValue', '0.000000', controller)
        graph.set_pin(spawn_float_animation_channel, 'MaximumValue', '1000000000000.0', controller)
        graph.set_pin(spawn_float_animation_channel, 'LimitsEnabled', '(Enabled=(bMinimum=True,bMaximum=True))', controller)
        graph.set_pin(spawn_float_animation_channel1, 'Name', 'Enable', controller)
        graph.set_pin(spawn_float_animation_channel1, 'InitialValue', '1.0', controller)
        graph.set_pin(spawn_float_animation_channel1, 'MinimumValue', '0.000000', controller)
        graph.set_pin(spawn_float_animation_channel1, 'MaximumValue', '1.000000', controller)
        graph.set_pin(spawn_float_animation_channel1, 'LimitsEnabled', '(Enabled=(bMinimum=True,bMaximum=True))', controller)
        graph.set_pin(spawn_float_animation_channel2, 'Name', 'RotateMultiply', controller)
        graph.set_pin(spawn_float_animation_channel2, 'InitialValue', '1.0', controller)
        graph.set_pin(spawn_float_animation_channel2, 'MinimumValue', '0.000000', controller)
        graph.set_pin(spawn_float_animation_channel2, 'MaximumValue', '1.000000', controller)
        graph.set_pin(spawn_float_animation_channel2, 'LimitsEnabled', '(Enabled=(bMinimum=True,bMaximum=True))', controller)
        graph.set_pin(set_item_metadata1, 'Name', 'Steer', controller)
        graph.set_pin(set_item_metadata1, 'NameSpace', 'Self', controller)
        graph.set_pin(multiply, 'B', '0.010000', controller)
        graph.set_pin(multiply1, 'B', '0.800000', controller)
        graph.set_pin(spawn_bool_animation_channel, 'Name', 'SlideOnNearestMesh', controller)
        graph.set_pin(spawn_bool_animation_channel, 'InitialValue', 'true', controller)
        graph.set_pin(spawn_bool_animation_channel, 'MinimumValue', 'False', controller)
        graph.set_pin(spawn_bool_animation_channel, 'MaximumValue', 'True', controller)
        graph.set_pin(spawn_float_animation_channel3, 'Name', 'DiameterCollisionMultiply', controller)
        graph.set_pin(spawn_float_animation_channel3, 'MinimumValue', '0.000000', controller)
        graph.set_pin(spawn_float_animation_channel3, 'MaximumValue', '2.000000', controller)
        graph.set_pin(spawn_float_animation_channel3, 'LimitsEnabled', '(Enabled=(bMinimum=True,bMaximum=True))', controller)
        graph.set_pin(spawn_float_animation_channel4, 'Name', 'BulgeX', controller)
        graph.set_pin(spawn_float_animation_channel4, 'MinimumValue', '0.000000', controller)
        graph.set_pin(spawn_float_animation_channel4, 'MaximumValue', '2.000000', controller)
        graph.set_pin(spawn_float_animation_channel4, 'LimitsEnabled', '(Enabled=(bMinimum=True,bMaximum=True))', controller)
        graph.set_pin(spawn_float_animation_channel5, 'Name', 'BulgeY', controller)
        graph.set_pin(spawn_float_animation_channel5, 'MinimumValue', '0.000000', controller)
        graph.set_pin(spawn_float_animation_channel5, 'MaximumValue', '2.000000', controller)
        graph.set_pin(spawn_float_animation_channel5, 'LimitsEnabled', '(Enabled=(bMinimum=True,bMaximum=True))', controller)
        graph.set_pin(spawn_float_animation_channel6, 'Name', 'BulgeZ', controller)
        graph.set_pin(spawn_float_animation_channel6, 'MinimumValue', '0.000000', controller)
        graph.set_pin(spawn_float_animation_channel6, 'MaximumValue', '2.000000', controller)
        graph.set_pin(spawn_float_animation_channel6, 'LimitsEnabled', '(Enabled=(bMinimum=True,bMaximum=True))', controller)
    ...
    def _build_function_forward_graph(self, controller):
        ...
        get_joints = controller.add_variable_node_from_object_path('joints','TArray<FRigElementKey>','/Script/ControlRig.RigElementKey',True,'()', unreal.Vector2D(600.0, 104.0), 'Get joints')
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(800.0, 104.0), 'vetalaLib_GetItem')
        get_item_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(976.0, 96.0), 'Get Item Metadata')
        get_parent = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyGetParent', 'Execute', unreal.Vector2D(1300.0, 104.0), 'Get Parent')
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(2176.0, 320.0), 'Get Transform')
        set_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(2592.0, 208.0), 'Set Transform')
        vetala_lib_wheel_automate = controller.add_function_reference_node(library.find_function('vetalaLib_WheelAutomate'), unreal.Vector2D(2736.0, 576.0), 'vetalaLib_WheelAutomate')
        at = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(2320.0, 736.0), 'At')
        at1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(2320.0, 864.0), 'At')
        get_float_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(1296.0, 276.0), 'Get Float Channel')
        get_float_channel1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(1296.0, 436.0), 'Get Float Channel')
        get_float_channel2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(1296.0, 596.0), 'Get Float Channel')
        get_item_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(744.0, 1640.0), 'Get Item Metadata')
        get_transform1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(1064.0, 1640.0), 'Get Transform')
        at2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(1044.0, 1940.0), 'At')
        to_euler = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionToEuler', 'Execute', unreal.Vector2D(1344.0, 1640.0), 'To Euler')
        if1 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(1744.0, 1840.0), 'If')
        multiply = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorMul', 'Execute', unreal.Vector2D(1944.0, 1640.0), 'Multiply')
        add = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleAdd', 'Execute', unreal.Vector2D(2144.0, 1640.0), 'Add')
        add1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleAdd', 'Execute', unreal.Vector2D(2344.0, 1640.0), 'Add')
        get_bool_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetBoolAnimationChannel', 'Execute', unreal.Vector2D(1296.0, 756.0), 'Get Bool Channel')
        get_tire_joints = controller.add_variable_node_from_object_path('tire_joints','TArray<FRigElementKey>','/Script/ControlRig.RigElementKey',True,'()', unreal.Vector2D(2016.0, 1456.0), 'Get tire_joints')
        vetala_lib_tire_collision = controller.add_function_reference_node(library.find_function('vetalaLib_TireCollision'), unreal.Vector2D(2752.0, 1072.0), 'vetalaLib_TireCollision')
        get_float_channel3 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(1296.0, 900.0), 'Get Float Channel')
        from_string = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(1008.0, 900.0), 'From String')
        get_float_channel4 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(1296.0, 1028.0), 'Get Float Channel')
        from_string1 = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(992.0, 996.0), 'From String')
        get_float_channel5 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(1296.0, 1184.0), 'Get Float Channel')
        from_string2 = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(992.0, 1152.0), 'From String')
        get_float_channel6 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(1296.0, 1328.0), 'Get Float Channel')
        from_string3 = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(992.0, 1296.0), 'From String')
        from_string4 = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(960.0, 752.0), 'From String')
        from_string5 = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(960.0, 640.0), 'From String')
        from_string6 = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(976.0, 512.0), 'From String')
        from_string7 = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(960.0, 368.0), 'From String')
        set_transform1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(2705.9990234375, 1728.972900390625), 'Set Transform')
        get_brake_joint = controller.add_variable_node_from_object_path('brake_joint','TArray<FRigElementKey>','/Script/ControlRig.RigElementKey',True,'()', unreal.Vector2D(2352.0, 1872.0), 'Get brake_joint')
        vetala_lib_get_item1 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(2512.0, 1952.0), 'vetalaLib_GetItem')
        project_to_new_parent = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ProjectTransformToNewParent', 'Execute', unreal.Vector2D(2768.0, 2032.0), 'Project to new Parent')

        controller.resolve_wild_card_pin(f'{at.get_node_path()}.Array', 'TArray<FVector>', '/Script/CoreUObject.Vector')
        controller.resolve_wild_card_pin(f'{at1.get_node_path()}.Array', 'TArray<FVector>', '/Script/CoreUObject.Vector')
        controller.resolve_wild_card_pin(f'{at2.get_node_path()}.Array', 'TArray<FVector>', '/Script/CoreUObject.Vector')
        ...
        graph.add_link(set_transform,'ExecutePin',vetala_lib_wheel_automate,'ExecuteContext',controller)
        graph.add_link(vetala_lib_wheel_automate,'ExecuteContext',vetala_lib_tire_collision,'ExecuteContext',controller)
        graph.add_link(vetala_lib_tire_collision,'ExecuteContext',set_transform1,'ExecutePin',controller)
        ...
        graph.add_link(get_item_metadata,'Value',get_transform,'Item',controller)
        graph.add_link(get_item_metadata,'Value',get_item_metadata1,'Item',controller)
        graph.add_link(get_item_metadata,'Value',vetala_lib_tire_collision,'control_spin',controller)
        graph.add_link(get_item_metadata,'Value',vetala_lib_wheel_automate,'control_spin',controller)
        graph.add_link(get_parent,'Parent',vetala_lib_tire_collision,'control',controller)
        graph.add_link(get_parent,'Parent',vetala_lib_wheel_automate,'control',controller)
        graph.add_link(get_parent,'Parent',project_to_new_parent,'OldParent',controller)
        graph.add_link(get_parent,'Parent',project_to_new_parent,'NewParent',controller)
        graph.add_link(get_parent,'Parent.Name',get_float_channel,'Control',controller)
        graph.add_link(get_parent,'Parent.Name',get_float_channel1,'Control',controller)
        graph.add_link(get_parent,'Parent.Name',get_float_channel2,'Control',controller)
        graph.add_link(get_parent,'Parent.Name',get_bool_channel,'Control',controller)
        graph.add_link(get_parent,'Parent.Name',get_float_channel3,'Control',controller)
        graph.add_link(get_parent,'Parent.Name',get_float_channel4,'Control',controller)
        graph.add_link(get_parent,'Parent.Name',get_float_channel5,'Control',controller)
        graph.add_link(get_parent,'Parent.Name',get_float_channel6,'Control',controller)
        graph.add_link(get_transform,'Transform',set_transform,'Value',controller)
        graph.add_link('Start Execute Node','True',set_transform,'ExecutePin',controller)
        graph.add_link(get_float_channel2,'Value',vetala_lib_wheel_automate,'Diameter',controller)
        graph.add_link(get_float_channel,'Value',vetala_lib_wheel_automate,'Enable',controller)
        graph.add_link(get_float_channel1,'Value',vetala_lib_wheel_automate,'RotateMultiply',controller)
        graph.add_link(at,'Element',vetala_lib_wheel_automate,'forwardAxis',controller)
        graph.add_link(at1,'Element',vetala_lib_wheel_automate,'rotateAxis',controller)
        graph.add_link(add1,'Result',vetala_lib_wheel_automate,'steer',controller)
        graph.add_link('Entry','forward_axis',at,'Array',controller)
        graph.add_link('Entry','rotate_axis',at1,'Array',controller)
        graph.add_link(from_string7,'Result',get_float_channel,'Channel',controller)
        graph.add_link(from_string6,'Result',get_float_channel1,'Channel',controller)
        graph.add_link(from_string5,'Result',get_float_channel2,'Channel',controller)
        graph.add_link(get_float_channel2,'Value',vetala_lib_tire_collision,'Diameter',controller)
        graph.add_link(get_item_metadata1,'Value',get_transform1,'Item',controller)
        graph.add_link(get_transform1,'Transform.Rotation',to_euler,'Value',controller)
        graph.add_link(get_transform1,'Transform.Translation',if1,'False',controller)
        graph.add_link('Entry','steer_axis',at2,'Array',controller)
        graph.add_link(at2,'Element',multiply,'B',controller)
        graph.add_link(to_euler,'Result',if1,'True',controller)
        graph.add_link('Entry','steer_use_rotate',if1,'Condition',controller)
        graph.add_link(if1,'Result',multiply,'A',controller)
        graph.add_link(multiply,'Result.X',add,'A',controller)
        graph.add_link(multiply,'Result.Y',add,'B',controller)
        graph.add_link(multiply,'Result.Z',add1,'B',controller)
        graph.add_link(add,'Result',add1,'A',controller)
        graph.add_link(from_string4,'Result',get_bool_channel,'Channel',controller)
        graph.add_link(get_bool_channel,'Value',vetala_lib_tire_collision,'slide_on_nearest',controller)
        graph.add_link(get_tire_joints,'Value',vetala_lib_tire_collision,'tire_joints',controller)
        graph.add_link(get_float_channel3,'Value',vetala_lib_tire_collision,'diameter_collision_multiply',controller)
        graph.add_link(from_string,'Result',get_float_channel3,'Channel',controller)
        graph.add_link(from_string1,'Result',get_float_channel4,'Channel',controller)
        graph.add_link(from_string2,'Result',get_float_channel5,'Channel',controller)
        graph.add_link(from_string3,'Result',get_float_channel6,'Channel',controller)
        graph.add_link(vetala_lib_get_item1,'Element',set_transform1,'Item',controller)
        graph.add_link(project_to_new_parent,'Transform',set_transform1,'Value',controller)
        graph.add_link(get_brake_joint,'Value',vetala_lib_get_item1,'Array',controller)
        graph.add_link(vetala_lib_get_item1,'Element',project_to_new_parent,'Child',controller)
        graph.add_link(get_float_channel4,'Value',vetala_lib_tire_collision,'tire_bulge.X',controller)
        graph.add_link(get_float_channel5,'Value',vetala_lib_tire_collision,'tire_bulge.Y',controller)
        graph.add_link(get_float_channel6,'Value',vetala_lib_tire_collision,'tire_bulge.Z',controller)

        graph.set_pin(get_item_metadata, 'Name', 'Control', controller)
        graph.set_pin(get_item_metadata, 'NameSpace', 'Self', controller)
        graph.set_pin(get_item_metadata, 'Default', '(Type=Bone,Name="None")', controller)
        graph.set_pin(get_parent, 'bDefaultParent', 'True', controller)
        graph.set_pin(get_transform, 'Space', 'GlobalSpace', controller)
        ...
        graph.set_pin(get_item_metadata1, 'Name', 'Steer', controller)
        graph.set_pin(get_item_metadata1, 'NameSpace', 'Self', controller)
        graph.set_pin(get_item_metadata1, 'Default', '(Type=Bone,Name="None")', controller)
        graph.set_pin(get_transform1, 'Space', 'LocalSpace', controller)
        graph.set_pin(get_transform1, 'bInitial', 'False', controller)
        graph.set_pin(at2, 'Index', '0', controller)
        graph.set_pin(to_euler, 'RotationOrder', 'ZYX', controller)
        graph.set_pin(get_bool_channel, 'bInitial', 'False', controller)
        graph.set_pin(vetala_lib_tire_collision, 'tire_bulge', '(X=0.000000,Y=0.000000,Z=0.000000)', controller)
        graph.set_pin(vetala_lib_tire_collision, 'tire_bulge_clamp', '(X=2.000000,Y=2.000000,Z=2.000000)', controller)
        graph.set_pin(get_float_channel3, 'bInitial', 'False', controller)
        graph.set_pin(from_string, 'String', 'DiameterCollisionMultiply', controller)
        graph.set_pin(get_float_channel4, 'bInitial', 'False', controller)
        graph.set_pin(get_float_channel4, 'CachedChannelHash', '0', controller)
        graph.set_pin(from_string1, 'String', 'BulgeX', controller)
        graph.set_pin(get_float_channel5, 'bInitial', 'False', controller)
        graph.set_pin(get_float_channel5, 'CachedChannelHash', '0', controller)
        graph.set_pin(from_string2, 'String', 'BulgeY', controller)
        graph.set_pin(get_float_channel6, 'bInitial', 'False', controller)
        graph.set_pin(get_float_channel6, 'CachedChannelHash', '0', controller)
        graph.set_pin(from_string3, 'String', 'BulgeZ', controller)
        graph.set_pin(from_string4, 'String', 'SlideOnNearestMesh', controller)
        graph.set_pin(from_string5, 'String', 'Diameter', controller)
        graph.set_pin(from_string6, 'String', 'RotateMultiply', controller)
        graph.set_pin(from_string7, 'String', 'Enable', controller)
        graph.set_pin(set_transform1, 'Space', 'GlobalSpace', controller)
        graph.set_pin(set_transform1, 'bInitial', 'False', controller)
        graph.set_pin(set_transform1, 'Weight', '1.000000', controller)
        graph.set_pin(set_transform1, 'bPropagateToChildren', 'True', controller)
...
class UnrealAimMultiAtCurveRig(UnrealUtilRig):
    ...
    def _build_function_construct_graph(self, controller):
        ...
        get_joints = controller.add_variable_node_from_object_path('joints', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(964.0, -2373.0), 'Get joints')
        num = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetNum(in Array,out Num)', unreal.Vector2D(1127.0, -2382.0), 'Num')
        greater = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntGreater', 'Execute', unreal.Vector2D(1335.0, -2398.0), 'Greater')
        branch = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(1543.0, -2494.0), 'Branch')
        vetala_lib_get_tops = controller.add_function_reference_node(library.find_function('vetalaLib_GetTops'), unreal.Vector2D(1799.0, -2654.0), 'vetalaLib_GetTops')
        spline_from_items = controller.add_external_function_reference_node('/ControlRigSpline/SplineFunctionLibrary/SplineFunctionLibrary.SplineFunctionLibrary_C', 'SplineFromItems', unreal.Vector2D(3447.0, -2766.0), 'SplineFromItems')
        add = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayAdd(io Array,in Element,out Index)', unreal.Vector2D(6119.0, -2270.0), 'Add')
        draw_spline = controller.add_unit_node_from_struct_path('/Script/ControlRigSpline.RigUnit_DrawControlRigSpline', 'Execute', unreal.Vector2D(4055.0, -2590.0), 'Draw Spline')
        add1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayAdd(io Array,in Element,out Index)', unreal.Vector2D(4631.0, -3566.0), 'Add')
        for_each = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayIterator(in Array,out Element,out Index,out Count,out Ratio)', unreal.Vector2D(3159.0, -3502.0), 'For Each')
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(3351.0, -3230.0), 'Get Transform')
        transform_location = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathTransformTransformVector', 'Execute', unreal.Vector2D(3895.0, -3278.0), 'Transform Location')
        multiply = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorMul', 'Execute', unreal.Vector2D(3719.0, -3086.0), 'Multiply')
        get_local_controls = controller.add_variable_node_from_object_path('local_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(5975.0, -2574.0), 'Get local_controls')
        get_aims = controller.add_variable_node_from_object_path('aims', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(4471.0, -3790.0), 'Get aims')
        spawn_null = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddNull', 'Execute', unreal.Vector2D(4247.0, -3550.0), 'Spawn Null')
        vetala_lib_find_bone_aim_axis = controller.add_function_reference_node(library.find_function('vetalaLib_findBoneAimAxis'), unreal.Vector2D(3543.0, -3502.0), 'vetalaLib_findBoneAimAxis')
        for_loop = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ForLoopCount', 'Execute', unreal.Vector2D(4263.0, -2590.0), 'For Loop')
        position_from_spline = controller.add_unit_node_from_struct_path('/Script/ControlRigSpline.RigUnit_PositionFromControlRigSpline', 'Execute', unreal.Vector2D(4743.0, -2606.0), 'Position From Spline')
        get_aims1 = controller.add_variable_node_from_object_path('aims', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(3127.0, -2622.0), 'Get aims')
        reset = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayReset(io Array)', unreal.Vector2D(2119.0, -2446.0), 'Reset')
        get_aims2 = controller.add_variable_node_from_object_path('aims', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(1986.0, -2249.0), 'Get aims')
        vetala_lib_control = self._create_control(controller, 5559.0, -2270.0)
        spawn_null1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddNull', 'Execute', unreal.Vector2D(5111.0, -2206.0), 'Spawn Null')
        get_parent = controller.add_variable_node_from_object_path('parent', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(2903.0, -2398.0), 'Get parent')
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(3079.0, -2366.0), 'vetalaLib_GetItem')
        set_default_parent = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetDefaultParent', 'Execute', unreal.Vector2D(5815.0, -2414.0), 'Set Default Parent')
        get_children = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_CollectionChildrenArray', 'Execute', unreal.Vector2D(5511.0, -3710.0), 'Get Children')
        num1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetNum(in Array,out Num)', unreal.Vector2D(5863.0, -3710.0), 'Num')
        make_array = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayMake(in Values,out Array)', unreal.Vector2D(5879.0, -3326.0), 'Make Array')
        greater1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntGreater', 'Execute', unreal.Vector2D(6087.0, -3710.0), 'Greater')
        branch1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(6503.0, -3278.0), 'Branch')
        for_each1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayIterator(in Array,out Element,out Index,out Count,out Ratio)', unreal.Vector2D(6743.0, -3246.0), 'For Each')
        find = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayFind(in Array,in Element,out Index,out Success)', unreal.Vector2D(7063.0, -3230.0), 'Find')
        get_joints1 = controller.add_variable_node_from_object_path('joints', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(6791.0, -3390.0), 'Get joints')
        branch2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(7239.0, -3454.0), 'Branch')
        add2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayAdd(io Array,in Element,out Index)', unreal.Vector2D(7591.0, -3598.0), 'Add')
        vetala_lib_control1 = self._create_control(controller, 7879.0, -2334.0)
        for_each2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayIterator(in Array,out Element,out Index,out Count,out Ratio)', unreal.Vector2D(7111.0, -2766.0), 'For Each')
        get_parent1 = controller.add_variable_node_from_object_path('parent', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(6647.0, -2238.0), 'Get parent')
        vetala_lib_get_item1 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(6823.0, -2254.0), 'vetalaLib_GetItem')
        set_fk_items = controller.add_variable_node_from_object_path('fk_items', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', False, '()', unreal.Vector2D(6199.0, -3246.0), 'Set fk_items')
        get_fk_items = controller.add_variable_node_from_object_path('fk_items', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(5463.0, -3102.0), 'Get fk_items')
        reset1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayReset(io Array)', unreal.Vector2D(5639.0, -3102.0), 'Reset')
        get_fk_items1 = controller.add_variable_node_from_object_path('fk_items', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(7303.0, -3678.0), 'Get fk_items')
        get_fk_items2 = controller.add_variable_node_from_object_path('fk_items', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(6855.0, -2654.0), 'Get fk_items')
        set_last_control = controller.add_variable_node_from_object_path('last_control', 'FRigElementKey', '/Script/ControlRig.RigElementKey', False, '', unreal.Vector2D(9692.0, -2320.0), 'Set last_control')
        get_last_control = controller.add_variable_node_from_object_path('last_control', 'FRigElementKey', '/Script/ControlRig.RigElementKey', True, '', unreal.Vector2D(6791.0, -2430.0), 'Get last_control')
        if1 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(7287.0, -2286.0), 'If')
        item_exists = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ItemExists', 'Execute', unreal.Vector2D(6999.0, -2414.0), 'Item Exists')
        set_last_control1 = controller.add_variable_node_from_object_path('last_control', 'FRigElementKey', '/Script/ControlRig.RigElementKey', False, '', unreal.Vector2D(5895.0, -3134.0), 'Set last_control')
        get_transform1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(7687.0, -2926.0), 'Get Transform')
        join = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_StringJoin', 'Execute', unreal.Vector2D(8140.0, -2192.0), 'Join')
        from_string = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(8231.0, -2334.0), 'From String')
        get_description = controller.add_variable_node('description', 'FString', None, True, '', unreal.Vector2D(7127.0, -2126.0), 'Get description')
        spawn_null2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddNull', 'Execute', unreal.Vector2D(8460.0, -2736.0), 'Spawn Null')
        to_string = controller.add_template_node('DISPATCH_RigDispatch_ToString(in Value,out Result)', unreal.Vector2D(8135.0, -1982.0), 'To String')
        set_default_parent1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetDefaultParent', 'Execute', unreal.Vector2D(8967.0, -2734.0), 'Set Default Parent')
        join1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_StringJoin', 'Execute', unreal.Vector2D(7335.0, -2126.0), 'Join')
        add3 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntAdd', 'Execute', unreal.Vector2D(6935.0, -2014.0), 'Add')
        to_string1 = controller.add_template_node('DISPATCH_RigDispatch_ToString(in Value,out Result)', unreal.Vector2D(7127.0, -2030.0), 'To String')
        set_item_array_metadata = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in NameSpace,in Value,out Success)', unreal.Vector2D(9991.0, -2686.0), 'Set Item Array Metadata')
        get_fk_controls = controller.add_variable_node_from_object_path('fk_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(8999.0, -2094.0), 'Get fk_controls')
        add4 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayAdd(io Array,in Element,out Index)', unreal.Vector2D(9276.0, -1936.0), 'Add')
        get_fk_controls1 = controller.add_variable_node_from_object_path('fk_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(9751.0, -2510.0), 'Get fk_controls')
        reset2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayReset(io Array)', unreal.Vector2D(3127.0, -3790.0), 'Reset')
        get_fk_controls2 = controller.add_variable_node_from_object_path('fk_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(2919.0, -3918.0), 'Get fk_controls')
        set_item_metadata = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in NameSpace,in Value,out Success)', unreal.Vector2D(10567.0, -2686.0), 'Set Item Metadata')
        get_aims3 = controller.add_variable_node_from_object_path('aims', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(10151.0, -2398.0), 'Get aims')
        vetala_lib_get_item2 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(10327.0, -2398.0), 'vetalaLib_GetItem')
        set_item_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in NameSpace,in Value,out Success)', unreal.Vector2D(9612.0, -2016.0), 'Set Item Metadata')
        get_aim_controls = controller.add_variable_node_from_object_path('aim_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(3415.0, -3902.0), 'Get aim_controls')
        reset3 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayReset(io Array)', unreal.Vector2D(3463.0, -3790.0), 'Reset')
        add5 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayAdd(io Array,in Element,out Index)', unreal.Vector2D(6359.0, -2270.0), 'Add')
        get_aim_controls1 = controller.add_variable_node_from_object_path('aim_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(6183.0, -2574.0), 'Get aim_controls')
        vetala_lib_get_item3 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(3719.0, -2030.0), 'vetalaLib_GetItem')
        set_item_array_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in NameSpace,in Value,out Success)', unreal.Vector2D(4170.0, -1389.0), 'Set Item Array Metadata')
        get_aim_controls2 = controller.add_variable_node_from_object_path('aim_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(3826.0, -1273.0), 'Get aim_controls')
        set_item_array_metadata2 = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in NameSpace,in Value,out Success)', unreal.Vector2D(4599.0, -1358.0), 'Set Item Array Metadata')
        get_aims4 = controller.add_variable_node_from_object_path('aims', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(4482.0, -953.0), 'Get aims')
        set_item_metadata2 = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in NameSpace,in Value,out Success)', unreal.Vector2D(10007.0, -2014.0), 'Set Item Metadata')
        branch3 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(6087.0, -2062.0), 'Branch')
        equals = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(4467.0, -2066.0), 'Equals')
        equals1 = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(4455.0, -1950.0), 'Equals')
        or1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathBoolOr', 'Execute', unreal.Vector2D(4647.0, -1998.0), 'Or')
        spawn_scale_float_animation_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelScaleFloat', 'Execute', unreal.Vector2D(5991.0, -1390.0), 'Spawn Scale Float Animation Channel')
        spawn_scale_float_animation_channel1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelScaleFloat', 'Execute', unreal.Vector2D(6423.0, -1406.0), 'Spawn Scale Float Animation Channel')
        get_offset = controller.add_variable_node('offset', 'float', None, True, '', unreal.Vector2D(3539.0, -2958.0), 'Get offset')
        if2 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(5121.0, -1786.0), 'If')
        spawn_null3 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddNull', 'Execute', unreal.Vector2D(8471.0, -2478.0), 'Spawn Null')
        join2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_StringJoin', 'Execute', unreal.Vector2D(8391.0, -2014.0), 'Join')
        from_string1 = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(8487.0, -2158.0), 'From String')
        to_string2 = controller.add_template_node('DISPATCH_RigDispatch_ToString(in Value,out Result)', unreal.Vector2D(8391.0, -1806.0), 'To String')
        set_item_metadata3 = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in NameSpace,in Value,out Success)', unreal.Vector2D(10423.0, -2014.0), 'Set Item Metadata')
        get_top_parents = controller.add_variable_node_from_object_path('top_parents', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(4080.0, -4236.0), 'Get top_parents')
        num2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetNum(in Array,out Num)', unreal.Vector2D(4256.0, -4252.0), 'Num')
        greater2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntGreater', 'Execute', unreal.Vector2D(4488.0, -4197.0), 'Greater')
        spline_from_items1 = controller.add_external_function_reference_node('/ControlRigSpline/SplineFunctionLibrary/SplineFunctionLibrary.SplineFunctionLibrary_C', 'SplineFromItems', unreal.Vector2D(4704.0, -4588.0), 'SplineFromItems')
        position_from_spline1 = controller.add_unit_node_from_struct_path('/Script/ControlRigSpline.RigUnit_PositionFromControlRigSpline', 'Execute', unreal.Vector2D(4992.0, -4300.0), 'Position From Spline')
        make_transform = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathTransformMake', 'Execute', unreal.Vector2D(5296.0, -4316.0), 'Make Transform')
        subtract = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleSub', 'Execute', unreal.Vector2D(4208.0, -4092.0), 'Subtract')
        branch4 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(5021.0, -3818.0), 'Branch')
        spawn_null4 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddNull', 'Execute', unreal.Vector2D(5733.0, -4136.0), 'Spawn Null')
        get_parent2 = controller.add_variable_node_from_object_path('parent', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(5292.0, -4081.0), 'Get parent')
        vetala_lib_get_item4 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(5468.0, -4049.0), 'vetalaLib_GetItem')
        set_item_metadata4 = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in NameSpace,in Value,out Success)', unreal.Vector2D(6519.0, -4238.0), 'Set Item Metadata')
        at = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(4759.0, -4110.0), 'At')
        vetala_lib_zero_out_transform = controller.add_function_reference_node(library.find_function('vetalaLib_ZeroOutTransform'), unreal.Vector2D(9340.0, -2432.0), 'vetalaLib_ZeroOutTransform')
        spawn_bool_animation_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelBool', 'Execute', unreal.Vector2D(5340.0, -1280.0), 'Spawn Bool Animation Channel')
        at1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(5164.0, -912.0), 'At')
        get_local_controls1 = controller.add_variable_node_from_object_path('local_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(4956.0, -864.0), 'Get local_controls')
        spawn_bool_animation_channel1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelBool', 'Execute', unreal.Vector2D(5818.0, -965.0), 'Spawn Bool Animation Channel')
        spawn_bool_animation_channel2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelBool', 'Execute', unreal.Vector2D(6224.0, -937.0), 'Spawn Bool Animation Channel')
        multiply1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleMul', 'Execute', unreal.Vector2D(5036.0, -1616.0), 'Multiply')
        if3 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(4796.0, -1632.0), 'If')
        ...
        controller.resolve_wild_card_pin(f'{at1.get_node_path()}.Array', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey')
        controller.resolve_wild_card_pin(f'{if3.get_node_path()}.Result', 'float', 'None')
        ...
        graph.add_link('Entry', 'shape_rotate', vetala_lib_control, 'rotate', controller)
        graph.add_link('Entry', 'shape_scale', vetala_lib_control, 'scale', controller)
        graph.add_link(multiply1, 'Result', vetala_lib_control, 'scale_offset', controller)
        graph.add_link(vetala_lib_control, 'Control', set_default_parent, 'Parent', controller)
        ...
        graph.add_link(if2, 'Result', multiply1, 'A', controller)
        graph.add_link(from_string1, 'Result', spawn_null3, 'Name', controller)
        ...
        graph.add_link(spawn_bool_animation_channel, 'ExecutePin', spawn_bool_animation_channel1, 'ExecutePin', controller)
        graph.add_link(at1, 'Element', spawn_bool_animation_channel, 'Parent', controller)
        graph.add_link(get_local_controls1, 'Value', at1, 'Array', controller)
        graph.add_link(at1, 'Element', spawn_bool_animation_channel1, 'Parent', controller)
        graph.add_link(at1, 'Element', spawn_bool_animation_channel2, 'Parent', controller)
        graph.add_link(spawn_bool_animation_channel1, 'ExecutePin', spawn_bool_animation_channel2, 'ExecutePin', controller)
        graph.add_link(if3, 'Result', multiply1, 'B', controller)
        ...
        graph.set_pin(spawn_bool_animation_channel, 'MaximumValue', 'True', controller)
        graph.set_pin(at1, 'Index', '0', controller)
        graph.set_pin(spawn_bool_animation_channel1, 'Name', 'IK Visibility', controller)
        graph.set_pin(spawn_bool_animation_channel1, 'InitialValue', 'true', controller)
        graph.set_pin(spawn_bool_animation_channel1, 'MinimumValue', 'False', controller)
        graph.set_pin(spawn_bool_animation_channel1, 'MaximumValue', 'True', controller)
        graph.set_pin(spawn_bool_animation_channel2, 'Name', 'Enable', controller)
        graph.set_pin(spawn_bool_animation_channel2, 'InitialValue', 'true', controller)
        graph.set_pin(spawn_bool_animation_channel2, 'MinimumValue', 'False', controller)
        graph.set_pin(spawn_bool_animation_channel2, 'MaximumValue', 'True', controller)
        graph.set_pin(if3, 'True', '1.500000', controller)
    ...
    def _build_function_forward_graph(self, controller):
        ...
        controller.add_local_variable_from_object_path('fkvis', 'bool', '', '')
        controller.add_local_variable_from_object_path('ikvis', 'bool', '', '')
        controller.add_local_variable_from_object_path('enable_setup', 'bool', '', '')

        controller.add_local_variable_from_object_path('aims', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', '')
        controller.add_local_variable_from_object_path('aim_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', '')

        controller.add_local_variable('start_curl', cpp_type='double', cpp_type_object=None, default_value="False")
        controller.add_local_variable('end_curl', cpp_type='double', cpp_type_object=None, default_value="False")
        controller.add_local_variable('start_twist', cpp_type='double', cpp_type_object=None, default_value="False")
        controller.add_local_variable('end_twist', cpp_type='double', cpp_type_object=None, default_value="False")
        controller.add_local_variable('ratio_value', cpp_type='double', cpp_type_object=None, default_value="False")
        controller.add_local_variable_from_object_path('top_bones', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', '')

        get_joints = controller.add_variable_node_from_object_path('joints', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(756.0, 908.0), 'Get joints')
        num = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetNum(in Array,out Num)', unreal.Vector2D(1084.0, 912.0), 'Num')
        greater = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntGreater', 'Execute', unreal.Vector2D(1276.0, 896.0), 'Greater')
        branch = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(1248.0, 1104.0), 'Branch')
        vetala_lib_get_tops = controller.add_function_reference_node(library.find_function('vetalaLib_GetTops'), unreal.Vector2D(1340.0, 1488.0), 'vetalaLib_GetTops')
        get_item_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(9264.0, 2560.0), 'Get Item Metadata')
        vetala_lib_find_bone_aim_axis = controller.add_function_reference_node(library.find_function('vetalaLib_findBoneAimAxis'), unreal.Vector2D(9568.0, 2240.0), 'vetalaLib_findBoneAimAxis')
        branch1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(10000.0, 2176.0), 'Branch')
        get_item_array_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(9264.0, 2800.0), 'Get Item Array Metadata')
        and1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathBoolAnd', 'Execute', unreal.Vector2D(9760.0, 2432.0), 'And')
        aim_constraint = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_AimConstraintLocalSpaceOffset', 'Execute', unreal.Vector2D(11408.0, 2160.0), 'Aim Constraint')
        get_item_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(10976.0, 1744.0), 'Get Item Metadata')
        spline_from_items = controller.add_external_function_reference_node('/ControlRigSpline/SplineFunctionLibrary/SplineFunctionLibrary.SplineFunctionLibrary_C', 'SplineFromItems', unreal.Vector2D(5664.0, 1344.0), 'SplineFromItems')
        draw_spline = controller.add_unit_node_from_struct_path('/Script/ControlRigSpline.RigUnit_DrawControlRigSpline', 'Execute', unreal.Vector2D(6880.0, 848.0), 'Draw Spline')
        position_from_spline = controller.add_unit_node_from_struct_path('/Script/ControlRigSpline.RigUnit_PositionFromControlRigSpline', 'Execute', unreal.Vector2D(7824.0, 1584.0), 'Position From Spline')
        get_item_array_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(1200.0, 2304.0), 'Get Item Array Metadata')
        and2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathBoolAnd', 'Execute', unreal.Vector2D(2640.0, 1856.0), 'And')
        set_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(8416.0, 1776.0), 'Set Transform')
        make_transform = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathTransformMake', 'Execute', unreal.Vector2D(8096.0, 1568.0), 'Make Transform')
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(10224.0, 1904.0), 'vetalaLib_GetItem')
        for_each = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayIterator(in Array,out Element,out Index,out Count,out Ratio)', unreal.Vector2D(11984.0, 2960.0), 'For Each')
        get_item_metadata2 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(12304.0, 2736.0), 'Get Item Metadata')
        set_transform1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(12752.0, 2960.0), 'Set Transform')
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(12256.0, 3200.0), 'Get Transform')
        vetala_lib_get_item1 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(1904.0, 2464.0), 'vetalaLib_GetItem')
        multiply = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleMul', 'Execute', unreal.Vector2D(10085.0, 4476.0), 'Multiply')
        multiply1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleMul', 'Execute', unreal.Vector2D(10357.0, 5260.0), 'Multiply')
        greater1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntGreater', 'Execute', unreal.Vector2D(12272.0, 3504.0), 'Greater')
        branch2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(13136.0, 2912.0), 'Branch')
        set_rotation = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetRotation', 'Execute', unreal.Vector2D(13744.0, 2928.0), 'Set Rotation')
        from_axis_and_angle = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionFromAxisAndAngle', 'Execute', unreal.Vector2D(12117.0, 4540.0), 'From Axis And Angle')
        get_item_metadata3 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(12976.0, 3328.0), 'Get Item Metadata')
        get_float_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(3289.0, 1824.0), 'Get Float Channel')
        get_float_channel1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(3289.0, 2912.0), 'Get Float Channel')
        vetala_lib_get_item2 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(1884.0, 2848.0), 'vetalaLib_GetItem')
        get_float_channel2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(3289.0, 2272.0), 'Get Float Channel')
        multiply2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleMul', 'Execute', unreal.Vector2D(10085.0, 4796.0), 'Multiply')
        subtract = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleSub', 'Execute', unreal.Vector2D(9733.0, 4364.0), 'Subtract')
        add = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleAdd', 'Execute', unreal.Vector2D(11381.0, 4572.0), 'Add')
        cross = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorCross', 'Execute', unreal.Vector2D(11125.0, 4124.0), 'Cross')
        get_float_channel3 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(3289.0, 2576.0), 'Get Float Channel')
        multiply3 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleMul', 'Execute', unreal.Vector2D(10357.0, 5084.0), 'Multiply')
        subtract1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleSub', 'Execute', unreal.Vector2D(9653.0, 4924.0), 'Subtract')
        add1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleAdd', 'Execute', unreal.Vector2D(11461.0, 5388.0), 'Add')
        from_axis_and_angle1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionFromAxisAndAngle', 'Execute', unreal.Vector2D(12224.0, 5360.0), 'From Axis And Angle')
        multiply4 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionMul', 'Execute', unreal.Vector2D(12480.0, 4928.0), 'Multiply')
        get_curl_axis = controller.add_variable_node_from_object_path('curl_axis', 'TArray<FVector>', '/Script/CoreUObject.Vector', True, '()', unreal.Vector2D(10453.0, 4204.0), 'Get curl_axis')
        vetala_lib_get_item_vector = controller.add_function_reference_node(library.find_function('vetalaLib_GetItemVector'), unreal.Vector2D(10805.0, 4220.0), 'vetalaLib_GetItemVector')
        get_top_parents = controller.add_variable_node_from_object_path('top_parents', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(9883.0, 868.0), 'Get top_parents')
        num1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetNum(in Array,out Num)', unreal.Vector2D(9960.0, 1097.0), 'Num')
        greater2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntGreater', 'Execute', unreal.Vector2D(10192.0, 1152.0), 'Greater')
        branch3 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(10592.0, 2096.0), 'Branch')
        spline_from_items1 = controller.add_external_function_reference_node('/ControlRigSpline/SplineFunctionLibrary/SplineFunctionLibrary.SplineFunctionLibrary_C', 'SplineFromItems', unreal.Vector2D(10384.0, 784.0), 'SplineFromItems')
        position_from_spline1 = controller.add_unit_node_from_struct_path('/Script/ControlRigSpline.RigUnit_PositionFromControlRigSpline', 'Execute', unreal.Vector2D(11328.0, 576.0), 'Position From Spline')
        make_transform1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathTransformMake', 'Execute', unreal.Vector2D(11568.0, 592.0), 'Make Transform')
        set_transform2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(11835.0, 788.0), 'Set Transform')
        subtract2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleSub', 'Execute', unreal.Vector2D(10144.0, 640.0), 'Subtract')
        get_item_metadata4 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(10965.0, 1980.0), 'Get Item Metadata')
        get_item_metadata5 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(11216.0, 1392.0), 'Get Item Metadata')
        parent_constraint = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ParentConstraint', 'Execute', unreal.Vector2D(12240.0, 800.0), 'Parent Constraint')
        interpolate = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathTransformLerp', 'Execute', unreal.Vector2D(11328.0, 752.0), 'Interpolate')
        at = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(10960.0, 944.0), 'At')
        at1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(10960.0, 1088.0), 'At')
        absolute = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorAbs', 'Execute', unreal.Vector2D(11365.0, 4236.0), 'Absolute')
        parent_constraint1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ParentConstraint', 'Execute', unreal.Vector2D(12768.0, 832.0), 'Parent Constraint')
        set_control_visibility = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetControlVisibility', 'Execute', unreal.Vector2D(13776.0, 3296.0), 'Set Control Visibility')
        set_control_visibility1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetControlVisibility', 'Execute', unreal.Vector2D(8096.0, 3264.0), 'Set Control Visibility')
        for_loop = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ForLoopCount', 'Execute', unreal.Vector2D(7488.0, 3504.0), 'For Loop')
        add2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntAdd', 'Execute', unreal.Vector2D(7552.0, 3296.0), 'Add')
        at2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(7744.0, 3104.0), 'At')
        get_item_array_metadata2 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(1200.0, 2112.0), 'Get Item Array Metadata')
        vetala_lib_get_item3 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(748.0, 2176.0), 'vetalaLib_GetItem')
        branch4 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(6320.0, 1536.0), 'Branch')
        branch5 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(7360.0, 1904.0), 'Branch')
        set_aim_controls = controller.add_variable_node_from_object_path('aim_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', False, '()', unreal.Vector2D(1884.0, 1472.0), 'Set aim_controls')
        set_start_curl = controller.add_variable_node('start_curl', 'double', None, False, '', unreal.Vector2D(3712.0, 1632.0), 'Set start_curl')
        set_end_curl = controller.add_variable_node('end_curl', 'double', None, False, '', unreal.Vector2D(3664.0, 2240.0), 'Set end_curl')
        set_start_twist = controller.add_variable_node('start_twist', 'double', None, False, '', unreal.Vector2D(3661.0, 2562.0), 'Set start_twist')
        set_end_twist = controller.add_variable_node('end_twist', 'double', None, False, '', unreal.Vector2D(3664.0, 2951.0), 'Set end_twist')
        get_start_curl = controller.add_variable_node('start_curl', 'double', None, True, '', unreal.Vector2D(9829.0, 4508.0), 'Get start_curl')
        get_end_curl = controller.add_variable_node('end_curl', 'double', None, True, '', unreal.Vector2D(9893.0, 4764.0), 'Get end_curl')
        get_start_twist = controller.add_variable_node('start_twist', 'double', None, True, '', unreal.Vector2D(9877.0, 5068.0), 'Get start_twist')
        get_end_twist = controller.add_variable_node('end_twist', 'double', None, True, '', unreal.Vector2D(9893.0, 5308.0), 'Get end_twist')
        get_ratio_value = controller.add_variable_node('ratio_value', 'double', None, True, '', unreal.Vector2D(8576.0, 4816.0), 'Get ratio_value')
        set_top_bones = controller.add_variable_node_from_object_path('top_bones', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', False, '()', unreal.Vector2D(1632.0, 1472.0), 'Set top_bones')
        get_aim_controls = controller.add_variable_node_from_object_path('aim_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(7328.0, 3136.0), 'Get aim_controls')
        get_aim_controls1 = controller.add_variable_node_from_object_path('aim_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(5017.0, 1714.0), 'Get aim_controls')
        get_top_bones = controller.add_variable_node_from_object_path('top_bones', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(8272.0, 2464.0), 'Get top_bones')
        set_ikvis = controller.add_variable_node('ikvis', 'bool', None, False, '', unreal.Vector2D(3664.0, 3344.0), 'Set ikvis')
        set_fkvis = controller.add_variable_node('fkvis', 'bool', None, False, '', unreal.Vector2D(3664.0, 4000.0), 'Set fkvis')
        get_ikvis = controller.add_variable_node('ikvis', 'bool', None, True, '', unreal.Vector2D(5872.0, 1696.0), 'Get ikvis')
        get_enable_setup = controller.add_variable_node('enable_setup', 'bool', None, True, '', unreal.Vector2D(6848.0, 2000.0), 'Get enable_setup')
        get_ikvis1 = controller.add_variable_node('ikvis', 'bool', None, True, '', unreal.Vector2D(7802.0, 3695.0), 'Get ikvis')
        get_fkvis = controller.add_variable_node('fkvis', 'bool', None, True, '', unreal.Vector2D(13600.0, 3488.0), 'Get fkvis')
        set_enable_setup = controller.add_variable_node('enable_setup', 'bool', None, False, '', unreal.Vector2D(3664.0, 3600.0), 'Set enable_setup')
        branch6 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(3072.0, 1472.0), 'Branch')
        get_bool_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetBoolAnimationChannel', 'Execute', unreal.Vector2D(3216.0, 3296.0), 'Get Bool Channel')
        get_bool_channel1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetBoolAnimationChannel', 'Execute', unreal.Vector2D(3200.0, 4016.0), 'Get Bool Channel')
        get_bool_channel2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetBoolAnimationChannel', 'Execute', unreal.Vector2D(3232.0, 3680.0), 'Get Bool Channel')
        set_aims = controller.add_variable_node_from_object_path('aims', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', False, '()', unreal.Vector2D(2224.0, 1472.0), 'Set aims')
        get_aims = controller.add_variable_node_from_object_path('aims', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(7728.0, 2256.0), 'Get aims')
        draw_transform = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_DebugTransformMutableNoSpace', 'Execute', unreal.Vector2D(8960.0, 1712.0), 'Draw Transform')
        from_string = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(3065.96240234375, 2226.025146484375), 'From String')
        from_string1 = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(3098.554931640625, 2768.74072265625), 'From String')
        from_string2 = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(3008.0, 3456.0), 'From String')
        from_string3 = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(2960.0, 3824.0), 'From String')
        from_string4 = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(2939.54296875, 4187.01171875), 'From String')
        for_each1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayIterator(in Array,out Element,out Index,out Count,out Ratio)', unreal.Vector2D(7968.0, 2112.0), 'For Each')
        for_each2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayIterator(in Array,out Element,out Index,out Count,out Ratio)', unreal.Vector2D(8720.0, 2112.0), 'For Each')
        set_ratio_value = controller.add_variable_node('ratio_value', 'double', None, False, '', unreal.Vector2D(9184.0, 2224.0), 'Set ratio_value')
        ...
        controller.resolve_wild_card_pin(f'{add2.get_node_path()}.Result', 'int32', 'None')
        controller.resolve_wild_card_pin(f'{at2.get_node_path()}.Array', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey')
        controller.resolve_wild_card_pin(f'{for_each1.get_node_path()}.Array', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey')
        controller.resolve_wild_card_pin(f'{for_each2.get_node_path()}.Array', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey')
        ...
        graph.add_link('Start Execute Node', 'True', branch, 'ExecuteContext', controller)
        graph.add_link(branch, 'True', vetala_lib_get_tops, 'ExecuteContext', controller)
        graph.add_link(vetala_lib_get_tops, 'ExecuteContext', set_top_bones, 'ExecuteContext', controller)
        graph.add_link(set_ratio_value, 'ExecuteContext', vetala_lib_find_bone_aim_axis, 'ExecuteContext', controller)
        graph.add_link(vetala_lib_find_bone_aim_axis, 'ExecuteContext', branch1, 'ExecuteContext', controller)
        graph.add_link(branch1, 'True', branch3, 'ExecuteContext', controller)
        graph.add_link(aim_constraint, 'ExecutePin', for_each, 'ExecuteContext', controller)
        graph.add_link(set_fkvis, 'ExecuteContext', spline_from_items, 'ExecuteContext', controller)
        graph.add_link(spline_from_items, 'ExecuteContext', branch4, 'ExecuteContext', controller)
        graph.add_link(for_each1, 'ExecuteContext', set_transform, 'ExecutePin', controller)
        graph.add_link(for_each, 'ExecuteContext', set_transform1, 'ExecutePin', controller)
        graph.add_link(set_transform1, 'ExecutePin', branch2, 'ExecuteContext', controller)
        graph.add_link(branch3, 'True', spline_from_items1, 'ExecuteContext', controller)
        graph.add_link(spline_from_items1, 'ExecuteContext', set_transform2, 'ExecutePin', controller)
        graph.add_link(branch4, 'Completed', branch5, 'ExecuteContext', controller)
        graph.add_link(branch5, 'True', for_each1, 'ExecuteContext', controller)
        graph.add_link(set_top_bones, 'ExecuteContext', set_aim_controls, 'ExecuteContext', controller)
        graph.add_link(set_aim_controls, 'ExecuteContext', set_aims, 'ExecuteContext', controller)
        graph.add_link(branch6, 'True', set_start_curl, 'ExecuteContext', controller)
        graph.add_link(set_start_curl, 'ExecuteContext', set_end_curl, 'ExecuteContext', controller)
        graph.add_link(set_end_curl, 'ExecuteContext', set_start_twist, 'ExecuteContext', controller)
        graph.add_link(set_start_twist, 'ExecuteContext', set_end_twist, 'ExecuteContext', controller)
        graph.add_link(set_end_twist, 'ExecuteContext', set_ikvis, 'ExecuteContext', controller)
        graph.add_link(set_ikvis, 'ExecuteContext', set_enable_setup, 'ExecuteContext', controller)
        graph.add_link(set_enable_setup, 'ExecuteContext', set_fkvis, 'ExecuteContext', controller)
        graph.add_link(set_aims, 'ExecuteContext', branch6, 'ExecuteContext', controller)
        graph.add_link(for_each1, 'Completed', for_each2, 'ExecuteContext', controller)
        graph.add_link(for_each2, 'ExecuteContext', set_ratio_value, 'ExecuteContext', controller)
        graph.add_link(get_joints, 'Value', num, 'Array', controller)
        graph.add_link(get_joints, 'Value', vetala_lib_get_tops, 'bones', controller)
        graph.add_link(num, 'Num', 'Greater', 'A', controller)
        graph.add_link(num, 'Num', greater, 'A', controller)
        graph.add_link(greater, 'Result', branch, 'Condition', controller)
        graph.add_link(vetala_lib_get_tops, 'top_bones', vetala_lib_get_item3, 'Array', controller)
        graph.add_link(vetala_lib_get_tops, 'top_bones', set_top_bones, 'Value', controller)
        graph.add_link(for_each2, 'Element', get_item_metadata, 'Item', controller)
        graph.add_link(get_item_metadata, 'Found', and1, 'A', controller)
        graph.add_link(for_each2, 'Element', vetala_lib_find_bone_aim_axis, 'Bone', controller)
        ...
        graph.add_link(for_each2, 'Element', get_item_array_metadata, 'Item', controller)
        graph.add_link(get_item_array_metadata, 'Value', vetala_lib_get_item, 'Array', controller)
        graph.add_link(get_item_array_metadata, 'Value', for_each, 'Array', controller)
        graph.add_link(get_item_array_metadata, 'Found', and1, 'B', controller)
        graph.add_link(branch3, 'Completed', aim_constraint, 'ExecutePin', controller)
        ...
        graph.add_link(get_aim_controls1, 'Value', spline_from_items, 'Items', controller)
        graph.add_link(spline_from_items, 'Spline', draw_spline, 'Spline', controller)
        graph.add_link(spline_from_items, 'Spline', position_from_spline, 'Spline', controller)
        graph.add_link(branch4, 'True', draw_spline, 'ExecutePin', controller)
        graph.add_link(for_each1, 'Ratio', position_from_spline, 'U', controller)
        graph.add_link(position_from_spline, 'Position', make_transform, 'Translation', controller)
        graph.add_link(vetala_lib_get_item3, 'Element', get_item_array_metadata1, 'Item', controller)
        graph.add_link(get_item_array_metadata1, 'Value', set_aims, 'Value', controller)
        graph.add_link(get_item_array_metadata1, 'Found', and2, 'B', controller)
        graph.add_link(get_item_array_metadata2, 'Found', and2, 'A', controller)
        graph.add_link(and2, 'Result', branch6, 'Condition', controller)
        graph.add_link(set_transform, 'ExecutePin', draw_transform, 'ExecutePin', controller)
        ...
        graph.add_link(make_transform, 'Result', draw_transform, 'Transform', controller)
        graph.add_link(vetala_lib_get_item, 'Element', get_item_metadata4, 'Item', controller)
        graph.add_link(for_each, 'Element', get_item_metadata2, 'Item', controller)
        graph.add_link(for_each, 'Element', get_transform, 'Item', controller)
        graph.add_link(for_each, 'Element', get_item_metadata3, 'Item', controller)
        graph.add_link(for_each, 'Element', set_control_visibility, 'Item', controller)
        graph.add_link(for_each, 'Index', greater1, 'A', controller)
        graph.add_link(get_item_metadata2, 'Value', set_transform1, 'Item', controller)
        graph.add_link(get_transform, 'Transform', set_transform1, 'Value', controller)
        graph.add_link(get_item_array_metadata2, 'Value', vetala_lib_get_item1, 'Array', controller)
        graph.add_link(vetala_lib_get_item1, 'Element.Name', get_float_channel, 'Control', controller)
        graph.add_link(vetala_lib_get_item1, 'Element.Name', get_float_channel3, 'Control', controller)
        graph.add_link(vetala_lib_get_item1, 'Element.Name', get_bool_channel, 'Control', controller)
        graph.add_link(vetala_lib_get_item1, 'Element.Name', get_bool_channel1, 'Control', controller)
        graph.add_link(vetala_lib_get_item1, 'Element.Name', get_bool_channel2, 'Control', controller)
        graph.add_link(subtract, 'Result', multiply, 'A', controller)
        graph.add_link(get_start_curl, 'Value', multiply, 'B', controller)
        graph.add_link(multiply, 'Result', add, 'A', controller)
        graph.add_link(get_ratio_value, 'Value', multiply1, 'A', controller)
        graph.add_link(get_end_twist, 'Value', multiply1, 'B', controller)
        graph.add_link(multiply1, 'Result', add1, 'B', controller)
        graph.add_link(greater1, 'Result', branch2, 'Condition', controller)
        graph.add_link(branch2, 'True', set_rotation, 'ExecutePin', controller)
        graph.add_link(branch2, 'Completed', set_control_visibility, 'ExecutePin', controller)
        ...
        graph.add_link(get_float_channel, 'Value', set_start_curl, 'Value', controller)
        graph.add_link(vetala_lib_get_item2, 'Element.Name', get_float_channel1, 'Control', controller)
        graph.add_link(from_string1, 'Result', get_float_channel1, 'Channel', controller)
        graph.add_link(get_float_channel1, 'Value', set_end_twist, 'Value', controller)
        graph.add_link(get_item_array_metadata2, 'Value', vetala_lib_get_item2, 'Array', controller)
        graph.add_link(vetala_lib_get_item2, 'Element.Name', get_float_channel2, 'Control', controller)
        graph.add_link(from_string, 'Result', get_float_channel2, 'Channel', controller)
        graph.add_link(get_float_channel2, 'Value', set_end_curl, 'Value', controller)
        graph.add_link(get_end_curl, 'Value', multiply2, 'A', controller)
        graph.add_link(get_ratio_value, 'Value', multiply2, 'B', controller)
        graph.add_link(multiply2, 'Result', add, 'B', controller)
        graph.add_link(get_ratio_value, 'Value', subtract, 'B', controller)
        ...
        graph.add_link(from_string1, 'Result', get_float_channel3, 'Channel', controller)
        graph.add_link(get_float_channel3, 'Value', set_start_twist, 'Value', controller)
        graph.add_link(subtract1, 'Result', multiply3, 'A', controller)
        graph.add_link(get_start_twist, 'Value', multiply3, 'B', controller)
        graph.add_link(multiply3, 'Result', add1, 'A', controller)
        graph.add_link(get_ratio_value, 'Value', subtract1, 'B', controller)
        ...
        graph.add_link(num1, 'Num', 'Greater_2', 'A', controller)
        graph.add_link('Num_1', 'Num', greater2, 'A', controller)
        graph.add_link(greater2, 'Result', branch3, 'Condition', controller)
        graph.add_link(spline_from_items1, 'Spline', position_from_spline1, 'Spline', controller)
        graph.add_link(spline_from_items1, 'Transforms', at, 'Array', controller)
        ...
        graph.add_link(for_each2, 'Ratio', subtract2, 'B', controller)
        ...
        graph.add_link(for_each2, 'Element', get_item_metadata5, 'Item', controller)
        ...
        graph.add_link(get_fkvis, 'Value', set_control_visibility, 'bVisible', controller)
        graph.add_link(for_loop, 'ExecutePin', set_control_visibility1, 'ExecutePin', controller)
        graph.add_link(at2, 'Element', set_control_visibility1, 'Item', controller)
        graph.add_link(get_ikvis1, 'Value', set_control_visibility1, 'bVisible', controller)
        graph.add_link(branch5, 'Completed', for_loop, 'ExecutePin', controller)
        graph.add_link(for_loop, 'Index', add2, 'A', controller)
        graph.add_link(add2, 'Result', at2, 'Index', controller)
        graph.add_link(get_aim_controls, 'Value', at2, 'Array', controller)
        graph.add_link(vetala_lib_get_item3, 'Element', get_item_array_metadata2, 'Item', controller)
        graph.add_link(get_item_array_metadata2, 'Value', set_aim_controls, 'Value', controller)
        graph.add_link(get_ikvis, 'Value', branch4, 'Condition', controller)
        graph.add_link(get_enable_setup, 'Value', branch5, 'Condition', controller)
        graph.add_link(get_top_bones, 'Value', for_each2, 'Array', controller)
        graph.add_link(get_bool_channel, 'Value', set_ikvis, 'Value', controller)
        graph.add_link(get_bool_channel1, 'Value', set_fkvis, 'Value', controller)
        graph.add_link(get_bool_channel2, 'Value', set_enable_setup, 'Value', controller)
        graph.add_link(from_string2, 'Result', get_bool_channel, 'Channel', controller)
        graph.add_link(from_string4, 'Result', get_bool_channel1, 'Channel', controller)
        graph.add_link(from_string3, 'Result', get_bool_channel2, 'Channel', controller)
        graph.add_link(get_aims, 'Value', for_each1, 'Array', controller)
        graph.add_link(for_each2, 'Ratio', set_ratio_value, 'Value', controller)
        ...
        graph.set_pin(get_item_array_metadata, 'NameSpace', 'Self', controller)
        graph.set_pin(aim_constraint, 'bMaintainOffset', 'false', controller)
        graph.set_pin(aim_constraint, 'Filter', '(bX=True,bY=True,bZ=True)', controller)
        ...
        graph.set_pin(draw_spline, 'Detail', '16', controller)
        graph.set_pin(get_item_array_metadata1, 'Name', 'aims', controller)
        graph.set_pin(get_item_array_metadata1, 'NameSpace', 'Self', controller)
        graph.set_pin(set_transform, 'Space', 'GlobalSpace', controller)
        graph.set_pin(set_transform, 'bInitial', 'False', controller)
        graph.set_pin(set_transform, 'Weight', '1.000000', controller)
        ...
        graph.set_pin(add2, 'B', '1', controller)
        graph.set_pin(get_item_array_metadata2, 'Name', 'aim_controls', controller)
        graph.set_pin(get_item_array_metadata2, 'NameSpace', 'Self', controller)
        graph.set_pin(get_bool_channel, 'bInitial', 'False', controller)
        graph.set_pin(get_bool_channel1, 'bInitial', 'False', controller)
        graph.set_pin(get_bool_channel2, 'bInitial', 'False', controller)
        graph.set_pin(draw_transform, 'DebugDrawSettings', '(DepthPriority=SDPG_Foreground,Lifetime=-1.000000)', controller)
        graph.set_pin(draw_transform, 'Mode', 'Axes', controller)
        graph.set_pin(draw_transform, 'Color', '(R=1.000000,G=0.000000,B=0.000000,A=1.000000)', controller)
        graph.set_pin(draw_transform, 'Thickness', '0.000000', controller)
        graph.set_pin(draw_transform, 'Scale', '1.000000', controller)
        graph.set_pin(draw_transform, 'WorldOffset', '(Rotation=(X=0.000000,Y=0.000000,Z=0.000000,W=1.000000),Translation=(X=0.000000,Y=0.000000,Z=0.000000),Scale3D=(X=1.000000,Y=1.000000,Z=1.000000))', controller)
        graph.set_pin(draw_transform, 'bEnabled', 'false', controller)
        graph.set_pin(from_string, 'String', 'curl', controller)
        graph.set_pin(from_string1, 'String', 'twist', controller)
        graph.set_pin(from_string2, 'String', 'IK Visibility', controller)
        graph.set_pin(from_string3, 'String', 'Enable', controller)
