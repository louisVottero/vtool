...
class UnrealIkRig(UnrealUtilRig):
    ...
    def _build_controls(self, controller, library):
        ...
        set_item_metadata = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in NameSpace,in Value,out Success)', unreal.Vector2D(3000.0, -1900.0), 'Set Item Metadata')
        ...
        if4 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(5200.0, -800.0), 'If')
        get_item_array_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(4592.0, -944.0), 'Get Item Array Metadata')
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(5616.0, -688.0), 'vetalaLib_GetItem')
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(5568.0, -1024.0), 'Get Transform')
        ...
        num = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetNum(in Array,out Num)', unreal.Vector2D(4848.0, -944.0), 'Num')
        greater1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntGreater', 'Execute', unreal.Vector2D(5024.0, -944.0), 'Greater')
        ...
        set_item_array_metadata = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in NameSpace,in Value,out Success)', unreal.Vector2D(6768.0, -1616.0), 'Set Item Array Metadata')
        get_local_ik1 = controller.add_variable_node_from_object_path('local_ik', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(3696.0, -560.0), 'Get local_ik')
        spawn_bool_animation_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelBool', 'Execute', unreal.Vector2D(7296.0, -1616.0), 'Spawn Bool Animation Channel')
        spawn_float_animation_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelFloat', 'Execute', unreal.Vector2D(7280.0, -1328.0), 'Spawn Float Animation Channel')
        rig_element_key = controller.add_free_reroute_node('FRigElementKey', unreal.load_object(None, '/Script/ControlRig.RigElementKey').get_name(), is_constant=False, custom_widget_name='', default_value='', position=[6906.012803984808, -1219.2022628752848], node_name='', setup_undo_redo=True)
        spawn_float_animation_channel1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelFloat', 'Execute', unreal.Vector2D(7264.0, -960.0), 'Spawn Float Animation Channel')
        ...
        graph.add_link(spawn_bool_animation_channel, 'ExecuteContext', spawn_float_animation_channel, 'ExecuteContext', controller)
        graph.add_link(spawn_float_animation_channel, 'ExecuteContext', spawn_float_animation_channel1, 'ExecuteContext', controller)
        ...
        graph.add_link(at3, 'Element', rig_element_key, 'Value', controller)
        ...
        graph.set_pin(spawn_float_animation_channel, 'LimitsEnabled', '(Enabled=(bMinimum=false,bMaximum=false))', controller)
    ...
    def _build_function_forward_graph(self):
        ...
        at = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(656.0, 350.0), 'At')
        at1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(656.0, 550.0), 'At')
        at2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(656.0, 750.0), 'At')
        get_item_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(928.0, 464.0), 'Get Item Metadata')
        get_control_layer = controller.add_variable_node('control_layer', 'FName', None, True, '', unreal.Vector2D(600.0, 464.0), 'Get control_layer')
        basic_ik = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_TwoBoneIKSimplePerItem', 'Execute', unreal.Vector2D(3344.0, 272.0), 'Basic IK')
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(1672.0, 384.0), 'Get Transform')
        vetala_lib_find_bone_aim_axis = controller.add_function_reference_node(library.find_function('vetalaLib_findBoneAimAxis'), unreal.Vector2D(2544.0, 112.0), 'vetalaLib_findBoneAimAxis')
        draw_line = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_DebugLineNoSpace', 'Execute', unreal.Vector2D(3600.0, 480.0), 'Draw Line')
        get_transform1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(1312.0, 544.0), 'Get Transform')
        project_to_new_parent = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ProjectTransformToNewParent', 'Execute', unreal.Vector2D(1944.0, 768.0), 'Project to new Parent')
        vetala_lib_rig_layer_solve = controller.add_function_reference_node(library.find_function('vetalaLib_rigLayerSolve'), unreal.Vector2D(3952.0, 480.0), 'vetalaLib_rigLayerSolve')
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(1576.0, 912.0), 'vetalaLib_GetItem')
        get_item_array_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(1192.0, 896.0), 'Get Item Array Metadata')
        vetala_lib_ik_nudge_lock = controller.add_function_reference_node(library.find_function('vetalaLib_IK_NudgeLock'), unreal.Vector2D(2896.0, 256.0), 'vetalaLib_IK_NudgeLock')
        get_item_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(928.0, 176.0), 'Get Item Metadata')
        get_bool_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetBoolAnimationChannel', 'Execute', unreal.Vector2D(1536.0, 1056.0), 'Get Bool Channel')
        get_item_metadata2 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(560.0, 944.0), 'Get Item Metadata')
        get_short_name = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_Item', 'Execute', unreal.Vector2D(1164.7446138382322, 1144.8878615074805), 'Get Short Name')
        get_float_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(1536.0, 1216.0), 'Get Float Channel')

        get_short_name1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_Item', 'Execute', unreal.Vector2D(1152.0, 1280.0), 'Get Short Name')
        get_short_name2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_Item', 'Execute', unreal.Vector2D(1680.0, 224.0), 'Get Short Name')
        get_float_channel1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(2096.0, 240.0), 'Get Float Channel')
        get_item_metadata3 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(528.0, 1216.0), 'Get Item Metadata')
        if1 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(928.1085129829368, 1307.616135881219), 'If')
        ...
        graph.add_link(vetala_lib_ik_nudge_lock, 'ExecuteContext', basic_ik, 'ExecuteContext', controller)
        ...
        graph.add_link(get_item_metadata, 'Value', get_short_name2, 'Item', controller)
        ...
        graph.add_link(get_short_name, 'Item.Name', get_bool_channel, 'Control', controller)
        ...
        graph.add_link(if1, 'Result', get_short_name, 'Item', controller)
        graph.add_link(get_short_name1, 'Item.Name', get_float_channel, 'Control', controller)
        graph.add_link(if1, 'Result', get_short_name1, 'Item', controller)
        graph.add_link(get_short_name2, 'Item.Name', get_float_channel1, 'Control', controller)
