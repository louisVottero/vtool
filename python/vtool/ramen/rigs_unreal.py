...
class UnrealFootRollRig(UnrealUtilRig):
    ...
    def _build_function_construct_graph(self):
        ...
        vetala_lib_get_item_vector2 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItemVector'), unreal.Vector2D(1760.0, -960.0), 'vetalaLib_GetItemVector')
        ...
        get_transform2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(6300, -1250.0), 'Get Transform')
        set_transform2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(6800, -1500.0), 'Set Transform')
        ...
        graph.add_link(add, 'ExecuteContext', set_transform2, 'ExecuteContext', controller)
        graph.add_link(set_transform2, 'ExecuteContext', set_item_metadata, 'ExecuteContext', controller)

        graph.add_link(vetala_lib_control2, 'Last Control', set_transform2, 'Item', controller)
