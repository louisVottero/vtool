...
class UnrealFootRollRig(UnrealUtilRig):
    ...
    def _build_function_construct_graph(self):
        ...
        vetala_lib_control = self._create_control(controller, 5424.0, -2016.0)
        vetala_lib_get_parent = controller.add_function_reference_node(library.find_function('vetalaLib_GetParent'), unreal.Vector2D(448.0, -1920.0), 'vetalaLib_GetParent')
        set_item_metadata = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in Value,out Success)', unreal.Vector2D(7664.0, -2000.0), 'Set Item Metadata')
        get_control_layer = controller.add_variable_node('control_layer', 'FName', None, True, '', unreal.Vector2D(208.0, -1680.0), 'Get control_layer')
        get_description = controller.add_variable_node('description', 'FString', None, True, '', unreal.Vector2D(4704.0, -1568.0), 'Get description')
        add = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayAdd(io Array,in Element,out Index)', unreal.Vector2D(6448.0, -2016.0), 'Add')
        get_local_controls = controller.add_variable_node_from_object_path('local_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(5984.0, -2416.0), 'Get local_controls')
        spawn_null = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddNull', 'Execute', unreal.Vector2D(864.0, -2016.0), 'Spawn Null')
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(656.0, -1568.0), 'Get Transform')
        branch = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(-496.0, -2064.0), 'Branch')
        num = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetNum(in Array,out Num)', unreal.Vector2D(-16.0, -1392.0), 'Num')
        equals = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(208.0, -1376.0), 'Equals')
        get_joints = controller.add_variable_node_from_object_path('joints', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(288.0, -2272.0), 'Get joints')
        at = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(5248.0, -2240.0), 'At')
        at1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(576.0, -2272.0), 'At')
        vetala_lib_control1 = self._create_control(controller, 3072.0, -2032.0)
        add1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayAdd(io Array,in Element,out Index)', unreal.Vector2D(3808.0, -2032.0), 'Add')
        at2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(2288.0, -2240.0), 'At')
        make_array = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayMake(in Values,out Array)', unreal.Vector2D(2144.0, -1552.0), 'Make Array')
        get_transform1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(1712.0, -1648.0), 'Get Transform')
        get_heel_pivot = controller.add_variable_node_from_object_path('heel_pivot', 'TArray<FVector>', '/Script/CoreUObject.Vector', True, '()', unreal.Vector2D(1104.0, -1248.0), 'Get heel_pivot')
        get_yaw_in_pivot = controller.add_variable_node_from_object_path('yaw_in_pivot', 'TArray<FVector>', '/Script/CoreUObject.Vector', True, '()', unreal.Vector2D(1104.0, -1056.0), 'Get yaw_in_pivot')
        get_yaw_out_pivot = controller.add_variable_node_from_object_path('yaw_out_pivot', 'TArray<FVector>', '/Script/CoreUObject.Vector', True, '()', unreal.Vector2D(1104.0, -1152.0), 'Get yaw_out_pivot')
        vetala_lib_get_item_vector = controller.add_function_reference_node(library.find_function('vetalaLib_GetItemVector'), unreal.Vector2D(1296.0, -1296.0), 'vetalaLib_GetItemVector')
        vetala_lib_get_item_vector1 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItemVector'), unreal.Vector2D(1312.0, -1152.0), 'vetalaLib_GetItemVector')
        vetala_lib_get_item_vector2 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItemVector'), unreal.Vector2D(1312.0, -992.0), 'vetalaLib_GetItemVector')
        for_each = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayIterator(in Array,out Element,out Index,out Count,out Ratio)', unreal.Vector2D(2400.0, -2016.0), 'For Each')
        make_array1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayMake(in Values,out Array)', unreal.Vector2D(2144.0, -944.0), 'Make Array')
        at3 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(2560.0, -1280.0), 'At')
        get_description1 = controller.add_variable_node('description', 'FString', None, True, '', unreal.Vector2D(2544.0, -1488.0), 'Get description')
        join = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_StringJoin', 'Execute', unreal.Vector2D(2784.0, -1472.0), 'Join')
        get_local_controls1 = controller.add_variable_node_from_object_path('local_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(2672.0, -2336.0), 'Get local_controls')
        at4 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(2880.0, -2336.0), 'At')
        set_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(3392.0, -2032.0), 'Set Transform')
        get_local_controls2 = controller.add_variable_node_from_object_path('local_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(3536.0, -2304.0), 'Get local_controls')
        join1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_StringJoin', 'Execute', unreal.Vector2D(5088.0, -1840.0), 'Join')
        add2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayAdd(io Array,in Element,out Index)', unreal.Vector2D(1376.0, -2016.0), 'Add')
        get_local_controls3 = controller.add_variable_node_from_object_path('local_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(1248.0, -2320.0), 'Get local_controls')
        get_local_controls4 = controller.add_variable_node_from_object_path('local_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(3920.0, -2304.0), 'Get local_controls')
        at5 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(4864.0, -2336.0), 'At')
        vetala_lib_control2 = self._create_control(controller, 6144.0, -2016.0)
        join2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_StringJoin', 'Execute', unreal.Vector2D(5920.0, -1776.0), 'Join')
        get_transform2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(6080.0, -1248.0), 'Get Transform')
        set_transform1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(6528.0, -1472.0), 'Set Transform')
        set_item_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in Value,out Success)', unreal.Vector2D(7680.0, -1808.0), 'Set Item Metadata')
        set_item_metadata2 = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in Value,out Success)', unreal.Vector2D(4544.0, -2096.0), 'Set Item Metadata')
        at6 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(4320.0, -2384.0), 'At')
        vetala_lib_get_item_vector3 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItemVector'), unreal.Vector2D(4944.0, -1120.0), 'vetalaLib_GetItemVector')
        get_shape_scale = controller.add_variable_node_from_object_path('shape_scale', 'TArray<FVector>', '/Script/CoreUObject.Vector', True, '()', unreal.Vector2D(4752.0, -1104.0), 'Get shape_scale')
        multiply = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorMul', 'Execute', unreal.Vector2D(5200.0, -1120.0), 'Multiply')
        make_array2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayMake(in Values,out Array)', unreal.Vector2D(5376.0, -1120.0), 'Make Array')
        vetala_lib_get_item_vector4 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItemVector'), unreal.Vector2D(2720.0, -1120.0), 'vetalaLib_GetItemVector')
        get_shape_scale1 = controller.add_variable_node_from_object_path('shape_scale', 'TArray<FVector>', '/Script/CoreUObject.Vector', True, '()', unreal.Vector2D(2528.0, -1104.0), 'Get shape_scale')
        multiply1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorMul', 'Execute', unreal.Vector2D(2976.0, -1120.0), 'Multiply')
        make_array3 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayMake(in Values,out Array)', unreal.Vector2D(3152.0, -1120.0), 'Make Array')
        get_ik = controller.add_variable_node_from_object_path('ik', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(7040.0, -1264.0), 'Get ik')
        get_joints1 = controller.add_variable_node_from_object_path('joints', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(7040.0, -1344.0), 'Get joints')
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(7232.0, -1392.0), 'vetalaLib_GetItem')
        set_item_array_metadata = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in Value,out Success)', unreal.Vector2D(7536.0, -1328.0), 'Set Item Array Metadata')
        add3 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayAdd(io Array,in Element,out Index)', unreal.Vector2D(6800.0, -2016.0), 'Add')
        vetala_lib_zero_out_transform = controller.add_function_reference_node(library.find_function('vetalaLib_ZeroOutTransform'), unreal.Vector2D(3632.0, -1632.0), 'vetalaLib_ZeroOutTransform')
        get_transform3 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(3744.0, -1856.0), 'Get Transform')
        draw_transform = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_DebugTransformMutableNoSpace', 'Execute', unreal.Vector2D(4288.0, -1696.0), 'Draw Transform')
        set_transform2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(4176.0, -1952.0), 'Set Transform')
        vetala_lib_zero_out_transform1 = controller.add_function_reference_node(library.find_function('vetalaLib_ZeroOutTransform'), unreal.Vector2D(4112.0, -2080.0), 'vetalaLib_ZeroOutTransform')
        ...
        graph.add_link(add, 'ExecuteContext', add3, 'ExecuteContext', controller)
        graph.add_link(add1, 'ExecuteContext', vetala_lib_zero_out_transform1, 'ExecuteContext', controller)
        graph.add_link(add2, 'ExecuteContext', for_each, 'ExecuteContext', controller)
        graph.add_link(add3, 'ExecuteContext', set_transform1, 'ExecuteContext', controller)
        graph.add_link(at, 'Element', get_transform2, 'Item', controller)
        graph.add_link(at, 'Element', set_item_metadata, 'Item', controller)
        graph.add_link(at, 'Element', set_item_metadata1, 'Item', controller)
        graph.add_link(at, 'Element', vetala_lib_control, 'driven', controller)
        graph.add_link(at1, 'Element', get_transform, 'Item', controller)
        graph.add_link(at1, 'Element', vetala_lib_get_parent, 'joint', controller)
        graph.add_link(at2, 'Element', get_transform1, 'Item', controller)
        graph.add_link(at2, 'Element', set_item_metadata2, 'Item', controller)
        graph.add_link(at4, 'Element', vetala_lib_control1, 'parent', controller)
        graph.add_link(at5, 'Element', vetala_lib_control, 'parent', controller)
        graph.add_link(at5, 'Element', vetala_lib_control2, 'parent', controller)
        graph.add_link(get_local_controls4, 'Value', at6, 'Array', controller)
        graph.add_link(at6, 'Element', set_item_metadata2, 'Value', controller)
        graph.add_link(branch, 'True', spawn_null, 'ExecuteContext', controller)
        ...
        graph.add_link(for_each, 'Element', set_transform, 'Value', controller)
        graph.add_link(for_each, 'ExecuteContext', vetala_lib_control1, 'ExecuteContext', controller)
        graph.add_link(for_each, 'Index', at3, 'Index', controller)
        graph.add_link(get_control_layer, 'Value', set_item_metadata, 'Name', controller)
        graph.add_link(get_control_layer, 'Value', set_item_metadata2, 'Name', controller)
        ...
        graph.add_link(get_joints, 'Value', at2, 'Array', controller)
        ...
        graph.add_link(get_local_controls1, 'Value', at4, 'Array', controller)
        graph.add_link(get_local_controls2, 'Value', 'Return', 'controls', controller)
        ...
        graph.add_link(get_local_controls4, 'Value', at5, 'Array', controller)
        ...
        graph.add_link(get_transform3, 'Transform', draw_transform, 'Transform', controller)
        graph.add_link(get_transform3, 'Transform', set_transform2, 'Value', controller)
        ...
        graph.add_link(at3, 'Element', join, 'Values.1', controller)
        graph.add_link(make_array1, 'Array', at3, 'Array', controller)
        ...
        graph.add_link(set_item_metadata2, 'ExecuteContext', vetala_lib_control, 'ExecuteContext', controller)
        graph.add_link(set_transform, 'ExecuteContext', add1, 'ExecuteContext', controller)
        graph.add_link(set_transform1, 'ExecuteContext', set_item_metadata, 'ExecuteContext', controller)
        graph.add_link(set_transform2, 'ExecuteContext', draw_transform, 'ExecuteContext', controller)
        graph.add_link(spawn_null, 'ExecuteContext', add2, 'ExecuteContext', controller)
        graph.add_link(spawn_null, 'Item', add2, 'Element', controller)
        graph.add_link(vetala_lib_control, 'ExecuteContext', vetala_lib_control2, 'ExecuteContext', controller)
        ...
        graph.add_link(vetala_lib_control1, 'ExecuteContext', set_transform, 'ExecuteContext', controller)
        graph.add_link(vetala_lib_control1, 'Last Control', add1, 'Element', controller)
        graph.add_link(vetala_lib_control1, 'Last Control', get_transform3, 'Item', controller)
        graph.add_link(vetala_lib_control1, 'Last Control', set_transform, 'Item', controller)
        graph.add_link(vetala_lib_control1, 'Last Control', set_transform2, 'Item', controller)
        graph.add_link(vetala_lib_control1, 'Last Control', vetala_lib_zero_out_transform, 'Argument', controller)
        graph.add_link(vetala_lib_control1, 'Last Control', vetala_lib_zero_out_transform1, 'Argument', controller)
        graph.add_link(vetala_lib_control2, 'ExecuteContext', add, 'ExecuteContext', controller)
        ...
        graph.add_link(vetala_lib_control2, 'Last Control', set_transform1, 'Item', controller)
        ...
        graph.add_link(vetala_lib_get_parent, 'Result', spawn_null, 'Parent', controller)
        ...
        graph.add_link(get_transform1, 'Transform.Rotation', make_array, 'Values.0.Rotation', controller)
        graph.add_link(get_transform1, 'Transform.Rotation', make_array, 'Values.1.Rotation', controller)
        graph.add_link(get_transform1, 'Transform.Rotation', make_array, 'Values.2.Rotation', controller)
        graph.add_link(get_transform1, 'Transform.Rotation', make_array, 'Values.3.Rotation', controller)
        graph.add_link(get_transform1, 'Transform.Translation', make_array, 'Values.0.Translation', controller)
        ...
        controller.set_pin_default_value(f'{n(spawn_null)}.Name', 'foot_roll_null_1', False)
        controller.set_pin_default_value(f'{n(spawn_null)}.Space', 'LocalSpace', False)
        ...
        controller.set_pin_default_value(f'{n(at)}.Index', '1', False)
        ...
        controller.set_pin_default_value(f'{n(at2)}.Index', '2', False)
        ...
        controller.set_pin_default_value(f'{n(at5)}.Index', '-1', False)
        ...
        controller.set_pin_default_value(f'{n(at6)}.Index', '1', False)
        ...
        controller.set_pin_default_value(f'{n(get_transform3)}.Space', 'GlobalSpace', False)
        controller.set_pin_default_value(f'{n(get_transform3)}.bInitial', 'False', False)
        controller.set_pin_default_value(f'{n(draw_transform)}.Mode', 'Axes', False)
        controller.set_pin_default_value(f'{n(draw_transform)}.Color', '(R=1.000000,G=0.000000,B=0.000000,A=1.000000)', False)
        controller.set_pin_default_value(f'{n(draw_transform)}.Thickness', '0.000000', False)
        controller.set_pin_default_value(f'{n(draw_transform)}.Scale', '1.000000', False)
        controller.set_pin_default_value(f'{n(draw_transform)}.WorldOffset', '(Rotation=(X=0.000000,Y=0.000000,Z=0.000000,W=1.000000),Translation=(X=0.000000,Y=0.000000,Z=0.000000),Scale3D=(X=1.000000,Y=1.000000,Z=1.000000))', False)
        controller.set_pin_default_value(f'{n(draw_transform)}.bEnabled', 'True', False)
    ...
    def _build_function_forward_graph(self):
        ...
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(2240.0, 560.0), 'vetalaLib_GetItem')
        get_control_layer = controller.add_variable_node('control_layer', 'FName', None, True, '', unreal.Vector2D(1792.0, 1952.0), 'Get control_layer')
        vetala_lib_get_item1 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(1936.0, 1392.0), 'vetalaLib_GetItem')
        get_item_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in Default,out Value,out Found)', unreal.Vector2D(2688.0, 560.0), 'Get Item Metadata')
        set_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(3568.0, 944.0), 'Set Transform')
        project_to_new_parent = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ProjectTransformToNewParent', 'Execute', unreal.Vector2D(3168.0, 560.0), 'Project to new Parent')
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(3238.0, 1584.0), 'Get Transform')
        vetala_lib_get_item2 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(2032.0, 2336.0), 'vetalaLib_GetItem')
        get_item_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in Default,out Value,out Found)', unreal.Vector2D(2432.0, 2032.0), 'Get Item Metadata')
        vetala_lib_get_item3 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(2016.0, 1600.0), 'vetalaLib_GetItem')
        basic_fabrik = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_FABRIKItemArray', 'Execute', unreal.Vector2D(4208.0, 2176.0), 'Basic FABRIK')
        make_array = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayMake(in Values,out Array)', unreal.Vector2D(3248.0, 2320.0), 'Make Array')
        basic_fabrik1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_FABRIKItemArray', 'Execute', unreal.Vector2D(3808.0, 1424.0), 'Basic FABRIK')
        make_array1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayMake(in Values,out Array)', unreal.Vector2D(3248.0, 1344.0), 'Make Array')
        get_item_metadata2 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in Default,out Value,out Found)', unreal.Vector2D(2400.0, 1792.0), 'Get Item Metadata')
        project_to_new_parent1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ProjectTransformToNewParent', 'Execute', unreal.Vector2D(3254.0, 1840.0), 'Project to new Parent')
        vetala_lib_get_item4 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(1520.0, 1012.0), 'vetalaLib_GetItem')
        item_exists = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ItemExists', 'Execute', unreal.Vector2D(2400.0, 1008.0), 'Item Exists')
        branch = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(2752.0, 944.0), 'Branch')
        vetala_lib_get_item5 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(2032.0, 1012.0), 'vetalaLib_GetItem')
        get_item_array_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in Default,out Value,out Found)', unreal.Vector2D(1744.0, 981.0), 'Get Item Array Metadata')
        ...
        graph.add_link('Entry', 'joints', vetala_lib_get_item4, 'Array', controller)
        ...
        graph.add_link(get_item_array_metadata, 'Value', vetala_lib_get_item5, 'Array', controller)
        ...
        graph.add_link(vetala_lib_get_item3, 'Element', get_item_metadata2, 'Item', controller)
        graph.add_link(vetala_lib_get_item4, 'Element', get_item_array_metadata, 'Item', controller)
        graph.add_link(vetala_lib_get_item5, 'Element', item_exists, 'Item', controller)
        graph.add_link(vetala_lib_get_item5, 'Element', project_to_new_parent, 'Child', controller)
        graph.add_link(vetala_lib_get_item5, 'Element', set_transform, 'Item', controller)
        graph.add_link(vetala_lib_get_item1, 'Element', make_array1, 'Values.0', controller)
        graph.add_link(vetala_lib_get_item2, 'Element', make_array, 'Values.1', controller)
        graph.add_link(vetala_lib_get_item3, 'Element', make_array, 'Values.0', controller)
        graph.add_link(vetala_lib_get_item3, 'Element', make_array1, 'Values.1', controller)

        controller.set_pin_default_value(f'{n(vetala_lib_get_item)}.index', '1', False)
        controller.set_pin_default_value(f'{n(vetala_lib_get_item1)}.index', '0', False)
        ...
        controller.set_pin_default_value(f'{n(get_transform)}.Space', 'GlobalSpace', False)
        controller.set_pin_default_value(f'{n(get_transform)}.bInitial', 'False', False)
        controller.set_pin_default_value(f'{n(vetala_lib_get_item2)}.index', '2', False)
