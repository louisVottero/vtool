...
class UnrealWheelRig(UnrealUtilRig):
    ...
    def _build_function_construct_graph(self, controller):
        ...
        vetala_lib_control = self._create_control(controller, 2650.0, -1900.0)
        vetala_lib_control1 = self._create_control(controller, 3050.0, -1400.0)
        get_joints = controller.add_variable_node_from_object_path('joints', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(2150.0, -1400.0), 'Get joints')
        num = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetNum(in Array,out Num)', unreal.Vector2D(1850.0, -1900.0), 'Num')
        equals = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(2050.0, -1900.0), 'Equals')
        branch = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(2250.0, -1900.0), 'Branch')
        at = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(1550.0, -850.0), 'At')
        add = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorAdd', 'Execute', unreal.Vector2D(1850.0, -850.0), 'Add')
        make_array = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayMake(in Values,out Array)', unreal.Vector2D(2050.0, -850.0), 'Make Array')
        equals1 = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(600.0, -1150.0), 'Equals')
        if1 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(750.0, -1150.0), 'If')
        equals2 = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(600.0, -1350.0), 'Equals')
        if2 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(750.0, -1350.0), 'If')
        join = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_StringJoin', 'Execute', unreal.Vector2D(600.0, -950.0), 'Join')
        get_parent = controller.add_variable_node_from_object_path('parent', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(2150.0, -1600.0), 'Get parent')
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(2350.0, -1600.0), 'vetalaLib_GetItem')
        vetala_lib_get_item1 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(2350.0, -1400.0), 'vetalaLib_GetItem')
        set_item_metadata = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in NameSpace,in Value,out Success)', unreal.Vector2D(3350.0, -1400.0), 'Set Item Metadata')
        spawn_float_animation_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelFloat', 'Execute', unreal.Vector2D(4048.0, -2160.0), 'Spawn Float Animation Channel')
        spawn_float_animation_channel1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelFloat', 'Execute', unreal.Vector2D(4048.0, -1904.0), 'Spawn Float Animation Channel')
        spawn_float_animation_channel2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelFloat', 'Execute', unreal.Vector2D(4048.0, -1648.0), 'Spawn Float Animation Channel')
        get_wheel_diameter = controller.add_variable_node('wheel_diameter', 'float', None, True, '', unreal.Vector2D(3350.0, -1200.0), 'Get wheel_diameter')
        get_steer_control = controller.add_variable_node_from_object_path('steer_control', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(3548.0, -736.0), 'Get steer_control')
        vetala_lib_get_item2 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(3798.0, -736.0), 'vetalaLib_GetItem')
        set_item_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in NameSpace,in Value,out Success)', unreal.Vector2D(4048.0, -736.0), 'Set Item Metadata')
        multiply = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleMul', 'Execute', unreal.Vector2D(2192.0, -1184.0), 'Multiply')
        multiply1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleMul', 'Execute', unreal.Vector2D(2576.0, -1184.0), 'Multiply')
        spawn_bool_animation_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyAddAnimationChannelBool', 'Execute', unreal.Vector2D(4048.0, -1392.0), 'Spawn Bool Animation Channel')
        ...
        graph.add_link(spawn_bool_animation_channel, 'ExecutePin', set_item_metadata1, 'ExecuteContext', controller)
        ...
        graph.set_pin(set_item_metadata1, 'NameSpace', 'Self', controller)
        graph.set_pin(multiply, 'B', '0.10000', controller)
    ...
    def _build_function_forward_graph(self, controller):
        ...
        get_joints = controller.add_variable_node_from_object_path('joints', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(600.0, 100.0), 'Get joints')
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(800.0, 100.0), 'vetalaLib_GetItem')
        get_item_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(1000.0, 100.0), 'Get Item Metadata')
        get_parent = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyGetParent', 'Execute', unreal.Vector2D(1300.0, 100.0), 'Get Parent')
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(2100.0, 600.0), 'Get Transform')
        set_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(2600.0, 400.0), 'Set Transform')
        vetala_lib_wheel_automate = controller.add_function_reference_node(library.find_function('vetalaLib_WheelAutomate'), unreal.Vector2D(2000.0, 100.0), 'vetalaLib_WheelAutomate')
        at = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(1800.0, 700.0), 'At')
        at1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(1800.0, 900.0), 'At')
        get_float_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(1296.0, 272.0), 'Get Float Channel')
        get_float_channel1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(1296.0, 432.0), 'Get Float Channel')
        get_float_channel2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetFloatAnimationChannel', 'Execute', unreal.Vector2D(1296.0, 592.0), 'Get Float Channel')
        get_item_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(900.0, 1100.0), 'Get Item Metadata')
        get_transform1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(1200.0, 1100.0), 'Get Transform')
        at2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(1200.0, 1400.0), 'At')
        to_euler = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionToEuler', 'Execute', unreal.Vector2D(1500.0, 1100.0), 'To Euler')
        if1 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(1900.0, 1300.0), 'If')
        multiply = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorMul', 'Execute', unreal.Vector2D(2100.0, 1100.0), 'Multiply')
        add = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleAdd', 'Execute', unreal.Vector2D(2300.0, 1100.0), 'Add')
        add1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleAdd', 'Execute', unreal.Vector2D(2500.0, 1100.0), 'Add')
        get_bool_channel = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetBoolAnimationChannel', 'Execute', unreal.Vector2D(1296.0, 752.0), 'Get Bool Channel')
        from_string = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(1008.0, 880.0), 'From String')
        ...
        graph.add_link(vetala_lib_wheel_automate, 'ExecuteContext', set_transform, 'ExecutePin', controller)
        graph.add_link('Start Execute Node', 'True', vetala_lib_wheel_automate, 'ExecuteContext', controller)
        ...
        graph.add_link(get_bool_channel, 'Value', vetala_lib_wheel_automate, 'slide_on_nearest', controller)
        ...
        graph.add_link(from_string, 'Result', get_bool_channel, 'Channel', controller)
        ...
        graph.set_pin(at, 'Index', '0', controller)
        graph.set_pin(at1, 'Index', '0', controller)
        graph.set_pin(get_float_channel, 'Channel', 'Enable', controller)
        graph.set_pin(get_float_channel, 'bInitial', 'False', controller)
        graph.set_pin(get_float_channel1, 'Channel', 'RotateMultiply', controller)
        graph.set_pin(get_float_channel1, 'bInitial', 'False', controller)
        graph.set_pin(get_float_channel2, 'Channel', 'Diameter', controller)
        ...
        graph.set_pin(get_bool_channel, 'bInitial', 'False', controller)
        graph.set_pin(from_string, 'String', 'SlideOnNearestMesh', controller)
