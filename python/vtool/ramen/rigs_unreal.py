...
class UnrealAimMultiAtCurveRig(UnrealUtilRig):
    ...
    def _build_function_backward_graph(self, controller):
        ...
        vetala_lib_get_tops = controller.add_function_reference_node(library.find_function('vetalaLib_GetTops'), unreal.Vector2D(1236.0, 756.0), 'vetalaLib_GetTops')
        get_joints = controller.add_variable_node_from_object_path('joints', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(916.0, 1060.0), 'Get joints')
        get_offset = controller.add_variable_node('offset', 'float', None, True, '', unreal.Vector2D(916.0, 1172.0), 'Get offset')
        reset = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayReset(io Array)', unreal.Vector2D(1476.0, 772.0), 'Reset')
        get_aims = controller.add_variable_node_from_object_path('aims', 'TArray<FTransform>', '/Script/CoreUObject.Transform', True, '()', unreal.Vector2D(1252.0, 948.0), 'Get aims')
        for_each = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayIterator(in Array,out Element,out Index,out Count,out Ratio)', unreal.Vector2D(1796.0, 676.0), 'For Each')
        multiply = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorMul', 'Execute', unreal.Vector2D(2308.0, 1300.0), 'Multiply')
        transform_location = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathTransformTransformVector', 'Execute', unreal.Vector2D(2596.0, 1252.0), 'Transform Location')
        vetala_lib_find_bone_aim_axis = controller.add_function_reference_node(library.find_function('vetalaLib_findBoneAimAxis'), unreal.Vector2D(2100.0, 660.0), 'vetalaLib_findBoneAimAxis')
        add = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayAdd(io Array,in Element,out Index)', unreal.Vector2D(2740.0, 676.0), 'Add')
        get_aims1 = controller.add_variable_node_from_object_path('aims', 'TArray<FTransform>', '/Script/CoreUObject.Transform', True, '()', unreal.Vector2D(2484.0, 756.0), 'Get aims')
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(1956.0, 980.0), 'Get Transform')
        spline_from_transforms = controller.add_unit_node_from_struct_path('/Script/ControlRigSpline.RigUnit_ControlRigSplineFromTransforms', 'Execute', unreal.Vector2D(2420.0, 1668.0), 'Spline From Transforms')
        get_aims2 = controller.add_variable_node_from_object_path('aims', 'TArray<FTransform>', '/Script/CoreUObject.Transform', True, '()', unreal.Vector2D(2149.0, 1794.0), 'Get aims')
        at = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(1268.0, 1684.0), 'At')
        replace = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_NameReplace', 'Execute', unreal.Vector2D(1252.0, 1844.0), 'Replace')
        get_control_layer = controller.add_variable_node('control_layer', 'FName', None, True, '', unreal.Vector2D(916.0, 2148.0), 'Get control_layer')
        get_item_array_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(1508.0, 1764.0), 'Get Item Array Metadata')
        for_each1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayIterator(in Array,out Element,out Index,out Count,out Ratio)', unreal.Vector2D(2176.0, 2128.0), 'For Each')
        position_from_spline = controller.add_unit_node_from_struct_path('/Script/ControlRigSpline.RigUnit_PositionFromControlRigSpline', 'Execute', unreal.Vector2D(2388.0, 2004.0), 'Position From Spline')
        set_translation = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTranslation', 'Execute', unreal.Vector2D(2708.0, 2100.0), 'Set Translation')
