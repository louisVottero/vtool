...
class UnrealFootRollRig(UnrealUtilRig):
    ...
    def _build_function_construct_graph(self):
        ...
        set_item_metadata = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in Value,out Success)', unreal.Vector(7232.0, 7232.0), 'Set Item Metadata')
        get_control_layer = controller.add_variable_node('control_layer', 'FName', 'None', False, '', unreal.Vector2D(208.0, -1680.0), 'Get control_layer')
        get_description = controller.add_variable_node('description', 'FString', 'None', False, '', unreal.Vector2D(4704.0, -1568.0), 'Get description')
        add = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayAdd(io Array,in Element,out Index)', unreal.Vector(6448.0, 6448.0), 'Add')
        get_local_controls = controller.add_variable_node('local_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', False, '', unreal.Vector2D(5984.0, -2416.0), 'Get local_controls')
        ...
        num = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetNum(in Array,out Num)', unreal.Vector(-16.0, -16.0), 'Num')

        equals = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector(208.0, 208.0), 'Equals')
        controller.set_pin_default_value(f'{n(equals)}.B', '3', False)

        get_joints = controller.add_variable_node('joints', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', False, '', unreal.Vector2D(288.0, -2272.0), 'Get joints')

        at = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector(5248.0, 5248.0), 'At')
        controller.set_pin_default_value(f'{n(at)}.Index', '1', False)

        at1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector(576.0, 576.0), 'At')
        ...
        add1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayAdd(io Array,in Element,out Index)', unreal.Vector(3808.0, 3808.0), 'Add')

        at2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector(2288.0, 2288.0), 'At')
        controller.set_pin_default_value(f'{n(at2)}.Index', '2', False)

        make_array = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayMake(in Values,out Array)', unreal.Vector(2128.0, 2128.0), 'Make Array')
        ...
        get_heel_pivot = controller.add_variable_node('heel_pivot', 'TArray<FVector>', '/Script/CoreUObject.Vector', False, '', unreal.Vector2D(1552.0, -1216.0), 'Get heel_pivot')
        get_yaw_in_pivot = controller.add_variable_node('yaw_in_pivot', 'TArray<FVector>', '/Script/CoreUObject.Vector', False, '', unreal.Vector2D(1552.0, -1024.0), 'Get yaw_in_pivot')
        get_yaw_out_pivot = controller.add_variable_node('yaw_out_pivot', 'TArray<FVector>', '/Script/CoreUObject.Vector', False, '', unreal.Vector2D(1552.0, -1120.0), 'Get yaw_out_pivot')
        vetala_lib_get_item_vector = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(1744.0, -1264.0), 'vetalaLib_GetItem')
        vetala_lib_get_item_vector1 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(1760.0, -1120.0), 'vetalaLib_GetItem')
        vetala_lib_get_item_vector2 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(1760.0, -960.0), 'vetalaLib_GetItem')
        for_each = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayIterator(in Array,out Element,out Index,out Count,out Ratio)', unreal.Vector(2400.0, 2400.0), 'For Each')

        make_array1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayMake(in Values,out Array)', unreal.Vector(2144.0, 2144.0), 'Make Array')
        controller.set_pin_default_value(f'{n(make_array1)}.Values', '("toe","heel","yaw_out","yaw_in")', False)

        at3 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector(2560.0, 2560.0), 'At')
        get_description1 = controller.add_variable_node('description', 'FString', 'None', False, '', unreal.Vector2D(2544.0, -1488.0), 'Get description')
        ...
        get_local_controls1 = controller.add_variable_node('local_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', False, '', unreal.Vector2D(2672.0, -2336.0), 'Get local_controls')

        at4 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector(2880.0, 2880.0), 'At')
        ...
        get_local_controls2 = controller.add_variable_node('local_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', False, '', unreal.Vector2D(3664.0, -2336.0), 'Get local_controls')
        ...
        add2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayAdd(io Array,in Element,out Index)', unreal.Vector(1376.0, 1376.0), 'Add')
        get_local_controls3 = controller.add_variable_node('local_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', False, '', unreal.Vector2D(1248.0, -2320.0), 'Get local_controls')
        get_local_controls4 = controller.add_variable_node('local_controls', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', False, '', unreal.Vector2D(4640.0, -2336.0), 'Get local_controls')

        at5 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector(4864.0, 4864.0), 'At')
        ...
        graph.add_link('DISPATCH_RigVMDispatch_SwitchInt32', '0', branch, 'ExecuteContext', controller)
        ...
        graph.add_link(at2, 'Element', get_transform1, 'Item', controller)
        graph.add_link(at3, 'Element', join, '1', controller)
        graph.add_link(at3, 'Element', join, '1', controller)
        ...
        graph.add_link(get_control_layer, 'Value', vetala_lib_get_parent, 'control_layer', controller)
        graph.add_link(get_description, 'Value', join1, '0', controller)
        graph.add_link(get_description, 'Value', join1, '0', controller)
        graph.add_link(get_description, 'Value', join2, '0', controller)
        graph.add_link(get_description, 'Value', join2, '0', controller)
        graph.add_link(get_description1, 'Value', join, '0', controller)
        graph.add_link(get_description1, 'Value', join, '0', controller)
        ...
        graph.add_link(get_transform, 'Transform', spawn_null, 'Transform', controller)
        graph.add_link(get_transform1, 'Rotation', make_array, 'Rotation', controller)
        graph.add_link(get_transform1, 'Rotation', make_array, 'Rotation', controller)
        graph.add_link(get_transform1, 'Translation', make_array, 'Translation', controller)
        graph.add_link(get_transform1, 'Translation', make_array, 'Translation', controller)
        ...
        graph.add_link(vetala_lib_control2, 'ExecuteContext', add, 'ExecuteContext', controller)
        graph.add_link(vetala_lib_get_item_vector, 'Element', make_array, 'Translation', controller)
        graph.add_link(vetala_lib_get_item_vector, 'Element', make_array, 'Translation', controller)
        graph.add_link(vetala_lib_get_item_vector1, 'Element', make_array, 'Translation', controller)
        graph.add_link(vetala_lib_get_item_vector1, 'Element', make_array, 'Translation', controller)
        graph.add_link(vetala_lib_get_item_vector2, 'Element', make_array, 'Translation', controller)
        graph.add_link(vetala_lib_get_item_vector2, 'Element', make_array, 'Translation', controller)
