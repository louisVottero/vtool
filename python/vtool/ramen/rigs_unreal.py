...
class UnrealAnchor(UnrealUtil):
    ...
    def _build_function_graph(self):
        ...
        set_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(3808.0, 2064.0), 'Set Transform')
        ...
        graph.add_link(switch4, 'Completed', return1, 'ExecuteContext', controller)
        graph.add_link('Entry', 'ExecuteContext', switch4, 'ExecuteContext', controller)
        graph.add_link(switch4, 'Cases.0', vetala_lib_string_to_index2, 'ExecuteContext', controller)
        graph.add_link(switch4, 'Cases.1', vetala_lib_string_to_index, 'ExecuteContext', controller)
        ...
        graph.add_link(for_each, 'Element', get_item_metadata, 'Item', controller)
        graph.add_link(for_each, 'Element', set_transform, 'Item', controller)
        graph.add_link(for_each, 'Completed', set_transform, 'ExecutePin', controller)
        ...
        graph.set_pin(get_transform1, 'Space', 'LocalSpace', controller)
        graph.set_pin(get_transform1, 'bInitial', 'False', controller)
        graph.set_pin(set_transform, 'Space', 'LocalSpace', controller)
...
class UnrealSwitch(UnrealUtil):
    ...
    def _build_function_graph(self):
        ...
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(-112.0, -704.0), 'vetalaLib_GetItem')
        ...
        vetala_lib_get_item1 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(496.0, 368.0), 'vetalaLib_GetItem')
        ...
        graph.add_link(vetala_lib_get_item, 'Element', vetala_lib_control, 'driven', controller)
        graph.add_link('Entry', 'description', vetala_lib_control, 'description', controller)
        graph.add_link('Entry', 'side', vetala_lib_control, 'side', controller)
        graph.add_link('Entry', 'restrain_numbering', vetala_lib_control, 'restrain_numbering', controller)
        graph.add_link('Entry', 'shape', vetala_lib_control, 'shape', controller)
        ...
        graph.add_link('Entry', 'joints', vetala_lib_get_item, 'Array', controller)
        graph.add_link(vetala_lib_get_item, 'Element', set_item_metadata, 'Item', controller)
