...
class UnrealFootRollRig(UnrealUtilRig):
    ...
    def _build_function_forward_graph(self):
        ...
        vetala_lib_get_item1 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(1152.0, 1968.0), 'vetalaLib_GetItem')
        basic_fabrik = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_FABRIKItemArray', 'Execute', unreal.Vector2D(3920.0, 1664.0), 'Basic FABRIK')
        ...
        basic_fabrik1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_FABRIKItemArray', 'Execute', unreal.Vector2D(3456.0, 1680.0), 'Basic FABRIK')
        make_array1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayMake(in Values,out Array)', unreal.Vector2D(2480.0, 1600.0), 'Make Array')
        ...
        vetala_lib_get_item2 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(816.0, 1584.0), 'vetalaLib_GetItem')
        ...
        vetala_lib_get_item3 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(1376.0, 1312.0), 'vetalaLib_GetItem')
        ...
        get_joints = controller.add_variable_node_from_object_path('joints', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(3456.0, 1280.0), 'Get joints')
        vetala_lib_get_item4 = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(3680.0, 1248.0), 'vetalaLib_GetItem_10')
        ...
        set_transform1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(2304.0, 1312.0), 'Set Transform')
        ...
        graph.add_link(vetala_lib_get_item1, 'Element', set_transform1, 'Item', controller)
        ...
        graph.add_link(set_transform1, 'ExecutePin', basic_fabrik1, 'ExecutePin', controller)
        ...
        graph.add_link(branch, 'Completed', set_transform1, 'ExecutePin', controller)
