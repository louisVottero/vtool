...
class VetalaLib(object):
    ...
    def OutputRigControls(self, controller, library):
        ...
        branch = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(2336.0, -336.0), 'Branch')
        ...
        branch1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(256.0, -304.0), 'Branch')
        ...
        get_layer_enabled = controller.add_variable_node('layer_enabled', 'bool', None, True, '', unreal.Vector2D(2992.0, -432.0), 'Get layer_enabled')
        ...
        graph.add_link(branch1, 'Completed', branch, 'ExecuteContext', controller)
        graph.add_link(branch, 'True', for_each1, 'ExecuteContext', controller)
        graph.add_link(branch1, 'True', set_item_array_metadata, 'ExecuteContext', controller)
