...
class VetalaLib(object):
    ...
    def OutputRigControls(self, controller, library):
        ...
        branch1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(2272.0, -416.0), 'Branch')
        ...
        equals = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(-240.0, -432.0), 'Equals')
        branch2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(112.0, -496.0), 'Branch')
        ...
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(-320.0, 400.0), 'vetalaLib_GetItem')
        ...
        join = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_StringJoin', 'Execute', unreal.Vector2D(624.0, -352.0), 'Join')
        to_string = controller.add_template_node('DISPATCH_RigDispatch_ToString(in Value,out Result)', unreal.Vector2D(368.0, -272.0), 'To String')
        from_string1 = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(864.0, -352.0), 'From String')
        ...
        graph.add_link(entry, 'layer', to_string, 'Value', controller)
        ...
        graph.add_link(not_equals, 'Result', branch1, 'Condition', controller)
        ...
        graph.add_link(from_string1, 'Result', set_item_array_metadata, 'Name', controller)
        graph.add_link(vetala_lib_get_item, 'Element', get_item_array_metadata, 'Item', controller)
        graph.add_link(from_string1, 'Result', get_item_array_metadata, 'Name', controller)
        ...
        graph.set_pin(join, 'Values', '("Controls","_")', controller)
        graph.set_pin(join, 'Separator', '_', controller)
    ...
    def rigLayerSolver(self, controller, library):
        ...
        branch = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(1552.0, 1312.0), 'Branch')
        not_equals = controller.add_template_node('DISPATCH_RigVMDispatch_CoreNotEquals(in A,in B,out Result)', unreal.Vector2D(1216.0, 1408.0), 'Not Equals')
        set_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(2352.0, 1312.0), 'Set Transform')
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(1008.0, 2000.0), 'Get Transform')
        for_loop = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ForLoopCount', 'Execute', unreal.Vector2D(880.0, 672.0), 'For Loop')
        concat1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_NameConcat', 'Execute', unreal.Vector2D(1504.0, 624.0), 'Concat')
        int_to_name1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntToName', 'Execute', unreal.Vector2D(1264.0, 672.0), 'Int to Name')
        ...
        get_item_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(2704.0, 976.0), 'Get Item Metadata')
        from_string1 = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(2352.0, 1040.0), 'From String')
        set_transform1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(3552.0, 1296.0), 'Set Transform')
        branch2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(3088.0, 1232.0), 'Branch')
