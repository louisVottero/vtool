...
class VetalaLib(object):
    ...
    def WheelAutomate(self, controller, library):
        ...
        multiply5 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionMul', 'Execute', unreal.Vector2D(1888.0, -416.0), 'Multiply')
        ...
        set_control_translation_offset = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetControlTranslationOffset', 'Execute', unreal.Vector2D(3632.0, 0.0), 'Set Control Translation Offset')
        sphere_trace_by_object_types = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SphereTraceByObjectTypes', 'Execute', unreal.Vector2D(2560.0, 384.0), 'Sphere Trace By Object Types')
        if1 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(3088.0, 240.0), 'If')
        multiply8 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleMul', 'Execute', unreal.Vector2D(2726.9111328125, 907.431884765625), 'Multiply')
        add = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorAdd', 'Execute', unreal.Vector2D(3072.0, 656.0), 'Add')
        and1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathBoolAnd', 'Execute', unreal.Vector2D(2864.0, 224.0), 'And')
