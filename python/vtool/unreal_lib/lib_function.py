...
class VetalaLib(object):
    ...
    def ConstrainTransform(self, controller, library):
        ...
        set_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(544.0, -16.0), 'Set Transform')
        multiply = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathTransformMul', 'Execute', unreal.Vector2D(800.0, 560.0), 'Multiply')
        get_relative_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetRelativeTransformForItem', 'Execute', unreal.Vector2D(208.0, 528.0), 'Get Relative Transform')
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(208.0, 816.0), 'Get Transform')
        ...
        graph.add_link(entry, 'SourceTransform', get_relative_transform, 'Parent', controller)
        ...
        graph.add_link(entry, 'TargetTransform', get_relative_transform, 'Child', controller)
        graph.add_link(multiply, 'Result', set_transform, 'Value', controller)
        graph.add_link(get_relative_transform, 'RelativeTransform', multiply, 'A', controller)
        ...
        graph.set_pin(get_relative_transform, 'bChildInitial', 'true', controller)
        graph.set_pin(get_relative_transform, 'bParentInitial', 'true', controller)
    ...
    def GetItem_PURE(self, controller, library):
        ...
        num = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetNum(in Array,out Num)', unreal.Vector2D(-48.0, -176.0), 'Num')
        greater = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntGreater', 'Execute', unreal.Vector2D(144.0, -192.0), 'Greater')
        at = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetAtIndex(in Array,in Index,out Element)', unreal.Vector2D(288.0, 304.0), 'At')
        item_exists = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ItemExists', 'Execute', unreal.Vector2D(720.0, -96.0), 'Item Exists')
        if1 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(1552.0, 224.0), 'If')
        if2 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(16.0, -32.0), 'If')
        ...
        controller.resolve_wild_card_pin(f'{if2.get_node_path()}.Result', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey')

        controller.set_array_pin_size(f'{n(if2)}.False', 1)

        graph.add_link(entry, 'Array', num, 'Array', controller)
        graph.add_link(entry, 'Array', if2, 'True', controller)
        ...
        graph.add_link(greater, 'Result', if2, 'Condition', controller)
        graph.add_link(if2, 'Result', at, 'Array', controller)
        graph.add_link(at, 'Element', item_exists, 'Item', controller)
        graph.add_link(at, 'Element', if1, 'True', controller)
        graph.add_link(item_exists, 'Exists', if1, 'Condition', controller)

        graph.set_pin(greater, 'B', '0', controller)
        graph.set_pin(if2, 'False', '((Type=None,Name="None"))', controller)
    ...
    def GetTops(self, controller, library):

        controller.add_local_variable_from_object_path('tops',
                                                       'TArray<FRigElementKey>',
                                                       '/Script/ControlRig.RigElementKey',
                                                       '')
        ...
        return1 = 'Return'
        controller.add_exposed_pin('top_bones', unreal.RigVMPinDirection.OUTPUT, 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', '()')
        get_parent = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_HierarchyGetParent', 'Execute', unreal.Vector2D(160.0, 16.0), 'Get Parent')
        for_each = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayIterator(in Array,out Element,out Index,out Count,out Ratio)', unreal.Vector2D(-96.0, -96.0), 'For Each')
        find = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayFind(in Array,in Element,out Index,out Success)', unreal.Vector2D(416.0, -144.0), 'Find')
        add = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayAdd(io Array,in Element,out Index)', unreal.Vector2D(1216.0, -704.0), 'Add')
        branch = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(816.0, -384.0), 'Branch')
        get_tops = controller.add_variable_node_from_object_path('tops', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(1024.0, -752.0), 'Get tops')
        get_tops1 = controller.add_variable_node_from_object_path('tops', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(944.0, 10.0), 'Get tops')
        item_exists = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ItemExists', 'Execute', unreal.Vector2D(112.0, -256.0), 'Item Exists')
        and1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathBoolAnd', 'Execute', unreal.Vector2D(608.0, -288.0), 'And')
        get_tops2 = controller.add_variable_node_from_object_path('tops', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', True, '()', unreal.Vector2D(-784.0, -304.0), 'Get tops')
        reset = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayReset(io Array)', unreal.Vector2D(-400.0, -144.0), 'Reset')
        ...
        graph.add_link(reset, 'ExecuteContext', for_each, 'ExecuteContext', controller)
        graph.add_link(for_each, 'ExecuteContext', branch, 'ExecuteContext', controller)
        graph.add_link(branch, 'False', add, 'ExecuteContext', controller)
        graph.add_link(entry, 'bones', find, 'Array', controller)
        graph.add_link(entry, 'bones', for_each, 'Array', controller)
        graph.add_link(get_tops1, 'Value', return1, 'top_bones', controller)
        graph.add_link(for_each, 'Element', get_parent, 'Child', controller)
        graph.add_link(get_parent, 'Parent', find, 'Element', controller)
        graph.add_link(for_each, 'Element', add, 'Element', controller)
        graph.add_link(for_each, 'Element', item_exists, 'Item', controller)
        graph.add_link(find, 'Success', and1, 'B', controller)
        graph.add_link(get_tops, 'Value', add, 'Array', controller)
        graph.add_link(and1, 'Result', branch, 'Condition', controller)
        graph.add_link(item_exists, 'Exists', and1, 'A', controller)
        graph.add_link(get_tops2, 'Value', reset, 'Array', controller)

        graph.set_pin(get_parent, 'bDefaultParent', 'True', controller)

    def OutputRigControls(self, controller, library):

        branch = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(3920.0, -688.0), 'Branch')
        entry = 'Entry'
        ...
        controller.add_exposed_pin('layer_enabled', unreal.RigVMPinDirection.INPUT, 'bool', 'None', '')
        controller.add_exposed_pin('control_visibility', unreal.RigVMPinDirection.INPUT, 'bool', 'None', 'true')
        return1 = 'Return'
        ...
        if1 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(1616.0, 368.0), 'If')
        add_tag = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetMetadataTag', 'Execute', unreal.Vector2D(1728.0, -880.0), 'Add Tag')
        for_each = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayIterator(in Array,out Element,out Index,out Count,out Ratio)', unreal.Vector2D(1392.0, -880.0), 'For Each')
        from_string = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(1440.0, -624.0), 'From String')
        set_control_visibility = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetControlVisibility', 'Execute', unreal.Vector2D(3200.0, -608.0), 'Set Control Visibility')
        num = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetNum(in Array,out Num)', unreal.Vector2D(1712.0, -32.0), 'Num')
        branch1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(2336.0, -336.0), 'Branch')
        not_equals = controller.add_template_node('DISPATCH_RigVMDispatch_CoreNotEquals(in A,in B,out Result)', unreal.Vector2D(1904.0, -64.0), 'Not Equals')
        for_each1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayIterator(in Array,out Element,out Index,out Count,out Ratio)', unreal.Vector2D(2704.0, -624.0), 'For Each')
        equals = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(-208.0, -368.0), 'Equals')
        branch2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(256.0, -304.0), 'Branch')
        set_item_array_metadata = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in NameSpace,in Value,out Success)', unreal.Vector2D(896.0, -880.0), 'Set Item Array Metadata')
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(464.0, -80.0), 'vetalaLib_GetItem')
        get_item_array_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(992.0, -448.0), 'Get Item Array Metadata')
        num1 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayGetNum(in Array,out Num)', unreal.Vector2D(352.0, 256.0), 'Num')
        greater = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntGreater', 'Execute', unreal.Vector2D(576.0, 240.0), 'Greater')
        and1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathBoolAnd', 'Execute', unreal.Vector2D(2080.0, -384.0), 'And')
        int_to_name = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntToName', 'Execute', unreal.Vector2D(48.0, -752.0), 'Int to Name')
        concat = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_NameConcat', 'Execute', unreal.Vector2D(272.0, -800.0), 'Concat')
        get_layer_enabled = controller.add_variable_node('layer_enabled', 'bool', None, True, '', unreal.Vector2D(3552.0, -176.0), 'Get layer_enabled')
        get_control_visibility = controller.add_variable_node('control_visibility', 'bool', None, True, '', unreal.Vector2D(1737.11865234375, -433.5523376464844), 'Get control_visibility')
        get_item_array_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(3536.0, -832.0), 'Get Item Array Metadata')
        set_control_visibility1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetControlVisibility', 'Execute', unreal.Vector2D(4512.0, -1056.0), 'Set Control Visibility')
        for_each2 = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayIterator(in Array,out Element,out Index,out Count,out Ratio)', unreal.Vector2D(4192.0, -1056.0), 'For Each')
        ...
        graph.add_link(set_control_visibility, 'ExecutePin', branch, 'ExecuteContext', controller)
        graph.add_link(branch, 'True', for_each2, 'ExecuteContext', controller)
        graph.add_link(entry, 'ExecuteContext', branch2, 'ExecuteContext', controller)
        graph.add_link(branch1, 'Completed', return1, 'ExecuteContext', controller)
        graph.add_link(for_each, 'ExecuteContext', add_tag, 'ExecutePin', controller)
        graph.add_link(set_item_array_metadata, 'ExecuteContext', for_each, 'ExecuteContext', controller)
        graph.add_link(for_each1, 'ExecuteContext', set_control_visibility, 'ExecutePin', controller)
        graph.add_link(branch2, 'Completed', branch1, 'ExecuteContext', controller)
        graph.add_link(branch1, 'True', for_each1, 'ExecuteContext', controller)
        graph.add_link(branch2, 'True', set_item_array_metadata, 'ExecuteContext', controller)
        graph.add_link(for_each2, 'ExecuteContext', set_control_visibility1, 'ExecutePin', controller)
        graph.add_link(get_item_array_metadata1, 'Found', branch, 'Condition', controller)
        graph.add_link(entry, 'uuid', from_string, 'String', controller)
        graph.add_link(entry, 'controls', if1, 'True', controller)
        graph.add_link(entry, 'controls', set_item_array_metadata, 'Value', controller)
        graph.add_link(entry, 'controls', num1, 'Array', controller)
        graph.add_link(entry, 'controls', for_each, 'Array', controller)
        graph.add_link(entry, 'joints', vetala_lib_get_item, 'Array', controller)
        graph.add_link(entry, 'mode', equals, 'A', controller)
        ...
        graph.add_link(get_item_array_metadata, 'Value', if1, 'False', controller)
        graph.add_link(if1, 'Result', num, 'Array', controller)
        graph.add_link(if1, 'Result', for_each1, 'Array', controller)
        graph.add_link(for_each, 'Element', add_tag, 'Item', controller)
        graph.add_link(from_string, 'Result', add_tag, 'Tag', controller)
        graph.add_link(for_each1, 'Element', set_control_visibility, 'Item', controller)
        graph.add_link(get_layer_enabled, 'Value', set_control_visibility, 'bVisible', controller)
        graph.add_link(num, 'Num', 'Not Equals', 'A', controller)
        graph.add_link(and1, 'Result', branch1, 'Condition', controller)
        graph.add_link(num, 'Num', not_equals, 'A', controller)
        graph.add_link(not_equals, 'Result', and1, 'B', controller)
        graph.add_link(for_each1, 'Element', get_item_array_metadata1, 'Item', controller)
        graph.add_link(equals, 'Result', branch2, 'Condition', controller)
        graph.add_link(vetala_lib_get_item, 'Element', set_item_array_metadata, 'Item', controller)
        graph.add_link(concat, 'Result', set_item_array_metadata, 'Name', controller)
        ...
        graph.add_link(num1, 'Num', 'Greater', 'A', controller)
        graph.add_link('Num_1', 'Num', greater, 'A', controller)
        graph.add_link(get_control_visibility, 'Value', and1, 'A', controller)
        graph.add_link(int_to_name, 'Result', concat, 'B', controller)
        graph.add_link(get_layer_enabled, 'Value', set_control_visibility1, 'bVisible', controller)
        graph.add_link(get_item_array_metadata1, 'Value', for_each2, 'Array', controller)
        graph.add_link(for_each2, 'Element', set_control_visibility1, 'Item', controller)
    ...
    def WheelAutomate(self, controller, library):
        ...
        return1 = 'Return'
        controller.add_exposed_pin('steerRotation', unreal.RigVMPinDirection.OUTPUT, 'FTransform', '/Script/CoreUObject.Transform', '(Rotation=(X=0.000000,Y=0.000000,Z=0.000000,W=1.000000),Translation=(X=0.000000,Y=0.000000,Z=0.000000),Scale3D=(X=1.000000,Y=1.000000,Z=1.000000))')
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(96.0, 48.0), 'Get Transform')
        inverse = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathTransformInverse', 'Execute', unreal.Vector2D(688.0, 320.0), 'Inverse')
        ...
        to_world = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ToWorldSpace_Transform', 'Execute', unreal.Vector2D(640.0, -160.0), 'To World')
        ...
        multiply1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleMul', 'Execute', unreal.Vector2D(0.0, 1312.0), 'Multiply')
        ...
        multiply4 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorMul', 'Execute', unreal.Vector2D(912.0, 1216.0), 'Multiply')
        ...
        cross = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorCross', 'Execute', unreal.Vector2D(-272.0, -336.0), 'Cross')
        ...
        multiply5 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionMul', 'Execute', unreal.Vector2D(2192.0, 112.0), 'Multiply')
        ...
        set_control_rotation_offset = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetControlRotationOffset', 'Execute', unreal.Vector2D(3216.0, -144.0), 'Set Control Rotation Offset')
        multiply7 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathQuaternionMul', 'Execute', unreal.Vector2D(2016.0, -640.0), 'Multiply')

        graph.add_link(entry,'ExecuteContext',set_control_rotation_offset,'ExecutePin',controller)
        graph.add_link(set_control_rotation_offset,'ExecutePin',return1,'ExecuteContext',controller)
        ...
        graph.add_link(multiply6,'Result',return1,'steerRotation.Rotation',controller)
        ...
        graph.set_pin(return1, 'steerRotation', '(Rotation=(X=0.000000,Y=0.000000,Z=0.000000,W=1.000000),Translation=(X=0.000000,Y=0.000000,Z=0.000000),Scale3D=(X=1.000000,Y=1.000000,Z=1.000000))', controller)
        graph.set_pin(get_transform, 'Space', 'GlobalSpace', controller)
        graph.set_pin(get_transform, 'bInitial', 'False', controller)
        graph.set_pin(get_transform1, 'Space', 'GlobalSpace', controller)
        graph.set_pin(get_transform1, 'bInitial', 'False', controller)
        ...
        graph.set_pin(to_world, 'Value', '(Rotation=(X=0.000000,Y=0.000000,Z=0.000000,W=1.000000),Translation=(X=0.000000,Y=0.000000,Z=0.000000),Scale3D=(X=1.000000,Y=1.000000,Z=1.000000))', controller)
        ...
        graph.set_pin(set_control_rotation_offset, 'Space', 'GlobalSpace', controller)

    def TireCollision(self, controller, library):
        entry = 'Entry'
        controller.add_exposed_pin('control', unreal.RigVMPinDirection.INPUT, 'FRigElementKey', '/Script/ControlRig.RigElementKey', '(Type=None,Name="None")')
        controller.add_exposed_pin('control_spin', unreal.RigVMPinDirection.INPUT, 'FRigElementKey', '/Script/ControlRig.RigElementKey', '(Type=None,Name="None")')
        controller.add_exposed_pin('Diameter', unreal.RigVMPinDirection.INPUT, 'double', 'None', '')
        controller.add_exposed_pin('slide_on_nearest', unreal.RigVMPinDirection.INPUT, 'bool', 'None', '')
        controller.add_exposed_pin('diameter_collision_multiply', unreal.RigVMPinDirection.INPUT, 'double', 'None', '')
        controller.add_exposed_pin('tire_joints', unreal.RigVMPinDirection.INPUT, 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', '()')
        controller.add_exposed_pin('tire_bulge', unreal.RigVMPinDirection.INPUT, 'FVector', '/Script/CoreUObject.Vector', '(X=0.000000,Y=0.000000,Z=0.000000)')
        controller.add_exposed_pin('tire_bulge_clamp', unreal.RigVMPinDirection.INPUT, 'FVector', '/Script/CoreUObject.Vector', '(X=0.000000,Y=0.000000,Z=0.000000)')
        return1 = 'Return'
        for_each = controller.add_template_node('DISPATCH_RigVMDispatch_ArrayIterator(in Array,out Element,out Index,out Count,out Ratio)', unreal.Vector2D(1968.0, 144.0), 'For Each')
        sphere_trace_by_object_types = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SphereTraceByObjectTypes', 'Execute', unreal.Vector2D(832.0, -1200.0), 'Sphere Trace By Object Types')
        if2 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(1360.0, -1328.0), 'If')
        add1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorAdd', 'Execute', unreal.Vector2D(1136.0, -944.0), 'Add')
        and2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathBoolAnd', 'Execute', unreal.Vector2D(1135.0, -1360.0), 'And')
        get_diameter = controller.add_variable_node('Diameter','double',None,True,'', unreal.Vector2D(224.0, -960.0), 'Get Diameter')
        multiply2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleMul', 'Execute', unreal.Vector2D(448.0, -960.0), 'Multiply')
        multiply3 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleMul', 'Execute', unreal.Vector2D(656.0, -880.0), 'Multiply')
        set_control_translation_offset = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetControlTranslationOffset', 'Execute', unreal.Vector2D(1344.0, -16.0), 'Set Control Translation Offset')
        get_control_spin = controller.add_variable_node_from_object_path('control_spin','FRigElementKey','/Script/ControlRig.RigElementKey',True,'', unreal.Vector2D(1088.0, 112.0), 'Get control_spin')
        get_transform2 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(192.0, -1248.0), 'Get Transform')
        get_slide_on_nearest1 = controller.add_variable_node('slide_on_nearest','bool',None,True,'', unreal.Vector2D(784.0, -1376.0), 'Get slide_on_nearest')
        
        line_trace_by_object_types = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_LineTraceByObjectTypes', 'Execute', unreal.Vector2D(3472.0, 1296.0), 'Line Trace By Object Types')
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(2832.0, 1392.0), 'Get Transform')
        inverse = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathTransformInverse', 'Execute', unreal.Vector2D(2896.0, 1216.0), 'Inverse')
        get_transform1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(2512.0, 1072.0), 'Get Transform')
        multiply = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathTransformMul', 'Execute', unreal.Vector2D(3184.0, 1136.0), 'Multiply')
        if1 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(3760.0, 1392.0), 'If')
        set_translation = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTranslation', 'Execute', unreal.Vector2D(4096.0, 832.0), 'Set Translation')
        distance_between = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorDistance', 'Execute', unreal.Vector2D(3920.0, 1712.0), 'Distance Between')
        set_scale = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetScale', 'Execute', unreal.Vector2D(4976.0, 832.0), 'Set Scale')
        get_tire_bulge = controller.add_variable_node_from_object_path('tire_bulge','FVector','/Script/CoreUObject.Vector',True,'', unreal.Vector2D(3968.0, 1552.0), 'Get tire_bulge')
        get_tire_bulge_clamp = controller.add_variable_node_from_object_path('tire_bulge_clamp','FVector','/Script/CoreUObject.Vector',True,'', unreal.Vector2D(4480.0, 1904.0), 'Get tire_bulge_clamp')
        multiply1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorMul', 'Execute', unreal.Vector2D(4224.0, 1408.0), 'Multiply')
        add = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorAdd', 'Execute', unreal.Vector2D(4448.0, 1392.0), 'Add')
        clamp = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorClamp', 'Execute', unreal.Vector2D(4672.0, 1376.0), 'Clamp')
        and1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathBoolAnd', 'Execute', unreal.Vector2D(3728.0, 1120.0), 'And')
        get_slide_on_nearest = controller.add_variable_node('slide_on_nearest','bool',None,True,'', unreal.Vector2D(3488.0, 1120.0), 'Get slide_on_nearest')
        ...
        controller.resolve_wild_card_pin(f'{for_each.get_node_path()}.Array', 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey')
        controller.resolve_wild_card_pin(f'{if2.get_node_path()}.Result', 'FVector', '/Script/CoreUObject.Vector')
        controller.resolve_wild_card_pin(f'{add1.get_node_path()}.Result', 'FVector', '/Script/CoreUObject.Vector')

        graph.add_link(for_each,'ExecuteContext',set_translation,'ExecutePin',controller)
        graph.add_link(entry,'ExecuteContext',set_control_translation_offset,'ExecutePin',controller)
        graph.add_link(for_each,'Completed',return1,'ExecuteContext',controller)
        graph.add_link(set_control_translation_offset,'ExecutePin',for_each,'ExecuteContext',controller)
        graph.add_link(multiply,'Result.Translation',line_trace_by_object_types,'Start',controller)
        graph.add_link(get_transform,'Transform.Translation',line_trace_by_object_types,'End',controller)
        graph.add_link(line_trace_by_object_types,'bHit',and1,'B',controller)
        graph.add_link(line_trace_by_object_types,'HitLocation',if1,'True',controller)
        ...
        graph.add_link(inverse,'Result',multiply,'A',controller)
        graph.add_link(for_each,'Element',get_transform1,'Item',controller)
        graph.add_link(and1,'Result',if1,'Condition',controller)
        graph.add_link(if1,'Result',set_translation,'Value',controller)
        graph.add_link(if1,'Result',distance_between,'B',controller)
        graph.add_link(set_translation,'ExecutePin',set_scale,'ExecutePin',controller)
        graph.add_link(for_each,'Element',set_translation,'Item',controller)
        graph.add_link(for_each,'Element',set_scale,'Item',controller)
        graph.add_link(clamp,'Result',set_scale,'Scale',controller)
        graph.add_link(get_tire_bulge,'Value',multiply1,'A',controller)
        graph.add_link(get_tire_bulge_clamp,'Value',clamp,'Maximum',controller)
        graph.add_link(multiply1,'Result',add,'A',controller)
        graph.add_link(add,'Result',clamp,'Value',controller)
        graph.add_link(get_slide_on_nearest,'Value',and1,'A',controller)
        graph.add_link(entry,'control',get_transform2,'Item',controller)
        graph.add_link(entry,'diameter_collision_multiply',multiply3,'B',controller)
        graph.add_link(entry,'tire_joints',for_each,'Array',controller)
        graph.add_link(get_transform2,'Transform.Translation',sphere_trace_by_object_types,'Start',controller)
        graph.add_link(get_transform2,'Transform.Translation',sphere_trace_by_object_types,'End',controller)
        graph.add_link(multiply3,'Result',sphere_trace_by_object_types,'Radius',controller)
        graph.add_link(sphere_trace_by_object_types,'bHit',and2,'A',controller)
        graph.add_link(sphere_trace_by_object_types,'HitLocation',add1,'A',controller)
        graph.add_link(and2,'Result',if2,'Condition',controller)
        graph.add_link(add1,'Result',if2,'True',controller)
        graph.add_link(get_transform2,'Transform.Translation',if2,'False',controller)
        graph.add_link(if2,'Result',set_control_translation_offset,'Offset',controller)
        graph.add_link(get_slide_on_nearest1,'Value',and2,'B',controller)
        graph.add_link(get_diameter,'Value',multiply2,'A',controller)
        graph.add_link(multiply2,'Result',multiply3,'A',controller)
        graph.add_link(get_control_spin,'Value.Name',set_control_translation_offset,'Control',controller)
        graph.add_link(distance_between,'Result',multiply1,'B.X',controller)
        graph.add_link(distance_between,'Result',multiply1,'B.Y',controller)
        graph.add_link(distance_between,'Result',multiply1,'B.Z',controller)
        graph.add_link(multiply3,'Result',add1,'B.Z',controller)

        graph.set_pin(line_trace_by_object_types, 'WorkData', '(Hash=4294967295,bHit=False,HitLocation=(X=0.000000,Y=0.000000,Z=0.000000),HitNormal=(X=0.000000,Y=0.000000,Z=1.000000))', controller)
        graph.set_pin(get_transform, 'Space', 'GlobalSpace', controller)
        graph.set_pin(get_transform, 'bInitial', 'False', controller)
        ...
        graph.set_pin(set_scale, 'Space', 'LocalSpace', controller)
        graph.set_pin(set_scale, 'bInitial', 'False', controller)
        graph.set_pin(set_scale, 'Weight', '1.000000', controller)
        graph.set_pin(set_scale, 'bPropagateToChildren', 'True', controller)
        graph.set_pin(multiply1, 'B', '(X=1.000000,Y=1.000000,Z=1.000000)', controller)
        graph.set_pin(add, 'B', '(X=1.000000,Y=1.000000,Z=1.000000)', controller)
        graph.set_pin(clamp, 'Minimum', '(X=1.000000,Y=1.000000,Z=1.000000)', controller)
        graph.set_pin(sphere_trace_by_object_types, 'WorkData', '(Hash=4294967295,bHit=False,HitLocation=(X=0.000000,Y=0.000000,Z=0.000000),HitNormal=(X=0.000000,Y=0.000000,Z=1.000000))', controller)
        graph.set_pin(add1, 'B', '(X=0.000000,Y=0.000000,Z=0.000000)', controller)
        graph.set_pin(multiply2, 'B', '0.500000', controller)
        graph.set_pin(set_control_translation_offset, 'Space', 'GlobalSpace', controller)
        graph.set_pin(get_transform2, 'Space', 'GlobalSpace', controller)
        graph.set_pin(get_transform2, 'bInitial', 'False', controller)
    ...
    def SwitchMode_PURE(self, controller, library):
        ...
        controller.add_exposed_pin('joints', unreal.RigVMPinDirection.INPUT, 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', '()')
        controller.add_exposed_pin('joint_index', unreal.RigVMPinDirection.INPUT, 'int32', 'None', '0')
        return1 = 'Return'

        controller.add_exposed_pin('Result', unreal.RigVMPinDirection.OUTPUT, 'int32', 'None', '0')
        if1 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(416.0, -16.0), 'If')
        equals = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(176.0, 32.0), 'Equals')
        equals1 = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(48.0, -256.0), 'Equals')
        if2 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(640.0, -256.0), 'If')
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(-112.0, 336.0), 'vetalaLib_GetItem')
        if3 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(528.0, 368.0), 'If')
        get_int32_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(160.0, 352.0), 'Get Int32 Metadata')
        from_string = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(-96.0, 512.0), 'From String')
        ...
        graph.add_link(if3, 'Result', equals, 'B', controller)
        graph.add_link(equals1, 'Result', if2, 'Condition', controller)
        graph.add_link(vetala_lib_get_item, 'Element', get_int32_metadata, 'Item', controller)
        graph.add_link(get_int32_metadata, 'Found', if3, 'Condition', controller)
        graph.add_link(get_int32_metadata, 'Value', if3, 'True', controller)
        graph.add_link(from_string, 'Result', get_int32_metadata, 'Name', controller)
        graph.add_link(entry, 'joint_index', vetala_lib_get_item, 'index', controller)
    ...
    def rigLayerState_PURE(self, controller, library):
        ...
        controller.add_exposed_pin('layer', unreal.RigVMPinDirection.INPUT, 'int32', 'None', '')
        controller.add_exposed_pin('joints', unreal.RigVMPinDirection.INPUT, 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', '()')
        controller.add_exposed_pin('joint_index', unreal.RigVMPinDirection.INPUT, 'int32', 'None', '')
        return1 = 'Return'
        controller.add_exposed_pin('state', unreal.RigVMPinDirection.OUTPUT, 'bool', 'None', 'False')
        equals = controller.add_template_node('DISPATCH_RigVMDispatch_CoreEquals(in A,in B,out Result)', unreal.Vector2D(-32.0, -240.0), 'Equals')
        vetala_lib_get_item = controller.add_function_reference_node(library.find_function('vetalaLib_GetItem'), unreal.Vector2D(-320.0, 64.0), 'vetalaLib_GetItem')
        if1 = controller.add_template_node('DISPATCH_RigVMDispatch_If(in Condition,in True,in False,out Result)', unreal.Vector2D(320.0, 96.0), 'If')
        get_int32_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(-48.0, 80.0), 'Get Int32 Metadata')
        from_string = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(-304.0, 240.0), 'From String')
        ...
        graph.add_link(entry, 'joints', vetala_lib_get_item, 'Array', controller)
        graph.add_link(entry, 'joint_index', vetala_lib_get_item, 'index', controller)
        graph.add_link(equals, 'Result', return1, 'state', controller)
        graph.add_link(if1, 'Result', equals, 'B', controller)
        graph.add_link(vetala_lib_get_item, 'Element', get_int32_metadata, 'Item', controller)
    ...
    def rigLayerSolver(self, controller, library):
        ...
        entry = 'Entry'
        controller.add_exposed_pin('Joints', unreal.RigVMPinDirection.INPUT, 'TArray<FRigElementKey>', '/Script/ControlRig.RigElementKey', '()')
        controller.add_exposed_pin('Switch', unreal.RigVMPinDirection.INPUT, 'double', 'None', '')
        return1 = 'Return'
        ...
        get_item_metadata = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(1792.0, 432.0), 'Get Item Metadata')
        concat = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_NameConcat', 'Execute', unreal.Vector2D(912.0, 1472.0), 'Concat')
        int_to_name = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntToName', 'Execute', unreal.Vector2D(704.0, 1520.0), 'Int to Name')
        branch = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(1552.0, 1312.0), 'Branch')
        not_equals = controller.add_template_node('DISPATCH_RigVMDispatch_CoreNotEquals(in A,in B,out Result)', unreal.Vector2D(1216.0, 1408.0), 'Not Equals')
        set_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(2656.0, 1312.0), 'Set Transform')
        get_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetTransform', 'Execute', unreal.Vector2D(1008.0, 2000.0), 'Get Transform')
        for_loop = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ForLoopCount', 'Execute', unreal.Vector2D(880.0, 672.0), 'For Loop')
        concat1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_NameConcat', 'Execute', unreal.Vector2D(1504.0, 624.0), 'Concat')
        int_to_name1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathIntToName', 'Execute', unreal.Vector2D(1264.0, 672.0), 'Int to Name')
        item_exists = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_ItemExists', 'Execute', unreal.Vector2D(1712.0, 1024.0), 'Item Exists')
        branch1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(2048.0, 1296.0), 'Branch')
        to_int = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathDoubleToInt', 'Execute', unreal.Vector2D(-272.0, 768.0), 'To Int')
        from_string = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(192.0, -96.0), 'From String')
        set_int32_metadata = controller.add_template_node('DISPATCH_RigDispatch_SetMetadata(in Item,in Name,in NameSpace,in Value,out Success)', unreal.Vector2D(544.0, 112.0), 'Set Int32 Metadata')
        get_item_metadata1 = controller.add_template_node('DISPATCH_RigDispatch_GetMetadata(in Item,in Name,in NameSpace,in Default,out Value,out Found)', unreal.Vector2D(2704.0, 976.0), 'Get Item Metadata')
        from_string1 = controller.add_template_node('DISPATCH_RigDispatch_FromString(in String,out Result)', unreal.Vector2D(2352.0, 1040.0), 'From String')
        set_transform1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_SetTransform', 'Execute', unreal.Vector2D(3984.0, 1264.0), 'Set Transform')
        branch2 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_ControlFlowBranch', 'Execute', unreal.Vector2D(3088.0, 1232.0), 'Branch')
        get_relative_transform = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetRelativeTransformForItem', 'Execute', unreal.Vector2D(2064.0, 1520.0), 'Get Relative Transform')
        multiply = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathTransformMul', 'Execute', unreal.Vector2D(2400.0, 1616.0), 'Multiply')
        get_relative_transform1 = controller.add_unit_node_from_struct_path('/Script/ControlRig.RigUnit_GetRelativeTransformForItem', 'Execute', unreal.Vector2D(3504.0, 1392.0), 'Get Relative Transform')
        multiply1 = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathTransformMul', 'Execute', unreal.Vector2D(3776.0, 1472.0), 'Multiply')
        ...
        graph.add_link(set_transform, 'ExecutePin', branch2, 'ExecuteContext', controller)
        graph.add_link(set_int32_metadata, 'ExecuteContext', for_loop, 'ExecutePin', controller)
        graph.add_link(entry, 'Joints', for_each, 'Array', controller)
        graph.add_link(entry, 'Switch', to_int, 'Value', controller)
        ...
        graph.add_link(for_each, 'Element', get_relative_transform, 'Parent', controller)
        graph.add_link(for_each, 'Element', get_relative_transform1, 'Parent', controller)
        ...
        graph.add_link(get_item_metadata, 'Value', get_relative_transform, 'Child', controller)
        graph.add_link(int_to_name, 'Result', concat, 'B', controller)
        graph.add_link(concat, 'Result', not_equals, 'B', controller)
        graph.add_link(to_int, 'Result', int_to_name, 'Number', controller)
        ...
        graph.add_link(multiply, 'Result', set_transform, 'Value', controller)
        graph.add_link(get_transform, 'Transform', multiply, 'B', controller)
        graph.add_link(get_transform, 'Transform', multiply1, 'B', controller)
        ...
        graph.add_link(to_int, 'Result', set_int32_metadata, 'Value', controller)
        graph.add_link(from_string, 'Result', set_int32_metadata, 'Name', controller)
        graph.add_link(from_string1, 'Result', get_item_metadata1, 'Name', controller)
        graph.add_link(get_item_metadata1, 'Value', set_transform1, 'Item', controller)
        graph.add_link(get_item_metadata1, 'Value', get_relative_transform1, 'Child', controller)
        graph.add_link(get_item_metadata1, 'Found', branch2, 'Condition', controller)
        graph.add_link(branch2, 'True', set_transform1, 'ExecutePin', controller)
        graph.add_link(multiply1, 'Result', set_transform1, 'Value', controller)
        graph.add_link(get_relative_transform, 'RelativeTransform', multiply, 'A', controller)
        graph.add_link(get_relative_transform1, 'RelativeTransform', multiply1, 'A', controller)
        ...
        graph.set_pin(from_string1, 'String', 'main', controller)
        ...
        graph.set_pin(get_relative_transform, 'bChildInitial', 'true', controller)
        graph.set_pin(get_relative_transform, 'bParentInitial', 'true', controller)
        graph.set_pin(get_relative_transform1, 'bChildInitial', 'true', controller)
        graph.set_pin(get_relative_transform1, 'bParentInitial', 'true', controller)
    ...
    def Control(self, controller, library):
        ...
        controller.add_exposed_pin('scale_offset', unreal.RigVMPinDirection.INPUT, 'double', 'None', '1')
        ...
        multiply = controller.add_unit_node_from_struct_path('/Script/RigVM.RigVMFunction_MathVectorMul', 'Execute', unreal.Vector2D(858.05419921875, 739.0125732421875), 'Multiply')

        graph.add_link(entry, 'ExecuteContext', spawn_transform_control, 'ExecutePin', controller)
        graph.add_link(set_last_description, 'ExecuteContext', return1, 'ExecuteContext', controller)
        graph.add_link(spawn_transform_control, 'ExecutePin', vetala_lib_control_sub, 'ExecuteContext', controller)
        ...
        graph.add_link(entry, 'scale_offset', multiply, 'B.X', controller)
        graph.add_link(entry, 'scale_offset', multiply, 'B.Y', controller)
        graph.add_link(entry, 'scale_offset', multiply, 'B.Z', controller)
        ...
        graph.add_link(multiply, 'Result', spawn_transform_control, 'Settings.Shape.Transform.Scale3D', controller)

        graph.set_pin(spawn_transform_control, 'OffsetSpace', 'LocalSpace', controller)
        graph.set_pin(spawn_transform_control, 'InitialValue', '(Rotation=(X=0.000000,Y=0.000000,Z=0.000000,W=1.000000),Translation=(X=0.000000,Y=0.000000,Z=0.000000),Scale3D=(X=1.000000,Y=1.000000,Z=1.000000))', controller)
        graph.set_pin(spawn_transform_control, 'Settings', '(InitialSpace=LocalSpace,bUsePreferredRotationOrder=False,PreferredRotationOrder=YZX,Limits=(LimitTranslationX=(bMinimum=False,bMaximum=False),LimitTranslationY=(bMinimum=False,bMaximum=False),LimitTranslationZ=(bMinimum=False,bMaximum=False),LimitPitch=(bMinimum=False,bMaximum=False),LimitYaw=(bMinimum=False,bMaximum=False),LimitRoll=(bMinimum=False,bMaximum=False),LimitScaleX=(bMinimum=False,bMaximum=False),LimitScaleY=(bMinimum=False,bMaximum=False),LimitScaleZ=(bMinimum=False,bMaximum=False),MinValue=(Location=(X=-100.000000,Y=-100.000000,Z=-100.000000),Rotation=(Pitch=-180.000000,Yaw=-180.000000,Roll=-180.000000),Scale=(X=0.000000,Y=0.000000,Z=0.000000)),MaxValue=(Location=(X=100.000000,Y=100.000000,Z=100.000000),Rotation=(Pitch=180.000000,Yaw=180.000000,Roll=180.000000),Scale=(X=10.000000,Y=10.000000,Z=10.000000)),bDrawLimits=True),Shape=(bVisible=True,Name="Circle_Thin",Color=(R=1.000000,G=0.000000,B=0.000000,A=1.000000),Transform=(Rotation=(X=0.000000,Y=0.000000,Z=0.000000,W=1.000000),Translation=(X=0.000000,Y=0.000000,Z=0.000000),Scale3D=(X=1.000000,Y=1.000000,Z=1.000000))),Proxy=(bIsProxy=False,ShapeVisibility=BasedOnSelection),FilteredChannels=(),DisplayName="None")', controller)
        graph.set_pin(at, 'Index', '0', controller)
